...
/** This interface defines a complete listener for a parse tree produced by {@link STParser}. */
public interface STParserListener extends ParseTreeListener {
  /**
   * Enter a parse tree produced by {@link STParser#template_}.
   *
   * @param ctx the parse tree
   */
  void enterTemplate_(STParser.Template_Context ctx);

  /**
   * Exit a parse tree produced by {@link STParser#template_}.
   *
   * @param ctx the parse tree
   */
  void exitTemplate_(STParser.Template_Context ctx);

  /**
   * Enter a parse tree produced by {@link STParser#elements}.
   *
   * @param ctx the parse tree
   */
  void enterElements(STParser.ElementsContext ctx);

  /**
   * Exit a parse tree produced by {@link STParser#elements}.
   *
   * @param ctx the parse tree
   */
  void exitElements(STParser.ElementsContext ctx);
  ...
  /**
   * Enter a parse tree produced by {@link STParser#list_}.
   *
   * @param ctx the parse tree
   */
  void enterList_(STParser.List_Context ctx);

  /**
   * Exit a parse tree produced by {@link STParser#list_}.
   *
   * @param ctx the parse tree
   */
  void exitList_(STParser.List_Context ctx);

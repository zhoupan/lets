...
public class CSharpPreprocessorParser extends CSharpPreprocessorParserBase {
  ...
  public static class Preprocessor_directiveContext extends ParserRuleContext {
    ...
    public int getRuleIndex() {
      return RULE_preprocessor_directive;
    }
  ...
  public static class PreprocessorDiagnosticContext extends Preprocessor_directiveContext {
    ...
    public PreprocessorDiagnosticContext(Preprocessor_directiveContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).enterPreprocessorDiagnostic(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).exitPreprocessorDiagnostic(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof CSharpPreprocessorParserVisitor)
        return ((CSharpPreprocessorParserVisitor<? extends T>) visitor)
            .visitPreprocessorDiagnostic(this);
  ...
  public static class PreprocessorNullableContext extends Preprocessor_directiveContext {
    ...
    public PreprocessorNullableContext(Preprocessor_directiveContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).enterPreprocessorNullable(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).exitPreprocessorNullable(this);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof CSharpPreprocessorParserVisitor)
        return ((CSharpPreprocessorParserVisitor<? extends T>) visitor)
            .visitPreprocessorNullable(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public static class PreprocessorRegionContext extends Preprocessor_directiveContext {
    ...
    public PreprocessorRegionContext(Preprocessor_directiveContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).enterPreprocessorRegion(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).exitPreprocessorRegion(this);
    }
  ...
  public static class PreprocessorDeclarationContext extends Preprocessor_directiveContext {
    ...
    public PreprocessorDeclarationContext(Preprocessor_directiveContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).enterPreprocessorDeclaration(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).exitPreprocessorDeclaration(this);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof CSharpPreprocessorParserVisitor)
        return ((CSharpPreprocessorParserVisitor<? extends T>) visitor)
            .visitPreprocessorDeclaration(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public static class PreprocessorConditionalContext extends Preprocessor_directiveContext {
    ...
    public PreprocessorConditionalContext(Preprocessor_directiveContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).enterPreprocessorConditional(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).exitPreprocessorConditional(this);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof CSharpPreprocessorParserVisitor)
        return ((CSharpPreprocessorParserVisitor<? extends T>) visitor)
            .visitPreprocessorConditional(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public static class PreprocessorPragmaContext extends Preprocessor_directiveContext {
    ...
    public PreprocessorPragmaContext(Preprocessor_directiveContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).enterPreprocessorPragma(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).exitPreprocessorPragma(this);
    }
  ...
  public static class PreprocessorLineContext extends Preprocessor_directiveContext {
    ...
    public PreprocessorLineContext(Preprocessor_directiveContext ctx) {
      copyFrom(ctx);
    }
    ...
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).enterPreprocessorLine(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).exitPreprocessorLine(this);
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof CSharpPreprocessorParserVisitor)
        return ((CSharpPreprocessorParserVisitor<? extends T>) visitor).visitPreprocessorLine(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public static class Directive_new_line_or_sharpContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_directive_new_line_or_sharp;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).enterDirective_new_line_or_sharp(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).exitDirective_new_line_or_sharp(this);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof CSharpPreprocessorParserVisitor)
        return ((CSharpPreprocessorParserVisitor<? extends T>) visitor)
            .visitDirective_new_line_or_sharp(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public final Directive_new_line_or_sharpContext directive_new_line_or_sharp()
    ...
    Directive_new_line_or_sharpContext _localctx =
        new Directive_new_line_or_sharpContext(_ctx, getState());
  ...
  public static class Preprocessor_expressionContext extends ParserRuleContext {
    ...
    @Override
    public int getRuleIndex() {
      return RULE_preprocessor_expression;
    }

    @Override
    public void enterRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).enterPreprocessor_expression(this);
    }

    @Override
    public void exitRule(ParseTreeListener listener) {
      if (listener instanceof CSharpPreprocessorParserListener)
        ((CSharpPreprocessorParserListener) listener).exitPreprocessor_expression(this);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof CSharpPreprocessorParserVisitor)
        return ((CSharpPreprocessorParserVisitor<? extends T>) visitor)
            .visitPreprocessor_expression(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  private Preprocessor_expressionContext preprocessor_expression(int _p)
    ...
    Preprocessor_expressionContext _localctx =
        new Preprocessor_expressionContext(_ctx, _parentState);
  ...
  public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
    switch (ruleIndex) {
      case 2:
        return preprocessor_expression_sempred(
            (Preprocessor_expressionContext) _localctx, predIndex);
    }
    return true;
  }

  private boolean preprocessor_expression_sempred(
      Preprocessor_expressionContext _localctx, int predIndex) {
    switch (predIndex) {
      case 0:

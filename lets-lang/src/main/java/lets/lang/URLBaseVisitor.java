...
/**
 * This class provides an empty implementation of {@link URLVisitor}, which can be extended to
...
public class URLBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements URLVisitor<T> {
   ...
   */
  @Override
  public T visitScheme(URLParser.SchemeContext ctx) {
    return visitChildren(ctx);
  }
   ...
   */
  @Override
  public T visitDomainNameOrIPv4Host(URLParser.DomainNameOrIPv4HostContext ctx) {
    return visitChildren(ctx);
  }
   ...
   */
  @Override
  public T visitIPv6Host(URLParser.IPv6HostContext ctx) {
    return visitChildren(ctx);
  }
   ...
   */
  @Override
  public T visitV6host(URLParser.V6hostContext ctx) {
    return visitChildren(ctx);
  }
   ...
   */
  @Override
  public T visitFrag(URLParser.FragContext ctx) {
    return visitChildren(ctx);
  }
   ...
   */
  @Override
  public T visitQuery(URLParser.QueryContext ctx) {
    return visitChildren(ctx);
  }
   ...
   */
  @Override
  public T visitString(URLParser.StringContext ctx) {
    return visitChildren(ctx);
  }
}

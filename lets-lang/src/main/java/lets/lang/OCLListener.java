...
/** This interface defines a complete listener for a parse tree produced by {@link OCLParser}. */
public interface OCLListener extends ParseTreeListener {
  ...
  /**
   * Enter a parse tree produced by {@link OCLParser#expressions}.
   *
   * @param ctx the parse tree
   */
  void enterExpressions(OCLParser.ExpressionsContext ctx);

  /**
   * Exit a parse tree produced by {@link OCLParser#expressions}.
   *
   * @param ctx the parse tree
   */
  void exitExpressions(OCLParser.ExpressionsContext ctx);

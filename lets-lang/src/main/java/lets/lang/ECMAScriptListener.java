...
/**
 * This interface defines a complete listener for a parse tree produced by {@link ECMAScriptParser}.
 */
public interface ECMAScriptListener extends ParseTreeListener {
   ...
   * ECMAScriptParser#iterationStatement}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link ECMAScriptParser#propertyAssignment}.
   *
   * @param ctx the parse tree
   */
   ...
   * ECMAScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link ECMAScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */

...
/**
 * This interface defines a complete listener for a parse tree produced by {@link GraphQLParser}.
 */
public interface GraphQLListener extends ParseTreeListener {
  ...
  /**
   * Enter a parse tree produced by {@link GraphQLParser#executableDocument}.
   *
   * @param ctx the parse tree
   */
  void enterExecutableDocument(GraphQLParser.ExecutableDocumentContext ctx);

  /**
   * Exit a parse tree produced by {@link GraphQLParser#executableDocument}.
   *
   * @param ctx the parse tree
   */
  void exitExecutableDocument(GraphQLParser.ExecutableDocumentContext ctx);
  ...
  /**
   * Enter a parse tree produced by {@link GraphQLParser#type_}.
   *
   * @param ctx the parse tree
   */
  void enterType_(GraphQLParser.Type_Context ctx);

  /**
   * Exit a parse tree produced by {@link GraphQLParser#type_}.
   *
   * @param ctx the parse tree
   */
  void exitType_(GraphQLParser.Type_Context ctx);
  ...
  /**
   * Enter a parse tree produced by {@link GraphQLParser#typeSystemDocument}.
   *
   * @param ctx the parse tree
   */
  void enterTypeSystemDocument(GraphQLParser.TypeSystemDocumentContext ctx);

  /**
   * Exit a parse tree produced by {@link GraphQLParser#typeSystemDocument}.
   *
   * @param ctx the parse tree
   */
  void exitTypeSystemDocument(GraphQLParser.TypeSystemDocumentContext ctx);
  ...
  /**
   * Enter a parse tree produced by {@link GraphQLParser#typeSystemExtensionDocument}.
   *
   * @param ctx the parse tree
   */
  void enterTypeSystemExtensionDocument(GraphQLParser.TypeSystemExtensionDocumentContext ctx);

  /**
   * Exit a parse tree produced by {@link GraphQLParser#typeSystemExtensionDocument}.
   *
   * @param ctx the parse tree
   */
  void exitTypeSystemExtensionDocument(GraphQLParser.TypeSystemExtensionDocumentContext ctx);

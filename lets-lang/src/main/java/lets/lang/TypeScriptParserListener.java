...
/**
 * This interface defines a complete listener for a parse tree produced by {@link TypeScriptParser}.
 */
public interface TypeScriptParserListener extends ParseTreeListener {
  ...
  /**
   * Enter a parse tree produced by the {@code Intersection} labeled alternative in {@link
   * TypeScriptParser#unionOrIntersectionOrPrimaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code Intersection} labeled alternative in {@link
   * TypeScriptParser#unionOrIntersectionOrPrimaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code Primary} labeled alternative in {@link
   * TypeScriptParser#unionOrIntersectionOrPrimaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code Primary} labeled alternative in {@link
   * TypeScriptParser#unionOrIntersectionOrPrimaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code Union} labeled alternative in {@link
   * TypeScriptParser#unionOrIntersectionOrPrimaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code Union} labeled alternative in {@link
   * TypeScriptParser#unionOrIntersectionOrPrimaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code RedefinitionOfType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code RedefinitionOfType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code PredefinedPrimType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code PredefinedPrimType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code ArrayPrimType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code ArrayPrimType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code ParenthesizedPrimType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code ParenthesizedPrimType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code ThisPrimType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code ThisPrimType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code TuplePrimType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code TuplePrimType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code KeyOfType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code KeyOfType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code ObjectPrimType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code ObjectPrimType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code ReferencePrimType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code ReferencePrimType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code QueryPrimType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code QueryPrimType} labeled alternative in {@link
   * TypeScriptParser#primaryType}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link TypeScriptParser#exportStatement}.
   *
   * @param ctx the parse tree
   */
   ...
   * TypeScriptParser#iterationStatement}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code ForVarStatement} labeled alternative in {@link
   * TypeScriptParser#iterationStatement}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code ForVarStatement} labeled alternative in {@link
   * TypeScriptParser#iterationStatement}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code ForVarInStatement} labeled alternative in {@link
   * TypeScriptParser#iterationStatement}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code ForVarInStatement} labeled alternative in {@link
   * TypeScriptParser#iterationStatement}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code ForVarOfStatement} labeled alternative in {@link
   * TypeScriptParser#iterationStatement}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code ForVarOfStatement} labeled alternative in {@link
   * TypeScriptParser#iterationStatement}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code PropertyDeclarationExpression} labeled alternative in
   * {@link TypeScriptParser#propertyMemberDeclaration}.
   *
   * @param ctx the parse tree
   */
  void enterPropertyDeclarationExpression(
      TypeScriptParser.PropertyDeclarationExpressionContext ctx);

  /**
   * Exit a parse tree produced by the {@code PropertyDeclarationExpression} labeled alternative in
   * {@link TypeScriptParser#propertyMemberDeclaration}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code MethodDeclarationExpression} labeled alternative in
   * {@link TypeScriptParser#propertyMemberDeclaration}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code MethodDeclarationExpression} labeled alternative in
   * {@link TypeScriptParser#propertyMemberDeclaration}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code GetterSetterDeclarationExpression} labeled
   * alternative in {@link TypeScriptParser#propertyMemberDeclaration}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code GetterSetterDeclarationExpression} labeled alternative
   * in {@link TypeScriptParser#propertyMemberDeclaration}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code AbstractMemberDeclaration} labeled alternative in
   * {@link TypeScriptParser#propertyMemberDeclaration}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code AbstractMemberDeclaration} labeled alternative in
   * {@link TypeScriptParser#propertyMemberDeclaration}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link TypeScriptParser#propertyAssignment}.
   *
   * @param ctx the parse tree
   */
   ...
   * alternative in {@link TypeScriptParser#propertyAssignment}.
   *
   * @param ctx the parse tree
   */
   ...
   * TypeScriptParser#propertyAssignment}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code MethodProperty} labeled alternative in {@link
   * TypeScriptParser#propertyAssignment}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code MethodProperty} labeled alternative in {@link
   * TypeScriptParser#propertyAssignment}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code SpreadOperator} labeled alternative in {@link
   * TypeScriptParser#propertyAssignment}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code SpreadOperator} labeled alternative in {@link
   * TypeScriptParser#propertyAssignment}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code RestParameterInObject} labeled alternative in {@link
   * TypeScriptParser#propertyAssignment}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code RestParameterInObject} labeled alternative in {@link
   * TypeScriptParser#propertyAssignment}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link TypeScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code GeneratorsExpression} labeled alternative in {@link
  ...
  /**
   * Exit a parse tree produced by the {@code GeneratorsExpression} labeled alternative in {@link
   * TypeScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code GenericTypes} labeled alternative in {@link
   * TypeScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code GenericTypes} labeled alternative in {@link
   * TypeScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code OptionalChainExpression} labeled alternative in
   * {@link TypeScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code OptionalChainExpression} labeled alternative in {@link
   * TypeScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code GeneratorsFunctionExpression} labeled alternative in
   * {@link TypeScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code GeneratorsFunctionExpression} labeled alternative in
   * {@link TypeScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code CastAsExpression} labeled alternative in {@link
   * TypeScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code CastAsExpression} labeled alternative in {@link
   * TypeScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code NonNullAssertionExpression} labeled alternative in
   * {@link TypeScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code NonNullAssertionExpression} labeled alternative in
   * {@link TypeScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code IteratorsExpression} labeled alternative in {@link
   * TypeScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code IteratorsExpression} labeled alternative in {@link
   * TypeScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */

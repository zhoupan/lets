...
public interface GraphQLVisitor<T> extends ParseTreeVisitor<T> {
  ...
  /**
   * Visit a parse tree produced by {@link GraphQLParser#executableDocument}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitExecutableDocument(GraphQLParser.ExecutableDocumentContext ctx);
  ...
  /**
   * Visit a parse tree produced by {@link GraphQLParser#type_}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitType_(GraphQLParser.Type_Context ctx);
  ...
  /**
   * Visit a parse tree produced by {@link GraphQLParser#typeSystemDocument}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitTypeSystemDocument(GraphQLParser.TypeSystemDocumentContext ctx);
  ...
  /**
   * Visit a parse tree produced by {@link GraphQLParser#typeSystemExtensionDocument}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitTypeSystemExtensionDocument(GraphQLParser.TypeSystemExtensionDocumentContext ctx);

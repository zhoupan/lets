...
/**
 * This class provides an empty implementation of {@link CPP14ParserVisitor}, which can be extended
...
public class CPP14ParserBaseVisitor<T> extends AbstractParseTreeVisitor<T>
    implements CPP14ParserVisitor<T> {
  /**
   * {@inheritDoc}
   *
   ...
   */
  @Override
  public T visitNewExpression_(CPP14Parser.NewExpression_Context ctx) {
    return visitChildren(ctx);
  }
   ...
   */
  @Override
  public T visitNewDeclarator_(CPP14Parser.NewDeclarator_Context ctx) {
    return visitChildren(ctx);
  }
   ...
   */
  @Override
  public T visitNewInitializer_(CPP14Parser.NewInitializer_Context ctx) {
    return visitChildren(ctx);
  }
   ...
   */
  @Override
  public T visitEmptyDeclaration_(CPP14Parser.EmptyDeclaration_Context ctx) {
    return visitChildren(ctx);
  }
   ...
   */
  @Override
  public T visitNoPointerAbstractPackDeclarator(
   ...
   */
  @Override
  public T visitDynamicExceptionSpecification(

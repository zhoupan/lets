...
/**
 * This interface defines a complete generic visitor for a parse tree produced by {@link STParser}.
 *
...
public interface STParserVisitor<T> extends ParseTreeVisitor<T> {
  /**
   * Visit a parse tree produced by {@link STParser#template_}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitTemplate_(STParser.Template_Context ctx);

  /**
   * Visit a parse tree produced by {@link STParser#elements}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitElements(STParser.ElementsContext ctx);
  ...
  /**
   * Visit a parse tree produced by {@link STParser#list_}.
   *
   * @param ctx the parse tree
   * @return the visitor result
   */
  T visitList_(STParser.List_Context ctx);

...
/**
 * This interface defines a complete listener for a parse tree produced by {@link JavaScriptParser}.
 */
public interface JavaScriptParserListener extends ParseTreeListener {
   ...
   * JavaScriptParser#exportStatement}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link JavaScriptParser#exportStatement}.
   *
   * @param ctx the parse tree
   */
   ...
   * JavaScriptParser#iterationStatement}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link JavaScriptParser#propertyAssignment}.
   *
   * @param ctx the parse tree
   */
   ...
   * alternative in {@link JavaScriptParser#propertyAssignment}.
   *
   * @param ctx the parse tree
   */
   ...
   * {@link JavaScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
   ...
   * JavaScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code NamedFunction} labeled alternative in {@link
   * JavaScriptParser#anonymousFunction}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code NamedFunction} labeled alternative in {@link
   * JavaScriptParser#anonymousFunction}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Enter a parse tree produced by the {@code AnonymousFunctionDecl} labeled alternative in {@link
   * JavaScriptParser#anonymousFunction}.
   *
   * @param ctx the parse tree
   */
  ...
  /**
   * Exit a parse tree produced by the {@code AnonymousFunctionDecl} labeled alternative in {@link
   * JavaScriptParser#anonymousFunction}.
   *
   * @param ctx the parse tree
   */

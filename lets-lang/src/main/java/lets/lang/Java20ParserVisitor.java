...
public interface Java20ParserVisitor<T> extends ParseTreeVisitor<T> {
   ...
   * @return the visitor result
   */
  T visitTopLevelClassOrInterfaceDeclaration(
   ...
   * @return the visitor result
   */
  T visitAnnotationInterfaceMemberDeclaration(
   ...
   * @return the visitor result
   */
  T visitAnnotationInterfaceElementDeclaration(
   ...
   * @return the visitor result
   */
  T visitAnnotationInterfaceElementModifier(
   ...
   * @return the visitor result
   */
  T visitUnqualifiedClassInstanceCreationExpression(
   ...
   * @return the visitor result
   */
  T visitClassOrInterfaceTypeToInstantiate(
   ...
   * @return the visitor result
   */
  T visitArrayCreationExpressionWithoutInitializer(
   ...
   * @return the visitor result
   */
  T visitArrayCreationExpressionWithInitializer(

...
public interface JavaScriptParserVisitor<T> extends ParseTreeVisitor<T> {
  ...
  /**
   * Visit a parse tree produced by the {@code NamedFunction} labeled alternative in {@link
  ...
  /**
   * Visit a parse tree produced by the {@code AnonymousFunctionDecl} labeled alternative in {@link
   * JavaScriptParser#anonymousFunction}.
   *
   * @param ctx the parse tree
   * @return the visitor result

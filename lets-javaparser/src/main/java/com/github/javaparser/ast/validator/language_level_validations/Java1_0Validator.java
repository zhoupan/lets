          ...
          (n, reporter) ->
              reporter.report(
                  ...
                  new UpgradeJavaMessage(
                      "'assert' keyword is not supported.",
      ...
      new SimpleValidator<>(
          ...
          (n, reporter) ->
              reporter.report(
                  n,
                  new UpgradeJavaMessage(
                      "inner classes or interfaces are not supported.",
      ...
      new SimpleValidator<>(
          ...
          (n, reporter) ->
              reporter.report(
                  n,
                  new UpgradeJavaMessage(
                      "Reflection is not supported.", ParserConfiguration.LanguageLevel.JAVA_1_1)));
            ...
            if (node instanceof NodeWithTypeArguments) {
              if (((NodeWithTypeArguments<? extends Node>) node).getTypeArguments().isPresent()) {
                reporter.report(
                    node,
                    new UpgradeJavaMessage(
                        "Generics are not supported.", ParserConfiguration.LanguageLevel.JAVA_5));
              }
            }
            if (node instanceof NodeWithTypeParameters) {
              if (((NodeWithTypeParameters<? extends Node>) node)
                  .getTypeParameters()
                  .isNonEmpty()) {
                reporter.report(
                    node,
          ...
          (n, reporter) -> {
            if (n.getCatchClauses().isEmpty() && !n.getFinallyBlock().isPresent()) {
              reporter.report(
                  n,
                  new UpgradeJavaMessage(
                      "Try has no finally and no catch.",
            ...
            if (n.getResources().isNonEmpty()) {
              reporter.report(
                  n,
                  new UpgradeJavaMessage(
                      "Catch with resource is not supported.",
                      ParserConfiguration.LanguageLevel.JAVA_7));
            }
          });
          ...
          (node, reporter) -> {
            if (node instanceof AnnotationExpr || node instanceof AnnotationDeclaration) {
              reporter.report(
                  node,
                  new UpgradeJavaMessage(
                      "Annotations are not supported.", ParserConfiguration.LanguageLevel.JAVA_5));
            }
          });
      ...
      new SimpleValidator<>(
          ...
          (n, reporter) ->
              reporter.report(
                  n,
                  new UpgradeJavaMessage(
                      "Varargs are not supported.", ParserConfiguration.LanguageLevel.JAVA_5)));
      ...
      new SimpleValidator<>(
          ...
          (n, reporter) ->
              reporter.report(
                  ...
                  new UpgradeJavaMessage(
                      "Only one label allowed in a switch-case.",
                      ParserConfiguration.LanguageLevel.JAVA_7)));
      ...
      new SimpleValidator<>(
          ...
          (n, reporter) ->
              reporter.report(
                  n,
                  new UpgradeJavaMessage(
                      "Only labels allowed in break statements.",
      ...
      new SimpleValidator<>(
          ...
          (n, reporter) ->
              reporter.report(
                  n,
                  new UpgradeJavaMessage(
                      "Multi-catch is not supported.", ParserConfiguration.LanguageLevel.JAVA_7)));
      ...
      new SimpleValidator<>(
          ...
          (n, reporter) ->
              reporter.report(
                  n,
                  new UpgradeJavaMessage(
                      "Lambdas are not supported.", ParserConfiguration.LanguageLevel.JAVA_8)));
      ...
      new SimpleValidator<>(
          ...
          (n, reporter) ->
              reporter.report(
                  n,
                  new UpgradeJavaMessage(
                      "Modules are not supported.", ParserConfiguration.LanguageLevel.JAVA_9)));
      ...
      new SimpleValidator<>(
          ...
          (n, reporter) ->
              reporter.report(
                  n,
                  new UpgradeJavaMessage(
                      "Text Block Literals are not supported.",
      ...
      new SimpleValidator<>(
          ...
          (n, reporter) ->
              reporter.report(
                  n,
                  new UpgradeJavaMessage(
                      "Permitted sub-classes are not supported.",
          ...
          (n, reporter) -> {
            if (n.getLabels().isNonEmpty() && n.isDefault()) {
              reporter.report(
                  n,
                  new UpgradeJavaMessage(
                      "Switch case null, default not supported.",
      ...
      new SingleNodeTypeValidator<>(
          ...
          (n, reporter) -> {
            if (n.getGuard().isPresent()
                || n.getLabels().stream().anyMatch(expr -> expr.isTypePatternExpr())) {
              reporter.report(
                  n,
                  new UpgradeJavaMessage(

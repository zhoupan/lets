...
/**
 * Represents a set of types. A given value of this type has to be assignable to at all of the
 * element types. As of Java 8 it is used in casts or while expressing bounds for generic types.
 *
 * <p>For example: {@code public class A<T extends Serializable & Cloneable> { }}
 *
 * <p>Or: {@code void foo((Serializable & Cloneable)myObject);}
 *
 * @since 3.0.0
 */

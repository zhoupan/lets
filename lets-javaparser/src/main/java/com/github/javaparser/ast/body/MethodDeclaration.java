...
/**
 * A method declaration. "public int abc() {return 1;}" in this example: {@code class X { public int
 * abc() {return 1;} }}
 *
 * <p><br>
...
public class MethodDeclaration extends CallableDeclaration<MethodDeclaration>
   ...
   *
   * <p>[accessSpecifier] [static] [abstract] [final] [native] [synchronized] returnType methodName
   * ([paramType [paramName]]) [throws exceptionsList]
   *

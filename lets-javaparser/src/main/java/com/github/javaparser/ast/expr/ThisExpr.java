 ...
 * {@code World.this.greet()} is a MethodCallExpr of method name greet, and scope "World.this" which
 * is a ThisExpr with typeName "World". <br>
 * {@code this.name} is a FieldAccessExpr of field greet, and a ThisExpr as its scope. This ThisExpr
 * has no typeName.
 *

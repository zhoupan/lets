...
/**
 * A constructor call. <br>
 * In {@code new HashMap.Entry<String, Long>(15) {public String getKey() {return null;}};}
 * HashMap.Entry is the type, String and Long are type arguments, 15 is an argument, and everything
 * in { } is the anonymous class body.
 *
 * <p>In {@code class B { class C { public void a() { new B().new C(); } } }} the scope is {@code
 * new B()} of ObjectCreationExpr {@code new B().new C()}
 *
...
public class ObjectCreationExpr extends Expression
   ...
   */
  @Generated("com.github.javaparser.generator.core.node.PropertyGenerator")
  public ObjectCreationExpr setAnonymousClassBody(
      final NodeList<BodyDeclaration<?>> anonymousClassBody) {
    if (anonymousClassBody == this.anonymousClassBody) {
      return this;
    }
    notifyPropertyChange(
        ObservableProperty.ANONYMOUS_CLASS_BODY, this.anonymousClassBody, anonymousClassBody);
   ...
   * {@link ResolvedConstructorDeclaration} representing the declaration of the constructor invoked
   * by this {@code ObjectCreationExpr} is returned. Otherwise, an {@link UnsolvedSymbolException}
   * is thrown.
   *
   * @return a {@link ResolvedConstructorDeclaration} representing the declaration of the invoked
   *     constructor.
   * @throws UnsolvedSymbolException if the declaration corresponding to the object creation
  ...
  public boolean isPolyExpression() {
    return isUsingDiamondOperator()
        && (appearsInInvocationContext() || appearsInAssignmentContext());
  }
}

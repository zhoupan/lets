 ...
 * <h2>Java ?? to 13</h2>
 *
 * The {@code instanceof} expression is a <a
 * href="https://docs.oracle.com/javase/specs/jls/se11/html/jls-15.html#jls-15.20">relational
 * operator</a>, evaluating to true if the object on the left hand side is an instance of the type
 * ({@link ReferenceType}) on the right hand side. <br>
 * <br>
 * Example: <br>
 * {@code tool instanceof Drill} <br>
 * <br>
 * This is then used wherever a conditional/boolean value can be used. For example: <br>
 *
 ...
 * Example: <br>
 * {@code tool instanceof Drill d} <br>
 * <br>
 * This is then used wherever a conditional/boolean value can be used. The scope of the variable
 * created can vary, and is defined further within <a
 * href="https://bugs.openjdk.java.net/browse/JDK-8181287">JEP305</a>. <br>
 *
...
public class InstanceOfExpr extends Expression
  ...
  @OptionalProperty private PatternExpr pattern;
  ...
  public InstanceOfExpr(
      final Expression expression, final ReferenceType type, final PatternExpr pattern) {
  ...
  public InstanceOfExpr(
      TokenRange tokenRange, Expression expression, ReferenceType type, PatternExpr pattern) {
    super(tokenRange);
   ...
   * <br>
   * For example: <br>
   * {@code obj instanceof String stringName} <br>
   * <br>
   * In this example, {@code getName()} returns {@code stringName}
   */

...
public class IntegerLiteralExpr extends LiteralStringValueExpr {
  ...
  /**
   * @deprecated This function is deprecated in favor of {@link #IntegerLiteralExpr(String)}. Please
   ...
   *     {@link IntegerLiteralExpr#asNumber()}. It will be made private or merged with {@link
   *     IntegerLiteralExpr#asNumber()} in future releases
   */
  @Deprecated
  public int asInt() {
  ...
  /**
   * This function returns a representation of the literal value as a number. This will return an
   * integer, except for the case when the literal has the value {@code 2147483648}. This special
   * literal is only allowed in the expression {@code -2147483648} which represents <code>
   * Integer.MIN_VALUE</code>). However 2147483648 (2^31) is out of range of int, which is -(2^31)
   * to (2^31)-1 and thus a long must be returned.
   *
   ...
   * {@code -1} is represented by a unary expression with a minus operator and the literal {@code
   * 1}. It is however possible to represent negative numbers in a literal directly, i.e. by using
   * the binary or hexadecimal representation. For example {@code 0xffff_ffff} represents the value
   * <code> -1</code>.
   *

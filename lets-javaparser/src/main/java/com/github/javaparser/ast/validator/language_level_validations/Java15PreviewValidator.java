...
/**
 * This validator validates according to Java 15 syntax rules -- including incubator/preview/second
 * preview features.
 *
 * @see <a
 *     href="https://openjdk.java.net/projects/jdk/15/">https://openjdk.java.net/projects/jdk/15/</a>
 */
public class Java15PreviewValidator extends Java15Validator {
  ...
  public Java15PreviewValidator() {
    ...
    // Preview
    // remove(noSealedClasses); // Sealed Classes - first preview within Java 15 -

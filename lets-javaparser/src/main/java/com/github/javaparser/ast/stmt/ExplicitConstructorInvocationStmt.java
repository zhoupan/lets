...
public class ExplicitConstructorInvocationStmt extends Statement
  ...
  @Override
  @Generated("com.github.javaparser.generator.core.node.TypeCastingGenerator")
  public void ifExplicitConstructorInvocationStmt(
      Consumer<ExplicitConstructorInvocationStmt> action) {
    action.accept(this);
  }
   ...
   * by this {@code ExplicitConstructorInvocationStmt} is returned. Otherwise, an {@link
   ...
   *     constructor.
   * @throws UnsolvedSymbolException if the declaration corresponding to the explicit constructor
   *     invocation statement could not be resolved.

...
public abstract class Expression extends Node {
  ...
  /**
   * Returns {@code true} when the Node to be tested is not an {@link EnclosedExpr}, {@code false}
   * otherwise.
   */
  public static final Predicate<Node> IS_NOT_ENCLOSED_EXPR = n -> !(n instanceof EnclosedExpr);

  /**
   * A {@link Function} that returns its argument (an {@link Expression}) when the argument is not
   * an {@link EnclosedExpr}, otherwise the first {@link Expression} down the argument's 'inner'
   * path that is not an {@link EnclosedExpr}.
   */
  ...
  public ArrayInitializerExpr asArrayInitializerExpr() {
    throw new IllegalStateException(
        f("%s is not ArrayInitializerExpr, it is %s", this, this.getClass().getSimpleName()));
  }
  ...
  public BooleanLiteralExpr asBooleanLiteralExpr() {
    throw new IllegalStateException(
        f("%s is not BooleanLiteralExpr, it is %s", this, this.getClass().getSimpleName()));
  }
  ...
  public IntegerLiteralExpr asIntegerLiteralExpr() {
    throw new IllegalStateException(
        f("%s is not IntegerLiteralExpr, it is %s", this, this.getClass().getSimpleName()));
  }
  ...
  public LiteralStringValueExpr asLiteralStringValueExpr() {
    throw new IllegalStateException(
        f("%s is not LiteralStringValueExpr, it is %s", this, this.getClass().getSimpleName()));
  }
  ...
  public MarkerAnnotationExpr asMarkerAnnotationExpr() {
    throw new IllegalStateException(
        f("%s is not MarkerAnnotationExpr, it is %s", this, this.getClass().getSimpleName()));
  }
  ...
  public MethodReferenceExpr asMethodReferenceExpr() {
    throw new IllegalStateException(
        f("%s is not MethodReferenceExpr, it is %s", this, this.getClass().getSimpleName()));
  }
  ...
  public NormalAnnotationExpr asNormalAnnotationExpr() {
    throw new IllegalStateException(
        f("%s is not NormalAnnotationExpr, it is %s", this, this.getClass().getSimpleName()));
  }
  ...
  public ObjectCreationExpr asObjectCreationExpr() {
    throw new IllegalStateException(
        f("%s is not ObjectCreationExpr, it is %s", this, this.getClass().getSimpleName()));
  }
  ...
  public SingleMemberAnnotationExpr asSingleMemberAnnotationExpr() {
    throw new IllegalStateException(
        f("%s is not SingleMemberAnnotationExpr, it is %s", this, this.getClass().getSimpleName()));
  }
  ...
  public VariableDeclarationExpr asVariableDeclarationExpr() {
    throw new IllegalStateException(
        f("%s is not VariableDeclarationExpr, it is %s", this, this.getClass().getSimpleName()));
  }
  ...
  public TextBlockLiteralExpr asTextBlockLiteralExpr() {
    throw new IllegalStateException(
        f("%s is not TextBlockLiteralExpr, it is %s", this, this.getClass().getSimpleName()));
  }

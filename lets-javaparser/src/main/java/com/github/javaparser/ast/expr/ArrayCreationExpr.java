...
/**
 * {@code new int[5][4][][]} or {@code new int[][]{{1},{2,3}}}. <br>
...
public class ArrayCreationExpr extends Expression {
  ...
  @NonEmptyProperty private NodeList<ArrayCreationLevel> levels;

  private Type elementType;

  @OptionalProperty private ArrayInitializerExpr initializer;

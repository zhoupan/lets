 ...
 * <ol>
 *   <li><b>var</b> a = 1;
 *   <li><b>var</b> a = new ArrayList&lt;String&gt;();
 * </ol>
 */
  ...
  public ResolvedType convertToUsage(Context context) {
    ...
    if (!(parent instanceof VariableDeclarator)) {
      throw new IllegalStateException(
          "Trying to resolve a `var` which is not in a variable declaration.");
    }
    ...
    return initializer
        ...
        .orElseThrow(
            () -> new IllegalStateException("Cannot resolve `var` which has no initializer."));
  }

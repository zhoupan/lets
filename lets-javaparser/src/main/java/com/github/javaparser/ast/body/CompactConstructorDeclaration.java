 ...
 *
 * <p>A record "compact" constructor declaration: {@code class X(int a, int b) { public X{ } }}
 * where {@code public X{}} is the compact record constructor declaration.
 *
 * <p>Note that the record constructor is distinct from a "standard" constructor as it does not
 * permit arguments/parameters.
 *
 * <p>All annotations preceding the name will be set on this object, not on the class. JavaParser
 ...
 *     Record Classes</a>
 * @see <a href="https://docs.oracle.com/javase/specs/jls/se16/html/jls-8.html#jls-8.10.4">JLS
 *     8.10.3 - Record Constructor Declarations</a>
 * @since 3.22.0
 */
public class CompactConstructorDeclaration extends BodyDeclaration<CompactConstructorDeclaration>
   ...
   *
   * <p>[accessSpecifier] className [throws exceptionsList]
   */
  ...
  /** This constructor is used by the parser and is considered private. */
  public CompactConstructorDeclaration(
      TokenRange tokenRange, NodeList<AnnotationExpr> annotations, BlockStmt body) {
    super(tokenRange, annotations);
    setBody(body);
    customInitialization();
  }

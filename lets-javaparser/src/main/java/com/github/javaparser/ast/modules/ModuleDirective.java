...
public abstract class ModuleDirective extends Node {
  ...
  public ModuleExportsDirective asModuleExportsDirective() {
    throw new IllegalStateException(
        f("%s is not ModuleExportsDirective, it is %s", this, this.getClass().getSimpleName()));
  }
  ...
  public ModuleOpensDirective asModuleOpensDirective() {
    throw new IllegalStateException(
        f("%s is not ModuleOpensDirective, it is %s", this, this.getClass().getSimpleName()));
  }
  ...
  public ModuleProvidesDirective asModuleProvidesDirective() {
    throw new IllegalStateException(
        f("%s is not ModuleProvidesDirective, it is %s", this, this.getClass().getSimpleName()));
  }
  ...
  public ModuleRequiresDirective asModuleRequiresDirective() {
    throw new IllegalStateException(
        f("%s is not ModuleRequiresDirective, it is %s", this, this.getClass().getSimpleName()));
  }
  ...
  public ModuleUsesDirective asModuleUsesDirective() {
    throw new IllegalStateException(
        f("%s is not ModuleUsesDirective, it is %s", this, this.getClass().getSimpleName()));
  }

...
public class PropertyGenerator extends NodeGenerator {
  ...
  protected void generateNode(
    ...
    nodeMetaModel
        ...
        .forEach(p -> derivedProperties.put(p.getName(), p));
  }
  ...
  private void generateGetter(
    ...
    final MethodDeclaration getter =
        new MethodDeclaration(
            createModifierList(PUBLIC),
            parseType(property.getTypeNameForGetter()),
  ...
  private void generateObservableProperty(
    ...
    EnumConstantDeclaration enumConstantDeclaration =
        observablePropertyEnum.addEnumConstant(constantName);
    if (isAttribute) {
  ...
  protected void after() throws Exception {
    CompilationUnit observablePropertyCu =
        sourceRoot

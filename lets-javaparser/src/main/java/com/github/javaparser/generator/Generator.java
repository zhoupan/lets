...
public abstract class Generator {
  ...
  private <T extends Node & NodeWithAnnotations<?>> void annotate(
  ...
  protected void addOrReplaceWhenSameSignature(
    ...
    addMethod(
        containingClassOrInterface, callable, () -> containingClassOrInterface.addMember(callable));
  }
   ...
   * This is not used by any code, but it is useful when changing a generator and you need to get
   * rid of a set of outdated methods.
   */

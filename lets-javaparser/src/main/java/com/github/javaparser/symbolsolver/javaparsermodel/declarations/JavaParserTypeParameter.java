 ...
 */
public class JavaParserTypeParameter extends AbstractTypeDeclaration
  ...
  public JavaParserTypeParameter(
      com.github.javaparser.ast.type.TypeParameter wrappedNode, TypeSolver typeSolver) {
  ...
  public ResolvedTypeParametrizable getContainer() {
    ...
    if (parentNode instanceof com.github.javaparser.ast.body.ConstructorDeclaration) {
      ...
      Optional<ClassOrInterfaceDeclaration> jpTypeDeclaration =
          jpConstructorDeclaration.findAncestor(
  ...
  public String toString() {
    return "JPTypeParameter("
        + wrappedNode.getName()
        + ", bounds="
        + wrappedNode.getTypeBound()
        + ")";
  }

 ...
 * This is intended to be used with custom classloaders. To support typical cases based on
 * reflection just use the ReflectionTypeSolver
 *
...
public class ClassLoaderTypeSolver implements TypeSolver {
  ...
  public SymbolReference<ResolvedReferenceTypeDeclaration> tryToSolveType(String name) {
    if (filterName(name)) {
      try {
        // Some implementations could return null when the class was loaded through the bootstrap
        // classloader
        ...
        // We can safely ignore this one because it is triggered when there are package names which
        // are almost the

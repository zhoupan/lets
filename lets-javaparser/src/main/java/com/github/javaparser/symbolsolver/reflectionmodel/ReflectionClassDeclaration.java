...
public class ReflectionClassDeclaration extends AbstractClassDeclaration
  ...
  public SymbolReference<ResolvedMethodDeclaration> solveMethod(
    ...
    return MethodResolutionLogic.findMostApplicable(
        candidateSolvedMethods, name, argumentsTypes, typeSolver);
  }
  ...
  public Optional<MethodUsage> solveMethodAsUsage(
    ...
    Optional<MethodUsage> ref =
        MethodResolutionLogic.findMostApplicableUsage(
            methodUsages, name, argumentsTypes, typeSolver);
    return ref;
  }
  ...
  public boolean canBeAssignedTo(ResolvedReferenceTypeDeclaration other) {
    ...
    if (this.clazz.getSuperclass() != null
        && new ReflectionClassDeclaration(clazz.getSuperclass(), typeSolver)

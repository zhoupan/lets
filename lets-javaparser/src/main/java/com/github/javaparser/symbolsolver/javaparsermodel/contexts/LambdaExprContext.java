      ...
      for (ResolvedValueDeclaration decl : sb.getSymbolDeclarations()) {
        if (decl.getName().equals(name)) {
          ...
          if (parentNode instanceof MethodCallExpr) {
            ...
            if (functionalMethodOpt.isPresent()) {
              ...
              for (lambdaParamIndex = 0;
                  lambdaParamIndex < wrappedNode.getParameters().size();
                  lambdaParamIndex++) {
                if (wrappedNode
          ...
          if (parentNode instanceof VariableDeclarator) {
            ...
            ResolvedType t =
                JavaParserFacade.get(typeSolver).convertToUsage(variableDeclarator.getType());
            ...
            if (functionalMethod.isPresent()) {
              ...
              if (lambdaType.isReferenceType()) {
                for (com.github.javaparser.utils.Pair<
          ...
          if (parentNode instanceof ReturnStmt) {
            ...
            Optional<MethodDeclaration> optDeclaration =
                returnStmt.findAncestor(MethodDeclaration.class);
            if (optDeclaration.isPresent()) {
              ...
              throw new UnsupportedOperationException(
                  "functional method is not present in return statement");
            }
          }

...
public class JavaParserEnumDeclaration extends AbstractTypeDeclaration
  ...
  public Set<ResolvedMethodDeclaration> getDeclaredMethods() {
    ...
    for (BodyDeclaration<?> member : wrappedNode.getMembers()) {
      if (member instanceof com.github.javaparser.ast.body.MethodDeclaration) {
        methods.add(
            new JavaParserMethodDeclaration(
    ...
    if ("valueOf".equals(name) && argumentsTypes.size() == 1) {
      ...
      if (argument.isReferenceType()
        ...
        return SymbolReference.solved(
            new JavaParserEnumDeclaration.ValueOfMethod(this, typeSolver));
      }
    }
  ...
  @Override
  public SymbolReference<? extends ResolvedValueDeclaration> solveSymbol(
  ...
  public List<ResolvedReferenceType> getAncestors(boolean acceptIncompleteList) {
    ...
    if (enumClass.getTypeDeclaration().isPresent()) {
      ...
      enumClass =
          enumClass.deriveTypeParameters(
  ...
  /**
   * This method is deprecated because it receives the TypesSolver as a parameter. Eventually we
   * would like to remove all usages of TypeSolver as a parameter.
   *
   * <p>Also, resolution should move out of declarations, so that they are pure declarations and the
   * resolution should work for JavaParser, Reflection and Javassist classes in the same way and not
   * be specific to the three implementations.
   */
  @Deprecated
   ...
   *
   * <p>An implicitly declared method {@code public static E[] values()}, which returns an array
   * containing the enum constants of {@code E}, in the same order as they appear in the body of the
   * declaration of E.
   *
   * @see <a
   *     href="https://docs.oracle.com/javase/specs/jls/se7/html/jls-8.html#jls-8.9.2">https://docs.oracle.com/javase/specs/jls/se7/html/jls-8.html#jls-8.9.2</a>
   * @see <a
   *     href="https://docs.oracle.com/javase/specs/jls/se8/html/jls-8.html#jls-8.9.3">https://docs.oracle.com/javase/specs/jls/se8/html/jls-8.html#jls-8.9.3</a>
   * @see <a
   *     href="https://docs.oracle.com/javase/specs/jls/se8/html/jls-14.html#jls-8.9.3">https://docs.oracle.com/javase/specs/jls/se8/html/jls-14.html#jls-8.9.3</a>
   */
  public static class ValuesMethod
    ...
    public ResolvedType getSpecifiedException(int index) {
      throw new UnsupportedOperationException(
          "The values method of an enum does not throw any exception");
    }
  ...
  /**
   * Needed by ContextHelper An implicitly declared method {@code public static E valueOf(String
   * name)}, which returns the enum constant of {@code E} with the specified name.
   *
   * @see <a
   *     href="https://docs.oracle.com/javase/specs/jls/se7/html/jls-8.html#jls-8.9.2">https://docs.oracle.com/javase/specs/jls/se7/html/jls-8.html#jls-8.9.2</a>
   * @see <a
  ...
  public static class ValueOfMethod
    ...
    public ResolvedType getSpecifiedException(int index) {
      throw new UnsupportedOperationException(
          "The valueOf method of an enum does not throw any exception");
    }

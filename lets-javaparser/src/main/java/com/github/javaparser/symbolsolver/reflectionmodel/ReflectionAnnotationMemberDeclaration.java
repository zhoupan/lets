...
public class ReflectionAnnotationMemberDeclaration implements ResolvedAnnotationMemberDeclaration {
  ...
  static {
    valueAsExpressionConverters.put(
        Boolean.class, (value) -> new BooleanLiteralExpr((Boolean) value));
    valueAsExpressionConverters.put(
        Character.class, (value) -> new CharLiteralExpr((Character) value));
    valueAsExpressionConverters.put(Double.class, (value) -> new DoubleLiteralExpr((Double) value));
    valueAsExpressionConverters.put(
        Integer.class, (value) -> new IntegerLiteralExpr((Integer) value));
    ...
    valueAsExpressionConverters.put(
        ...
        (value) -> {
          final ClassOrInterfaceType type =
              new ClassOrInterfaceType(null, ((Class<?>) value).getSimpleName());
  ...
  public ResolvedType getType() {
    ...
    SymbolReference<ResolvedReferenceTypeDeclaration> rrtd =

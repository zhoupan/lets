...
/**
 * Are meta-variables for types - that is, they are special names that allow abstract reasoning
 * about types. To distinguish them from type variables, inference variables are represented with
...
public class InferenceVariable implements ResolvedType {
  ...
  public static InferenceVariable unnamed(
  ...
  public int hashCode() {
    ...
    result =
        31 * result + (typeParameterDeclaration != null ? typeParameterDeclaration.hashCode() : 0);
    return result;
  }

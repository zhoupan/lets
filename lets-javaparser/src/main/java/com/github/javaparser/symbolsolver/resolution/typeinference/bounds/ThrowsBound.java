 ...
 *
 * <p>A bound of the form throws α is purely informational: it directs resolution to optimize the
 * instantiation of α so that, if possible, it is not a checked exception type.
 *

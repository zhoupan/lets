...
/**
 * Will let the symbol solver look inside an Android aar file while solving types. (It will look
 * inside the contained classes.jar)
 *
  ...
  public AarTypeSolver(File aarFile) throws IOException {
    ...
    if (classesJarEntry == null) {
      throw new IllegalArgumentException(
          String.format(
              "The given file (%s) is malformed: entry classes.jar was not found",

...
public class UnicodeEscapeProcessingProvider implements Provider {
  ...
  private final PositionMappingBuilder _mappingBuilder =
      new PositionMappingBuilder(_outputLine, _inputLine);
  ...
  public static final class PositionMapping {
    ...
    /**
     * Algorithm updating a {@link Position} from one file to a {@link Position} in a corresponding
     * file.
     */
    ...
    private static final class DeltaInfo extends Position implements PositionUpdate {
      ...
      /**
       * The offset to add to the {@link #line} and all following source positions up to the next
       * {@link PositionUpdate}.
       */
      private final int _lineDelta;

      /**
       * The offset to add to the {@link #column} and all following source positions up to the next
       * {@link PositionUpdate}.
       */

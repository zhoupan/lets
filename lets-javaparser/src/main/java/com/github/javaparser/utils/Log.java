 ...
 *
 * <p>See <a href="http://javaparser.org/javaparsers-logging-framework-in-one-file/">a blog about
 * this</a>
 */
public class Log {
  ...
  /**
   * Change how logging is handled. You can set your own implementation that forwards to your
   * logging library.
   */

...
public class Utils {
   ...
   *
   * <p>For example "ABC_DEF" becomes "abcDef"
   */
  ...
  private static String stringTransformer(
    ...
    if (s.isEmpty()) {
      throw new IllegalArgumentException(
          String.format("You cannot %s an empty string", operationDescription));
    }
   ...
   * @return content, with all kinds of EOL characters replaced by desiredEndOfLineCharacter
   */
  public static String normalizeEolInTextBlock(
      String content, LineSeparator desiredEndOfLineCharacter) {
  ...
  /**
   * Checks, if the parent is a unary expression with a minus operator. Used to check for negative
   * literals.
   */

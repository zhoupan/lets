...
public final class CodeGenerationUtils {
  ...
  /**
   * Useful for locating source code in your Maven project. Finds the classpath for class c, then
   * backs up out of "target/(test-)classes", giving the directory containing the pom.xml.
   */

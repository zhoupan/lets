...
/**
 * A collection of Java source files and its sub-directories located in a ZIP or JAR file on the
 * file system. Files can be parsed with a callback.
 */
public class SourceZip {
  ...
  /**
   * Create a new ZIP parser. An instance of {@link JavaParser} with the default {@link
   * ParserConfiguration} will be used to parse the ZIP.
   *
  ...
  /**
   * Create a new ZIP parser. An instance of {@link JavaParser} with the given configuration will be
  ...
  /**
   * Tries to parse all '.java' files in the ZIP located at this <i>SourceZip</i>'s path and returns
   * the parse results in a list.
   *

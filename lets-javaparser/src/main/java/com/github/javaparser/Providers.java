...
/**
 * Factory for providers of source code for JavaParser. Providers that have no parameter for
 * encoding but need it will use UTF-8.
 */
public final class Providers {
   ...
   */
  public static Provider resourceProvider(
      ClassLoader classLoader, String pathToResource, Charset encoding) throws IOException {
  ...
  /**
   * Provide a Provider from the resource found in the current class loader with the provided
   * encoding.<br>
   * As resource is accessed through a class loader, a leading "/" is not allowed in pathToResource
   */

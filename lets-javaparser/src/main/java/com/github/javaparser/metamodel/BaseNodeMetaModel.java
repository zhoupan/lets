...
public abstract class BaseNodeMetaModel {
  ...
  /**
   * @return the meta model for the node that this node extends. Note that this is to be used to
   *     find properties defined in superclasses of a Node.
   */
  ...
  /**
   * @return a list of all properties declared directly in this node (not its parent nodes.) These
   *     are also available as fields.
   */
  ...
  /**
   * @return a list of all properties that describe the parameters to the all-fields (but not
   *     "range" and "comment") constructor, in the order of appearance in the constructor parameter
   *     list.
   */
  ...
  /**
   * @return a list of all properties in this node and its parents. Note that a new list is created
   *     every time this method is called.
   */
  public List<PropertyMetaModel> getAllPropertyMetaModels() {
    List<PropertyMetaModel> allPropertyMetaModels =
        new ArrayList<>(getDeclaredPropertyMetaModels());
  ...
  /**
   * @return whether this AST node is the root node, meaning that it is the meta model for "Node":
   *     "NodeMetaModel".
   */
   ...
   *
   * @param parameters a map of propertyName -&gt; value. This should at least contain a pair for
   *     every required property for this node.
   */

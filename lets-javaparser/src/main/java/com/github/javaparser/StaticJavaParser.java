...
public final class StaticJavaParser {
  ...
  /**
   * Set the configuration for the static parse... methods. This is a STATIC field, so modifying it
   * will directly change how all static parse... methods work!
   */
  ...
  /**
   * Parses a variable declaration expression and returns a {@link VariableDeclarationExpr} that
   * represents it.
   *
  ...
  /**
   * Parses the content of a JavadocComment and returns a {@link Javadoc} that represents it.
   *
   ...
   * @throws ParseProblemException if the source code has parser errors
   */
  public static ExplicitConstructorInvocationStmt parseExplicitConstructorInvocationStmt(
   ...
   */
  public static ArrayInitializerExpr parseArrayInitializerExpr(
      @NotNull String arrayInitializerExpr) {
    Preconditions.checkNotNull(
        arrayInitializerExpr, "Parameter arrayInitializerExpr can't be null.");

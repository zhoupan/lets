...
/**
 * This is basically a MethodDeclaration with some TypeParameters defined. The defined
 * TypeParameters can comes from the Method itself or from the surrounding types.
 *
...
public class MethodUsage implements ResolvedTypeParametrized {
  ...
  public MethodUsage replaceTypeParameter(
    ...
    for (int i = 0; i < paramTypes.size(); i++) {
      ...
      ResolvedType newParamType =
          originalParamType.replaceTypeVariables(typeParameter, type, inferredTypes);
    ...
    ResolvedType newReturnType =
        oldReturnType.replaceTypeVariables(typeParameter, type, inferredTypes);

...
/**
 * The Concrete Syntax Model for a single node type. It knows the syntax used to represent a certain
 * element in Java code.
 */
  ...
  static {
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            token(RPAREN),
            conditional(
                ObservableProperty.DEFAULT_VALUE,
                IS_PRESENT,
                sequence(
                    space(),
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            list(
                ObservableProperty.THROWN_EXCEPTIONS,
                sequence(comma(), space()),
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            indent(),
            newline(),
            list(ObservableProperty.ENTRIES, sequence(comma(), newline()), none(), none()),
            conditional(
                ObservableProperty.MEMBERS,
                IS_EMPTY,
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            token(GeneratedJavaParserConstants.LPAREN),
            conditional(
                ObservableProperty.RECEIVER_PARAMETER,
                IS_PRESENT,
                sequence(child(ObservableProperty.RECEIVER_PARAMETER), comma(), space())),
            list(ObservableProperty.PARAMETERS, sequence(comma(), space()), none(), none()),
            token(GeneratedJavaParserConstants.RPAREN),
            list(
                ObservableProperty.THROWN_EXCEPTIONS,
                ...
                none()),
            conditional(
                ObservableProperty.BODY,
                IS_PRESENT,
                sequence(space(), child(ObservableProperty.BODY)),
                semicolon())));
    concreteSyntaxModelByClass.put(
        Parameter.class,
        sequence(
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            conditional(
                ObservableProperty.INITIALIZER,
                IS_PRESENT,
                sequence(space(), child(ObservableProperty.INITIALIZER)))));
    concreteSyntaxModelByClass.put(
    ...
    concreteSyntaxModelByClass.put(
        CharLiteralExpr.class, sequence(comment(), charToken(ObservableProperty.VALUE)));
    concreteSyntaxModelByClass.put(
        ClassExpr.class,
        sequence(
            comment(),
    ...
    concreteSyntaxModelByClass.put(
        DoubleLiteralExpr.class, sequence(comment(), attribute(ObservableProperty.VALUE)));
    concreteSyntaxModelByClass.put(
        EnclosedExpr.class,
        sequence(
            comment(),
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(child(ObservableProperty.TYPE), space(), child(ObservableProperty.NAME)));
    concreteSyntaxModelByClass.put(
        IntegerLiteralExpr.class, sequence(comment(), attribute(ObservableProperty.VALUE)));
    concreteSyntaxModelByClass.put(
        LambdaExpr.class,
        sequence(
            comment(),
            conditional(
                ObservableProperty.ENCLOSING_PARAMETERS,
                FLAG,
                token(GeneratedJavaParserConstants.LPAREN)),
            ...
            space(),
            conditional(
                ObservableProperty.EXPRESSION_BODY,
                IS_PRESENT,
                child(ObservableProperty.EXPRESSION_BODY),
                child(ObservableProperty.BODY))));
    concreteSyntaxModelByClass.put(
        LongLiteralExpr.class, sequence(comment(), attribute(ObservableProperty.VALUE)));
    concreteSyntaxModelByClass.put(
        MarkerAnnotationExpr.class,
        sequence(
            comment(), token(GeneratedJavaParserConstants.AT), attribute(ObservableProperty.NAME)));
    concreteSyntaxModelByClass.put(
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            comment(),
            conditional(
                ObservableProperty.SCOPE,
                IS_PRESENT,
                sequence(child(ObservableProperty.SCOPE), token(GeneratedJavaParserConstants.DOT))),
            typeArguments(),
            child(ObservableProperty.NAME),
            token(GeneratedJavaParserConstants.LPAREN),
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            comment(),
            conditional(
                ObservableProperty.QUALIFIER,
                IS_PRESENT,
                sequence(
                    child(ObservableProperty.QUALIFIER), token(GeneratedJavaParserConstants.DOT))),
            attribute(ObservableProperty.IDENTIFIER),
            orphanCommentsEnding()));
    concreteSyntaxModelByClass.put(
        NameExpr.class,
        sequence(comment(), child(ObservableProperty.NAME), orphanCommentsEnding()));
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            child(ObservableProperty.NAME),
            conditional(
                ObservableProperty.PAIRS, IS_NOT_EMPTY, token(GeneratedJavaParserConstants.LPAREN)),
            list(ObservableProperty.PAIRS, sequence(comma(), space())),
            conditional(
                ObservableProperty.PAIRS,
                IS_NOT_EMPTY,
                token(GeneratedJavaParserConstants.RPAREN))));
    concreteSyntaxModelByClass.put(
        NullLiteralExpr.class, sequence(comment(), token(GeneratedJavaParserConstants.NULL)));
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            token(GeneratedJavaParserConstants.RPAREN),
            conditional(
                ObservableProperty.ANONYMOUS_CLASS_BODY,
                IS_PRESENT,
                sequence(
                    space(),
                    token(LBRACE),
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            token(GeneratedJavaParserConstants.RPAREN)));
    concreteSyntaxModelByClass.put(
        StringLiteralExpr.class, sequence(comment(), stringToken(ObservableProperty.VALUE)));
    concreteSyntaxModelByClass.put(
        TextBlockLiteralExpr.class, sequence(comment(), textBlockToken(ObservableProperty.VALUE)));
    concreteSyntaxModelByClass.put(
        SuperExpr.class,
        sequence(
            comment(),
            conditional(
                TYPE_NAME,
                IS_PRESENT,
                sequence(child(TYPE_NAME), token(GeneratedJavaParserConstants.DOT))),
    ...
    concreteSyntaxModelByClass.put(
        TypeExpr.class, sequence(comment(), child(ObservableProperty.TYPE)));
    concreteSyntaxModelByClass.put(
        UnaryExpr.class,
        sequence(
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            conditional(
                ObservableProperty.LABEL,
                IS_PRESENT,
                sequence(space(), child(ObservableProperty.LABEL))),
            semicolon()));
    concreteSyntaxModelByClass.put(
        CatchClause.class,
        sequence(
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            semicolon()));
    concreteSyntaxModelByClass.put(
        EmptyStmt.class, sequence(comment(), token(GeneratedJavaParserConstants.SEMICOLON)));
    concreteSyntaxModelByClass.put(
        UnparsableStmt.class, sequence(comment(), token(GeneratedJavaParserConstants.SEMICOLON)));
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            conditional(
                ...
                sequence(
                    ...
                    unindent())),
            conditional(
                ObservableProperty.ELSE_STMT,
                IS_PRESENT,
                sequence(
                    token(GeneratedJavaParserConstants.ELSE),
                    conditional(
                        Arrays.asList(
                            ObservableProperty.ELSE_BLOCK, ObservableProperty.CASCADING_IF_STMT),
                        CsmConditional.Condition.FLAG,
                        sequence(space(), child(ObservableProperty.ELSE_STMT)),
                        sequence(
                            newline(),
                            indent(),
                            child(ObservableProperty.ELSE_STMT),
                            unindent()))))));
    concreteSyntaxModelByClass.put(
        LabeledStmt.class,
        sequence(
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(comment(), child(ObservableProperty.CLASS_DECLARATION)));
    concreteSyntaxModelByClass.put(
        LocalRecordDeclarationStmt.class,
        sequence(comment(), child(ObservableProperty.RECORD_DECLARATION)));
    concreteSyntaxModelByClass.put(
        ReturnStmt.class,
        sequence(
            comment(),
            ...
            conditional(
                ObservableProperty.EXPRESSION,
                IS_PRESENT,
                sequence(space(), child(ObservableProperty.EXPRESSION))),
            semicolon()));
    concreteSyntaxModelByClass.put(
        YieldStmt.class,
        sequence(
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            space(),
            conditional(
                ObservableProperty.RESOURCES,
                CsmConditional.Condition.IS_NOT_EMPTY,
                sequence(
                    token(LPAREN),
                    list(
                        ObservableProperty.RESOURCES,
                        sequence(semicolon(), newline()),
                        indent(),
                        unindent()),
                    token(RPAREN),
                    space())),
            ...
            conditional(
                ObservableProperty.FINALLY_BLOCK,
                IS_PRESENT,
                sequence(
                    space(),
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            conditional(
                SCOPE,
                IS_PRESENT,
                sequence(child(SCOPE), string(GeneratedJavaParserConstants.DOT))),
            list(ANNOTATIONS, space(), none(), space()),
            child(NAME),
            conditional(
                ObservableProperty.USING_DIAMOND_OPERATOR,
                FLAG,
                sequence(
                    string(GeneratedJavaParserConstants.LT),
                    string(GeneratedJavaParserConstants.GT)),
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            annotations(),
            list(
                ObservableProperty.ELEMENTS,
                sequence(space(), token(GeneratedJavaParserConstants.BIT_AND), space()))));
    concreteSyntaxModelByClass.put(
        PrimitiveType.class,
        sequence(
            comment(), list(ObservableProperty.ANNOTATIONS), attribute(ObservableProperty.TYPE)));
    concreteSyntaxModelByClass.put(
        TypeParameter.class,
        sequence(
            comment(),
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            list(
                ObservableProperty.ELEMENTS,
                sequence(space(), token(GeneratedJavaParserConstants.BIT_OR), space()))));
    concreteSyntaxModelByClass.put(UnknownType.class, none());
    concreteSyntaxModelByClass.put(
        VoidType.class,
        sequence(comment(), annotations(), token(GeneratedJavaParserConstants.VOID)));
    concreteSyntaxModelByClass.put(
        VarType.class,
        sequence(comment(), annotations(), string(GeneratedJavaParserConstants.IDENTIFIER, "var")));
    concreteSyntaxModelByClass.put(
        WildcardType.class,
        sequence(
            comment(),
            ...
            token(GeneratedJavaParserConstants.HOOK),
            conditional(
                ObservableProperty.EXTENDED_TYPE,
                IS_PRESENT,
                sequence(
                    space(),
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            conditional(
                ...
                sequence(
                    token(GeneratedJavaParserConstants.DOT),
                    token(GeneratedJavaParserConstants.STAR))),
            semicolon(),
            orphanCommentsEnding()));
    concreteSyntaxModelByClass.put(
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            conditional(
                ...
                FLAG,
                sequence(token(GeneratedJavaParserConstants.OPEN), space())),
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            child(ObservableProperty.NAME),
            list(
                ObservableProperty.MODULE_NAMES,
                sequence(comma(), space()),
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            newline()));
    concreteSyntaxModelByClass.put(
        ModuleProvidesDirective.class,
        sequence(
            token(GeneratedJavaParserConstants.PROVIDES),
            space(),
            child(ObservableProperty.NAME),
            list(
                ObservableProperty.WITH,
                sequence(comma(), space()),
    ...
    concreteSyntaxModelByClass.put(
        ...
        sequence(
            ...
            semicolon(),
            newline()));
    List<String> unsupportedNodeClassNames =
    ...
    if (unsupportedNodeClassNames.isEmpty()) {
      ...
      initializationError =
          Optional.of(
              "The "
                  + ConcreteSyntaxModel.class.getSimpleName()
                  + " should include support for these classes: "
                  + String.join(", ", unsupportedNodeClassNames));
    }
  }

...
/**
 * Configuration options for the {@link PrettyPrinter}. This class is no longer acceptable to use
 * because it is not sufficiently configurable and it is too tied to a specific implementation
 *
 * <p>Use {@link PrinterConfiguration interface or DefaultPrinterConfiguration default
 * implementation } instead.
 *
 * @deprecated This class could be removed in a future version. Use default
...
public class PrettyPrinterConfiguration implements PrinterConfiguration {
  ...
  public PrettyPrinterConfiguration setIndentation(Indentation indentation) {
    wrappedConfiguration.addOption(
        new DefaultConfigurationOption(ConfigOption.INDENTATION, indentation));
    return this;
  }
  ...
  /**
   * When true, all comments will be printed, unless printJavadoc is false, then only line and block
  ...
  public PrettyPrinterConfiguration setColumnAlignFirstMethodChain(
      boolean columnAlignFirstMethodChain) {
    wrappedConfiguration =
        columnAlignFirstMethodChain
            ? addOption(
                new DefaultConfigurationOption(ConfigOption.COLUMN_ALIGN_FIRST_METHOD_CHAIN))
            : removeOption(
                new DefaultConfigurationOption(ConfigOption.COLUMN_ALIGN_FIRST_METHOD_CHAIN));
    return this;
  }
  ...
  public PrettyPrinterConfiguration setEndOfLineCharacter(String endOfLineCharacter) {
    addOption(
        new DefaultConfigurationOption(ConfigOption.END_OF_LINE_CHARACTER, endOfLineCharacter));
    return this;
  }
   ...
   * </pre>
   *
   * until the amount of constants passes this currentValue (5 by default). Then they get aligned
   * like this:
   *
   * <pre>
   *     enum X {
   ...
   * </pre>
   *
   * Set it to a large number to always align horizontally. Set it to 1 or less to always align
   * vertically.
   */
  public PrettyPrinterConfiguration setMaxEnumConstantsToAlignHorizontally(
      int maxEnumConstantsToAlignHorizontally) {
    addOption(

...
public class CsmAttribute implements CsmElement {
  ...
  /**
   * Obtain the token type corresponding to the specific value of the attribute. For example, to the
   * attribute "Operator" different token could correspond like PLUS or MINUS.
   *

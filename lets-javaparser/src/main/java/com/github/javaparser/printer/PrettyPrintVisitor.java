...
/**
 * Outputs the AST as formatted Java source code. This class is no longer acceptable to use because
 * it is not sufficiently configurable and it is too tied to a specific implementation
 *
 * <p>Use {@link DefaultPrettyPrinterVisitor default implementation } instead.
 *
 * @author Julio Vilmar Gesser
 * @deprecated This class is no longer acceptable to use because it is not sufficiently configurable
 *     and it is too tied to a specific implementation. This class could be removed in a future
 *     version. Use default DefaultPrettyPrinterVisitor.
 */
@Deprecated
public class PrettyPrintVisitor implements VoidVisitor<Void> {
  ...
  protected void printMemberAnnotations(
      final NodeList<AnnotationExpr> annotations, final Void arg) {
  ...
  protected void printTypeArgs(
      final NodeWithTypeArguments<?> nodeWithTypeArguments, final Void arg) {

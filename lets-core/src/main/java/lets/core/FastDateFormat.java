...
public class FastDateFormat extends Format implements DateParser, DatePrinter {
  ...
  // -----------------------------------------------------------------------
  /**
   * Formats a {@code Date}, {@code Calendar} or {@code Long} (milliseconds) object. This method is
   * an implementation of {@link Format#format(Object, StringBuffer, FieldPosition)}
   *

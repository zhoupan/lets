 ...
 * </pre>
 *
 * <p>The above example converts {@code "UTF-8:com/domain/document.properties"} to the UTF-8
 * contents of the file at {@code com/domain/document.properties}.
 *
 ...
 * </pre>
 *
 * <p>The above example converts {@code "UTF-8:SomePath"} to the UTF-8 contents of the file at
 * {@code SomePath}.
 *
 * @since 1.5
 */
final class FileStringLookup extends AbstractPathFencedLookup {
   ...
   *
   * <p>For example: "UTF-8:com/domain/document.properties".
   *
  ...
  public String lookup(final String key) {
    ...
    if (keyLen < 2) {
      throw IllegalArgumentExceptions.format(
          "Bad file key format [%s], expected format is CharsetName:DocumentPath.", key);
    }
    ...
    try {
      ...
      throw IllegalArgumentExceptions.format(
          e, "Error looking up file [%s] with charset [%s].", fileName, charsetName);
    }
  }
}

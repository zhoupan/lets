...
public class WordUtils {
   ...
   *
   * <p>This method searches for the first space after the lower limit and abbreviates the String
   * there. It will also append any String passed as a parameter to the end of the String. The upper
   * limit can be specified to forcibly abbreviate a String.
   *
   * @param str the string to be abbreviated. If null is passed, null is returned. If the empty
   *     String is passed, the empty string is returned.
   * @param lower the lower limit; negative value is treated as zero.
   * @param upper the upper limit; specify -1 if no limit is desired. The upper limit cannot be
   *     lower than the lower limit.
   * @param appendToEnd String to be appended to the end of the abbreviated string. This is appended
   *     ONLY if the string was indeed abbreviated. The append does not count towards the lower or
   *     upper limits.
  ...
  public static String abbreviate(
      final String str, int lower, int upper, final String appendToEnd) {
   ...
   * <td>null</td>
   * <td>true/false</td>
   * <td>"Here is one line of" + systemNewLine + "text that is going" + systemNewLine + "to be wrapped
   * after" + systemNewLine + "20 columns."</td>
   * </tr>
   * <tr>
   * <td>"Click here to jump to the commons website - https://commons.apache.org"</td>
   * <td>20</td>
  ...
  /**
   * {@code WordUtils} instances should NOT be constructed in standard programming. Instead, the
   * class should be used as {@code WordUtils.wrap("foo bar", 20);}.
   *

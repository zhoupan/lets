 ...
 *
 * <p>Note that as MutableDouble does not extend Double, it is not treated by String.format as a
 * Double parameter.
 *
 * @see Double
 * @since 2.1
...
public class MutableDouble extends Number implements Comparable<MutableDouble>, Mutable<Number> {
   ...
   *
   * <p>Note that in most cases, for two instances of class {@code Double},{@code d1} and {@code
   * d2}, the value of {@code d1.equals(d2)} is {@code true} if and only if
   *
   * <blockquote>
   *
   * <pre>
   ...
   *       versa, the {@code equal} test has the value {@code false}, even though {@code +0.0==-0.0}
   *       has the value {@code true}. This allows hashtables to operate properly.
   * </ul>
   *

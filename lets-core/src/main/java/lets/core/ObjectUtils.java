 ...
 *
 * <p>This class tries to handle {@code null} input gracefully. An exception will generally not be
 * thrown for a {@code null} input. Each method documents its behavior in more detail.
 *
 * <p>#ThreadSafe#
 *
 * @since 1.0
...
public class ObjectUtils {
   ...
   *
   * <p>For example, in a {@code HashMap} the {@link java.util.HashMap#get(java.lang.Object)} method
   ...
   *
   * <p>Another example is {@code Hashtable}, where {@code null} cannot be stored.
   */
   ...
   *
   * <p>This method is similar to {@link #clone(Object)}, but will return the provided instance as
  ...
  public static <T extends Comparable<? super T>> int compare(
      final T c1, final T c2, final boolean nullGreater) {
    if (c1 == c2) {
      return 0;
    } else if (c1 == null) {
  ...
  /**
   * This method returns the provided value unchanged. This can prevent javac from inlining a
   * constant field, e.g.,
   *
   * <pre>
   ...
   * @return {@code object} if it is not {@code null}, defaultValue otherwise TODO Rename to
   *     getIfNull in 4.0
   */
   ...
   *
   * <p>This allows a hash code to be rapidly calculated for a number of objects. The hash code for
   * a single object is the <em>not</em> same as {@link #hashCode(Object)}. The hash code for
   ...
   * @since 3.2
   */
  public static void identityToString(final Appendable appendable, final Object object)
      throws IOException {
  ...
  // -----------------------------------------------------------------------
  /**
   * Gets the toString that would be produced by {@code Object} if a class did not override toString
  ...
  // -----------------------------------------------------------------------
  /**
   * Checks if an Object is empty or null. The following types are supported:
   *
   * <ul>
  ...
  /**
   * Checks if an Object is not empty and not null. The following types are supported:
   *
   * <ul>
   *   <li>{@link CharSequence}: Considered empty if its length is zero.
   *   <li>{@code Array}: Considered empty if its length is zero.
   ...
   * @since 2.0
   * @deprecated this method has been replaced by {@code java.util.Objects.toString(Object)} in Java
   *     7 and will be removed in future releases. Note however that said method will return "null"
   *     for null references, while this method returns an empty String. To preserve behavior use
   ...
   * @since 2.0
   * @deprecated this method has been replaced by {@code java.util.Objects.toString(Object, String)}
   *     in Java 7 and will be removed in future releases.
   */
  @Deprecated
  ...
  /**
   * {@code ObjectUtils} instances should NOT be constructed in standard programming. Instead, the
   * static methods on the class should be used, such as {@code

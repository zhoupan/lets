...
public class RegExUtils {
  ...
  /** The Constant REGEX_TO_PATTERN. */
  private static final Map<String, Pattern> REGEX_TO_PATTERN =
   ...
   *
   * <ul>
   *   <li>{@code pattern.matcher(text).replaceAll(StringUtils.EMPTY)}
   * </ul>
   *
  ...
  /**
   * Removes each substring of the text String that matches the given regular expression. This
   * method is a {@code null} safe equivalent to:
   *
   * <ul>
   *   <li>{@code text.replaceAll(regex, StringUtils.EMPTY)}
   *   <li>{@code Pattern.compile(regex).matcher(text).replaceAll(StringUtils.EMPTY)}
   * </ul>
   *
   * <p>A {@code null} reference passed to this method is a no-op.
   *
   * <p>Unlike in the {@link #removePattern(String, String)} method, the {@link Pattern#DOTALL}
   * option is NOT automatically added. To use the DOTALL option prepend {@code "(?s)"} to the
   * regex. DOTALL is also known as single-line mode in Perl.
   *
   * <pre>
   * StringUtils.removeAll(null, *)      = null
   ...
   * pattern. This method is a {@code null} safe equivalent to:
   *
   * <ul>
   *   <li>{@code pattern.matcher(text).replaceFirst(StringUtils.EMPTY)}
   * </ul>
   *
   * <p>A {@code null} reference passed to this method is a no-op.
   *
  ...
  /**
   * Removes the first substring of the text string that matches the given regular expression. This
   * method is a {@code null} safe equivalent to:
   *
   * <ul>
   *   <li>{@code text.replaceFirst(regex, StringUtils.EMPTY)}
   *   <li>{@code Pattern.compile(regex).matcher(text).replaceFirst(StringUtils.EMPTY)}
   * </ul>
   *
   * <p>A {@code null} reference passed to this method is a no-op.
   *
   * <p>The {@link Pattern#DOTALL} option is NOT automatically added. To use the DOTALL option
   ...
   * DOTALL option. This call is a {@code null} safe equivalent to:
   *
   * <ul>
   *   <li>{@code text.replaceAll(&quot;(?s)&quot; + regex, StringUtils.EMPTY)}
   *   <li>{@code Pattern.compile(regex,
   *       Pattern.DOTALL).matcher(text).replaceAll(StringUtils.EMPTY)}
   * </ul>
   *
   * <p>A {@code null} reference passed to this method is a no-op.
   *
  ...
  /**
   * Replaces each substring of the text String that matches the given regular expression pattern
   * with the given replacement. This method is a {@code null} safe equivalent to:
   *
   * <ul>
   *   <li>{@code pattern.matcher(text).replaceAll(replacement)}
   * </ul>
   *
   * <p>A {@code null} reference passed to this method is a no-op.
   *
  ...
  public static String replaceAll(
      final String text, final Pattern regex, final String replacement) {
  ...
  /**
   * Replaces each substring of the text String that matches the given regular expression with the
   * given replacement. This method is a {@code null} safe equivalent to:
   *
   * <ul>
   *   <li>{@code text.replaceAll(regex, replacement)}
   *   <li>{@code Pattern.compile(regex).matcher(text).replaceAll(replacement)}
   * </ul>
   *
   * <p>A {@code null} reference passed to this method is a no-op.
   *
   * <p>Unlike in the {@link #replacePattern(String, String, String)} method, the {@link
   * Pattern#DOTALL} option is NOT automatically added. To use the DOTALL option prepend {@code
   * "(?s)"} to the regex. DOTALL is also known as single-line mode in Perl.
   *
   * <pre>
   * StringUtils.replaceAll(null, *, *)       = null
   ...
   * pattern with the given replacement. This method is a {@code null} safe equivalent to:
   *
   * <ul>
   *   <li>{@code pattern.matcher(text).replaceFirst(replacement)}
   * </ul>
   *
   * <p>A {@code null} reference passed to this method is a no-op.
   *
  ...
  /**
   * Replaces the first substring of the text string that matches the given regular expression with
   * the given replacement. This method is a {@code null} safe equivalent to:
   *
   * <ul>
   *   <li>{@code text.replaceFirst(regex, replacement)}
   *   <li>{@code Pattern.compile(regex).matcher(text).replaceFirst(replacement)}
   * </ul>
   *
   * <p>A {@code null} reference passed to this method is a no-op.
   *
   ...
   */
  public static String replaceFirst(
      final String text, final String regex, final String replacement) {
    if ((text == null) || (regex == null) || (replacement == null)) {
      return text;
    }
   ...
   * given replacement using the {@link Pattern#DOTALL} option. DOTALL is also known as single-line
   * mode in Perl. This call is a {@code null} safe equivalent to:
   *
   * <ul>
   *   <li>{@code text.replaceAll(&quot;(?s)&quot; + regex, replacement)}
   *   <li>{@code Pattern.compile(regex, Pattern.DOTALL).matcher(text).replaceAll(replacement)}
   * </ul>
   *
   * <p>A {@code null} reference passed to this method is a no-op.
   *
   ...
   * @return the pattern
   */
  public static synchronized Pattern compileOrGet(String regex) {
    if (REGEX_TO_PATTERN.containsKey(regex)) {
      return REGEX_TO_PATTERN.get(regex);
    }
    Pattern p = Pattern.compile(regex);
    REGEX_TO_PATTERN.put(regex, p);
    return p;
  }

  /**
   * Checks if is i pv 4 address.
   *
   * @param ip the ip
   * @return true, if is i pv 4 address
   */
  public static boolean isIpv4Address(String ip) {
    return compileOrGet(REGEX_IPV4_ADDRESS).matcher(ip).matches();
  }
}

 ...
 * throw an exception. Each method documents its behavior.
 *
 * <p>#ThreadSafe#
 *
 * @since 2.0
...
public class ArrayUtils {
   ...
   * indices).
   *
   * <p>This method returns a new array with the same elements of the input array plus the given
   ...
   *     may be removed in a future release. Please note the handling of {@code null} input arrays
   *     differs in the new method: inserting {@code X} into a {@code null} array results in {@code
   *     null} not {@code X}.
   */
  @Deprecated
   ...
   * @throws IndexOutOfBoundsException if the index is out of range (index &lt; 0 || index &gt;
   *     array.length).
   * @deprecated this method has been superseded by {@link #insert(int, byte[], byte...)} and may be
   *     removed in a future release. Please note the handling of {@code null} input arrays differs
   *     in the new method: inserting {@code X} into a {@code null} array results in {@code null}
   *     not {@code X}.
   */
  @Deprecated
   ...
   * @throws IndexOutOfBoundsException if the index is out of range (index &lt; 0 || index &gt;
   *     array.length).
   * @deprecated this method has been superseded by {@link #insert(int, char[], char...)} and may be
   *     removed in a future release. Please note the handling of {@code null} input arrays differs
   *     in the new method: inserting {@code X} into a {@code null} array results in {@code null}
   *     not {@code X}.
   */
   ...
   * @throws IndexOutOfBoundsException if the index is out of range (index &lt; 0 || index &gt;
   *     array.length).
   * @deprecated this method has been superseded by {@link #insert(int, float[], float...)} and may
   *     be removed in a future release. Please note the handling of {@code null} input arrays
   *     differs in the new method: inserting {@code X} into a {@code null} array results in {@code
   *     null} not {@code X}.
   */
  @Deprecated
   ...
   * @throws IndexOutOfBoundsException if the index is out of range (index &lt; 0 || index &gt;
   *     array.length).
   * @deprecated this method has been superseded by {@link #insert(int, int[], int...)} and may be
   *     removed in a future release. Please note the handling of {@code null} input arrays differs
   *     in the new method: inserting {@code X} into a {@code null} array results in {@code null}
   *     not {@code X}.
   */
   ...
   * @throws IndexOutOfBoundsException if the index is out of range (index &lt; 0 || index &gt;
   *     array.length).
   * @deprecated this method has been superseded by {@link #insert(int, long[], long...)} and may be
   *     removed in a future release. Please note the handling of {@code null} input arrays differs
   *     in the new method: inserting {@code X} into a {@code null} array results in {@code null}
   *     not {@code X}.
   */
  ...
  private static Object add(
      final Object array, final int index, final Object element, final Class<?> clss) {
    if (array == null) {
      if (index != 0) {
   ...
   * @throws IndexOutOfBoundsException if the index is out of range (index &lt; 0 || index &gt;
   *     array.length).
   * @deprecated this method has been superseded by {@link #insert(int, short[], short...)} and may
   *     be removed in a future release. Please note the handling of {@code null} input arrays
   *     differs in the new method: inserting {@code X} into a {@code null} array results in {@code
   *     null} not {@code X}.
   */
   ...
   * @deprecated this method has been superseded by {@link #insert(int, Object[], Object...)
   *     insert(int, T[], T...)} and may be removed in a future release. Please note the handling of
   *     {@code null} input arrays differs in the new method: inserting {@code X} into a {@code
  ...
  public static <T> T[] addAll(final T[] array1, @SuppressWarnings("unchecked") final T... array2) {
    ...
    try {
      ...
      /*
       * We do this here, rather than before the copy because: - it would be a wasted check most of the
       * time - safer, in case check turns out to be too strict
       */
   ...
   *
   * <p>The new array contains the same elements of the input array plus the given element in the
   * first position. The component type of the new array is the same as that of the input array.
   *
   * <p>If the input array is {@code null}, a new one element array is returned whose component type
   * is the same as the element.
   *
   ...
   *
   * <p>The new array contains the same elements of the input array plus the given element in the
   * first positioaddFirstaddFirstaddFirstn. The component type of the new array is the same as that
   * of the input array.
   *
   * <p>If the input array is {@code null}, a new one element array is returned whose component type
   * is the same as the element, unless the element itself is null, in which case the return type is
  ...
  public static boolean contains(
      final double[] array, final double valueToFind, final double tolerance) {
   ...
   * @param valueToFind the value to find
   * @return a BitSet of all the the indices of the value within the array, an empty BitSet if not
   ...
   * return an empty BitSet ({@code -1}).
   *
   * @param array the array to search through for the object, may be {@code null}
   * @param valueToFind the value to find
   * @param startIndex the index to start searching at
   * @return a BitSet of all the indices of the value within the array, an empty BitSet if not found
   ...
   *
   * <p>This method will return all the indices of the value which fall between the region defined
   * by valueToFind - tolerance and valueToFind + tolerance, each time between the nearest integers.
   *
   * <p>This method returns an empty BitSet for a {@code null} input array.
   *
   * @param array the array to search through for the object, may be {@code null}
   ...
   * @since 3.10
   */
  public static BitSet indexesOf(
      final double[] array, final double valueToFind, final double tolerance) {
   ...
   * @param valueToFind the value to find
   * @param startIndex the index to start searching at
   * @return a BitSet of the indices of the value within the array, an empty BitSet if not found or
   ...
   * Finds the indices of the given value in the array starting at the given index.
   *
   * <p>This method will return the indices of the values which fall between the region defined by
   * valueToFind - tolerance and valueToFind + tolerance, between the nearest integers.
   *
   * <p>This method returns an empty BitSet for a {@code null} input array.
   *
   * <p>A negative startIndex is treated as zero. A startIndex larger than the array length will
   ...
   */
  public static BitSet indexesOf(
      final double[] array, final double valueToFind, int startIndex, final double tolerance) {
    final BitSet bitSet = new BitSet();
   ...
   * @return a BitSet of all the indices of the object within the array, an empty BitSet if not
   *     found or {@code null} array input
   * @since 3.10
   */
   ...
   * @param objectToFind the object to find, may be {@code null}
   * @param startIndex the index to start searching at
   * @return a BitSet of all the indices of the object within the array starting at the index, an
   *     empty BitSet if not found or {@code null} array input
   * @since 3.10
   */
   ...
   *
   * <p>When an array is returned, it is always a new array.
   *
   * <pre>
   ...
   * @throws IndexOutOfBoundsException if {@code array} is provided and either {@code index < 0} or
  ...
  public static <T> T[] insert(final int index, final T[] array, final T... values) {
     ...
     *
     * By returning null when 'array' is null, we avoid returning the vararg array to the caller. We
     * also avoid relying on the type of the vararg array, by inspecting the component type of 'array'.
     */
   ...
   * @deprecated this method has been replaced by {@code java.util.Objects.deepEquals(Object,
   *     Object)} and will be removed from future releases.
   */
  @Deprecated
  ...
  /**
   * This method checks whether the provided array is sorted according to natural ordering ({@code
   * false} before {@code true}).
   *
  ...
  /**
   * This method checks whether the provided array is sorted according to the class's {@code
   * compareTo} method.
   *
   * @param array the array to check
  ...
  /**
   * This method checks whether the provided array is sorted according to the provided {@code
   * Comparator}.
   *
   * @param array the array to check
   ...
   *
   * <p>This method returns {@link #INDEX_NOT_FOUND} ({@code -1}) if {@code null} array input.
   *
   ...
   * <p>This method returns {@link #INDEX_NOT_FOUND} ({@code -1}) for a {@code null} input array.
   *
   * <p>A negative startIndex will return {@link #INDEX_NOT_FOUND} ({@code -1}). A startIndex larger
   ...
   *
   * <p>This method returns a new array with the same elements of the input array except those at
   * the specified positions. The component type of the returned array is always the same as that of
   * the input array.
   *
   * <p>If the input array is {@code null}, an IndexOutOfBoundsException will be thrown, because in
   * that case no valid index can be specified.
   ...
   */
  @SuppressWarnings(
      "unchecked") // removeAll() always creates an array of the same type as its input
   ...
   *
   * <p>All subsequent elements are shifted to the left (subtracts one from their indices). If the
   * array doesn't contains such an element, no elements are removed from the array. {@code null}
   * will be returned if the input array is {@code null}.
   *
   * @param element the element to remove
   * @param array the input array
   * @return A new array containing the existing elements except the occurrences of the specified
   *     element.
   * @since 3.5
   ...
   *
   * <p>This method returns a new array with the same elements of the input array except the first
   ...
   *
   * <p>This method returns a new array with the same elements of the input array except for the
  ...
  public static boolean[] removeElements(final boolean[] array, final boolean... values) {
    ...
    final HashMap<Boolean, MutableInt> occurrences =
        new HashMap<>(2); // only two possible values here
  ...
  public static void reverse(
      final boolean[] array, final int startIndexInclusive, final int endIndexExclusive) {
    if (array == null) {
      return;
    }
   ...
   */
  public static void reverse(
      final byte[] array, final int startIndexInclusive, final int endIndexExclusive) {
    if (array == null) {
      return;
    }
    int i = Math.max(startIndexInclusive, 0);
   ...
   */
  public static void reverse(
      final char[] array, final int startIndexInclusive, final int endIndexExclusive) {
    if (array == null) {
      return;
    }
    int i = Math.max(startIndexInclusive, 0);
   ...
   */
  public static void reverse(
      final double[] array, final int startIndexInclusive, final int endIndexExclusive) {
    if (array == null) {
      return;
    }
    int i = Math.max(startIndexInclusive, 0);
   ...
   */
  public static void reverse(
      final float[] array, final int startIndexInclusive, final int endIndexExclusive) {
    if (array == null) {
      return;
    }
    int i = Math.max(startIndexInclusive, 0);
   ...
   */
  public static void reverse(
      final long[] array, final int startIndexInclusive, final int endIndexExclusive) {
    if (array == null) {
      return;
    }
    int i = Math.max(startIndexInclusive, 0);
   ...
   *     (&gt;array.length) results in no change.
   * @param endIndexExclusive elements up to endIndex-1 are reversed in the array. Under value (&lt;
   *     start index) results in no change. Over value (&gt;array.length) is demoted to array
   *     length.
   * @since 3.2
   */
  public static void reverse(
      final Object[] array, final int startIndexInclusive, final int endIndexExclusive) {
    if (array == null) {
      return;
    }
    int i = Math.max(startIndexInclusive, 0);
   ...
   */
  public static void reverse(
      final short[] array, final int startIndexInclusive, final int endIndexExclusive) {
    if (array == null) {
      return;
    }
    int i = Math.max(startIndexInclusive, 0);
   ...
   *
   * <p>There is no special handling for multi-dimensional arrays. This method does nothing for
   * {@code null} or empty input arrays.
   *
   * @param array the array to shift, may be {@code null}
   * @param offset The number of positions to rotate the elements. If the offset is larger than the
   *     number of elements to rotate, than the effective offset is modulo the number of elements to
   *     rotate.
   * @since 3.5
   */
   ...
   * @param startIndexInclusive the starting index. Undervalue (&lt;0) is promoted to 0, overvalue
   *     (&gt;array.length) results in no change.
   * @param endIndexExclusive elements up to endIndex-1 are shifted in the array. Undervalue (&lt;
   *     start index) results in no change. Overvalue (&gt;array.length) is demoted to array length.
   * @param offset The number of positions to rotate the elements. If the offset is larger than the
   *     number of elements to rotate, than the effective offset is modulo the number of elements to
   *     rotate.
  ...
  public static void shift(
      final boolean[] array, int startIndexInclusive, int endIndexExclusive, int offset) {
    if (array == null) {
      return;
    }
   ...
   */
  public static void shift(
      final byte[] array, int startIndexInclusive, int endIndexExclusive, int offset) {
    if (array == null) {
      return;
    }
    if (startIndexInclusive >= array.length - 1 || endIndexExclusive <= 0) {
   ...
   */
  public static void shift(
      final char[] array, int startIndexInclusive, int endIndexExclusive, int offset) {
    if (array == null) {
      return;
    }
    if (startIndexInclusive >= array.length - 1 || endIndexExclusive <= 0) {
   ...
   */
  public static void shift(
      final double[] array, int startIndexInclusive, int endIndexExclusive, int offset) {
    if (array == null) {
      return;
    }
    if (startIndexInclusive >= array.length - 1 || endIndexExclusive <= 0) {
   ...
   */
  public static void shift(
      final float[] array, int startIndexInclusive, int endIndexExclusive, int offset) {
    if (array == null) {
      return;
    }
    if (startIndexInclusive >= array.length - 1 || endIndexExclusive <= 0) {
   ...
   */
  public static void shift(
      final int[] array, int startIndexInclusive, int endIndexExclusive, int offset) {
    if (array == null) {
      return;
    }
    if (startIndexInclusive >= array.length - 1 || endIndexExclusive <= 0) {
   ...
   */
  public static void shift(
      final long[] array, int startIndexInclusive, int endIndexExclusive, int offset) {
    if (array == null) {
      return;
    }
    if (startIndexInclusive >= array.length - 1 || endIndexExclusive <= 0) {
   ...
   */
  public static void shift(
      final Object[] array, int startIndexInclusive, int endIndexExclusive, int offset) {
    if (array == null) {
      return;
    }
    if (startIndexInclusive >= array.length - 1 || endIndexExclusive <= 0) {
   ...
   */
  public static void shift(
      final short[] array, int startIndexInclusive, int endIndexExclusive, int offset) {
    if (array == null) {
      return;
    }
    if (startIndexInclusive >= array.length - 1 || endIndexExclusive <= 0) {
   ...
   * @see <a href="https://en.wikipedia.org/wiki/Fisher%E2%80%93Yates_shuffle">Fisher-Yates shuffle
   *     algorithm</a>
   * @since 3.6
   */
   ...
   *
   * <p>The start index is inclusive, the end index exclusive. Null array input produces null
   * output.
   *
   ...
   *     Undervalue (&lt; startIndex) produces empty array, overvalue (&gt;array.length) is demoted
   *     to array length.
  ...
  public static char[] subarray(
      final char[] array, int startIndexInclusive, int endIndexExclusive) {
    if (array == null) {
      return null;
    }
    if (startIndexInclusive < 0) {
  ...
  public static double[] subarray(
      final double[] array, int startIndexInclusive, int endIndexExclusive) {
    if (array == null) {
      return null;
    }
    if (startIndexInclusive < 0) {
  ...
  public static float[] subarray(
      final float[] array, int startIndexInclusive, int endIndexExclusive) {
    if (array == null) {
      return null;
    }
    if (startIndexInclusive < 0) {
  ...
  public static long[] subarray(
      final long[] array, int startIndexInclusive, int endIndexExclusive) {
    if (array == null) {
      return null;
    }
    if (startIndexInclusive < 0) {
  ...
  public static short[] subarray(
      final short[] array, int startIndexInclusive, int endIndexExclusive) {
    if (array == null) {
      return null;
    }
    if (startIndexInclusive < 0) {
   ...
   * output.
   *
   * <p>The component type of the subarray is always the same as that of the input array. Thus, if
   ...
   *
   * <p>There is no special handling for multi-dimensional arrays. This method does nothing for a
   * {@code null} or empty input array or for overflow indices. Negative indices are promoted to
   * 0(zero). Examples:
   *
   * <ul>
   ...
   * Negative indices are promoted to 0(zero). If any of the sub-arrays to swap falls outside of the
   * given array, then the swap is stopped at the end of the array and as many as possible elements
   * are swapped. Examples:
   *
   * <ul>
   *   <li>ArrayUtils.swap([true, false, true, false], 0, 2, 1) -&gt; [true, false, true, false]
   *   <li>ArrayUtils.swap([true, false, true, false], 0, 0, 1) -&gt; [true, false, true, false]
   *   <li>ArrayUtils.swap([true, false, true, false], 0, 2, 2) -&gt; [true, false, true, false]
   *   <li>ArrayUtils.swap([true, false, true, false], -3, 2, 2) -&gt; [true, false, true, false]
   *   <li>ArrayUtils.swap([true, false, true, false], 0, 3, 3) -&gt; [false, false, true, true]
   * </ul>
   *
   * @param array the array to swap, may be {@code null}
   ...
   * </pre>
   *
   * <p>Therefore new arrays of generic types can be created with this method. For example, an array
   ...
   * </pre>
   *
   * <p>The method is typically used in scenarios, where the caller itself uses generic types that
   ...
   * explicitly like in {@code Number[] array =
   * ArrayUtils.&lt;Number&gt;toArray(Integer.valueOf(42), Double.valueOf(Math.PI))}, there is no
   * real advantage when compared to {@code new Number[] {Integer.valueOf(42),
   ...
   * @throws IllegalArgumentException if the array contains elements other than {@link
   *     java.util.Map.Entry} and an Array
   */
   ...
   *
   * <p>Multi-dimensional arrays are handled correctly, including multi-dimensional primitive
   * arrays.
   *
   ...
   * should be used as {@code ArrayUtils.clone(new int[] {2})}.
   *

...
final class JavaPlatformStringLookup extends AbstractStringLookup {
   ...
   *
   * @param args the standard Java main method parameter which is unused for our running of this
   *     class.
   */
  public static void main(final String[] args) {
    System.out.println(JavaPlatformStringLookup.class);
    System.out.printf(
        "%s = %s%n", KEY_VERSION, JavaPlatformStringLookup.INSTANCE.lookup(KEY_VERSION));
    System.out.printf(
        "%s = %s%n", KEY_RUNTIME, JavaPlatformStringLookup.INSTANCE.lookup(KEY_RUNTIME));
    ...
    System.out.printf(
        "%s = %s%n", KEY_HARDWARE, JavaPlatformStringLookup.INSTANCE.lookup(KEY_HARDWARE));
    System.out.printf(
        "%s = %s%n", KEY_LOCALE, JavaPlatformStringLookup.INSTANCE.lookup(KEY_LOCALE));
  }
  ...
  String getHardware() {
    return "processors: "
        ...
        + this.getSystemProperty("-", "sun.arch.data.model")

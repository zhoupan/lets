 ...
 * {@code false}. Checking of the file filter list stops when the first filter returns {@code
 * false}.
 *
 * @version $Id$
...
public class AndFileFilter extends AbstractFileFilter
   ...
   * And.
   *
   * @param ioFilterFilter the io filter filter
   * @return the and file filter
   */
  public AndFileFilter and(final IOFileFilter ioFilterFilter) {
    this.addFileFilter(ioFilterFilter);
    return this;
  }

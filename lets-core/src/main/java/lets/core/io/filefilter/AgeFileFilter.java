 ...
 *
 * <p>For example, to print all files and directories in the current directory older than one day:
 *
 * <pre>
 * File dir = new File(".");
...
public class AgeFileFilter extends AbstractFileFilter implements Serializable {
   ...
   *
   * @param cutoff the threshold age of the files
   * @param acceptOlder if true, older files (at or before the cutoff) are accepted, else newer ones
   *     (after the cutoff).
   */
  ...
  /**
   * Constructs a new age file filter for files older than (at or before) a certain File (whose last
   ...
   *
   * <p>If last modification time equals cutoff and newer files are required, file <b>IS NOT</b>
   * selected. If last modification time equals cutoff and older files are required, file <b>IS</b>
   * selected.
   *

 ...
 * given threshold.
 *
 * <p>For example, to print all files and directories in the current directory whose size is greater
 * than 1 MB:
 *
 * <pre>
 * File dir = new File(".");
...
public class SizeFileFilter extends AbstractFileFilter implements Serializable {
   ...
   *
   * @param size the threshold size of the files
   * @param acceptLarger if true, files equal to or larger are accepted, otherwise smaller ones (but
   *     not equal to)
   * @throws IllegalArgumentException if the size is negative
   */
   ...
   *
   * <p>If size equals threshold and smaller files are required, file <b>IS NOT</b> selected. If
   * size equals threshold and larger files are required, file <b>IS</b> selected.
   *

 ...
 *
 * <p>This filter selects files, but not directories, based on one or more wildcards and using
 ...
 * check is case-sensitive. See {@link FilenameUtils#wildcardMatch(String, String)} for more
 * information.
 *
 * <p>For example:
 *
 ...
 *
 * @since 1.1
 * @deprecated Use WildcardFileFilter. Deprecated as this class performs directory filtering which
 *     it shouldn't do, but that can't be removed due to compatibility.
 */
@Deprecated

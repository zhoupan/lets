...
public interface Resource extends InputStreamSource {
  ...
  /**
   * Indicate whether the contents of this resource can be read via {@link #getInputStream()}.
   *
   * <p>Will be {@code true} for typical resource descriptors; note that actual content reading may
   * still fail when attempted. However, a value of {@code false} is a definitive indication that
   * the resource content cannot be read.
   *
   * @see #getInputStream()
   */
  boolean isReadable();

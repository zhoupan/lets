 ...
 *
 * <p><code>LineIterator</code> holds a reference to an open <code>Reader</code>. When you have
 * finished with the iterator you should close the reader to free internal resources. This can be
 * done by closing the reader directly, or by calling the {@link #close()} or {@link
 * #closeQuietly(LineIterator)} method on the iterator.
 *
...
public class LineIterator implements Iterator<String>, Closeable {
  ...
  /**
   * Closes the underlying {@code Reader}. This method is useful if you only want to process the
   * first few lines of a larger file. If you do not close the iterator then the {@code Reader}

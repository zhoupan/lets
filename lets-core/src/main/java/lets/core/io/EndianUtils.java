...
import static lets.core.io.IOUtils.EOF;
 ...
 * the situation is reversed. This class helps you solve this incompatibility.
 *
 * <p>Origin of code: Excalibur
 *
 * @see lets.core.io.input.SwappedDataInputStream
 */
public class EndianUtils {
  ...
  /**
   * Writes a "short" value to a byte array at a given offset. The value is converted to the opposed
   * endian system while writing.
   *
  ...
  /**
   * Reads a "short" value from a byte array at a given offset. The value is converted to the
  ...
  /**
   * Reads an unsigned short (16-bit) value from a byte array at a given offset. The value is
  ...
  /**
   * Writes a "int" value to a byte array at a given offset. The value is converted to the opposed
   * endian system while writing.
   *
   * @param data target byte array
   * @param offset starting offset in the byte array
  ...
  /**
   * Reads a "int" value from a byte array at a given offset. The value is converted to the opposed
   * endian system while reading.
   *
   * @param data source byte array
   * @param offset starting offset in the byte array
   * @return the value read
  ...
  /**
   * Reads an unsigned integer (32-bit) value from a byte array at a given offset. The value is
   * converted to the opposed endian system while reading.
   *
   * @param data source byte array
   * @param offset starting offset in the byte array
  ...
  /**
   * Writes a "long" value to a byte array at a given offset. The value is converted to the opposed
   * endian system while writing.
   *
   * @param data target byte array
   * @param offset starting offset in the byte array
  ...
  /**
   * Reads a "long" value from a byte array at a given offset. The value is converted to the opposed
   * endian system while reading.
   *
   * @param data source byte array
   * @param offset starting offset in the byte array
  ...
  /**
   * Writes a "float" value to a byte array at a given offset. The value is converted to the opposed
   * endian system while writing.
   *
   * @param data target byte array
   * @param offset starting offset in the byte array
  ...
  /**
   * Reads a "float" value from a byte array at a given offset. The value is converted to the
   * opposed endian system while reading.
   *
   * @param data source byte array
   * @param offset starting offset in the byte array
  ...
  /**
   * Writes a "double" value to a byte array at a given offset. The value is converted to the
  ...
  /**
   * Reads a "double" value from a byte array at a given offset. The value is converted to the
   * opposed endian system while reading.
   *
   * @param data source byte array
   * @param offset starting offset in the byte array
  ...
  /**
   * Writes a "short" value to an OutputStream. The value is converted to the opposed endian system
   * while writing.
   *
  ...
  /**
   * Reads a "short" value from an InputStream. The value is converted to the opposed endian system
   * while reading.
   *
  ...
  /**
   * Reads a unsigned short (16-bit) from an InputStream. The value is converted to the opposed
   * endian system while reading.
   *
   * @param input source InputStream
   * @return the value just read
  ...
  /**
   * Writes a "int" value to an OutputStream. The value is converted to the opposed endian system
   * while writing.
   *
   * @param output target OutputStream
   * @param value value to write
  ...
  /**
   * Reads a "int" value from an InputStream. The value is converted to the opposed endian system
   * while reading.
   *
   * @param input source InputStream
   * @return the value just read
  ...
  /**
   * Reads a unsigned integer (32-bit) from an InputStream. The value is converted to the opposed
   * endian system while reading.
   *
   * @param input source InputStream
   * @return the value just read
  ...
  /**
   * Writes a "long" value to an OutputStream. The value is converted to the opposed endian system
   * while writing.
   *
   * @param output target OutputStream
   * @param value value to write
  ...
  /**
   * Reads a "long" value from an InputStream. The value is converted to the opposed endian system
   * while reading.
   *
   * @param input source InputStream
   * @return the value just read
  ...
  /**
   * Writes a "float" value to an OutputStream. The value is converted to the opposed endian system
   * while writing.
   *
   * @param output target OutputStream
   * @param value value to write
  ...
  /**
   * Reads a "float" value from an InputStream. The value is converted to the opposed endian system
   * while reading.
   *
   * @param input source InputStream
   * @return the value just read
  ...
  /**
   * Writes a "double" value to an OutputStream. The value is converted to the opposed endian system
   * while writing.
   *
   * @param output target OutputStream
   * @param value value to write
  ...
  /**
   * Reads a "double" value from an InputStream. The value is converted to the opposed endian system
   * while reading.
   *
   * @param input source InputStream
   * @return the value just read

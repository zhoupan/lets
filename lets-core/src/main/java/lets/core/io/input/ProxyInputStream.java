 ...
 *
 * <p>It is an alternative base class to FilterInputStream to increase reusability, because
 * FilterInputStream changes the methods being called, such as read(byte[]) to read(byte[], int,
 * int).
 *

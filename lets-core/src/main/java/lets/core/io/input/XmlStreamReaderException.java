...
/**
 * The XmlStreamReaderException is thrown by the XmlStreamReader constructors if the charset
 * encoding can not be determined according to the XML 1.0 specification and RFC 3023.
 *
 * <p>The exception returns the unconsumed InputStream to allow the application to do an alternate
 * processing with the stream. Note that the original InputStream given to the XmlStreamReader
 * cannot be used as that one has been already read.
 *
 * @since 2.0
 */
public class XmlStreamReaderException extends IOException {
   ...
   *
   * <p>Instances of this exception are thrown by the XmlStreamReader.
   *

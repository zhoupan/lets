 ...
 * bytes.
 *
 * <p>This class detects these bytes and, if required, can automatically skip them and return the
 * subsequent byte as the first byte in the stream.
 *
 * <p>The {@link ByteOrderMark} implementation has the following pre-defined BOMs:
 *
 * <ul>
 *   <li>UTF-8 - {@link ByteOrderMark#UTF_8}
 *   <li>UTF-16BE - {@link ByteOrderMark#UTF_16LE}
 *   <li>UTF-16LE - {@link ByteOrderMark#UTF_16BE}
 *   <li>UTF-32BE - {@link ByteOrderMark#UTF_32LE}
 *   <li>UTF-32LE - {@link ByteOrderMark#UTF_32BE}
 * </ul>
 *
 ...
 * </pre>
 *
 * @see lets.core.io.ByteOrderMark
...
public class BOMInputStream extends ProxyInputStream {
  ...
  /**
   * This method reads and either preserves or skips the first bytes in the stream. It behaves like
   * the single-byte <code>read()</code> method, either returning a valid byte or -1 to indicate
   * that the initial bytes have been processed already.
   *
  ...
  /**
   * Invokes the delegate's <code>read(byte[], int, int)</code> method, detecting and optionally
   * skipping BOM.
   *

 ...
 *
 * <p>First you need to create a {@link TailerListener} implementation ({@link
 * TailerListenerAdapter} is provided for convenience so that you don't have to implement every
 * method).
 *
 * <p>For example:
 *
 ...
 *
 * <p>You can create and use a Tailer in one of three ways:
 *
 * <ul>
 *   <li>Using one of the static helper methods:
 *       <ul>
 *         <li>{@link Tailer#create(File, TailerListener)}
 *         <li>{@link Tailer#create(File, TailerListener, long)}
 *         <li>{@link Tailer#create(File, TailerListener, long, boolean)}
 *       </ul>
 *   <li>Using an {@link java.util.concurrent.Executor}
 *   <li>Using an {@link Thread}
 * </ul>
 *
 * <p>An example of each of these is shown below.
 *
 ...
 *
 * <p>Remember to stop the tailer when you have done with it:
 *
 * <pre>
 *      tailer.stop();
 * </pre>
 ...
 *
 * <p>The file is read using the default charset; this can be overridden if necessary
 *
 * @see TailerListener
...
public class Tailer implements Runnable {
   ...
   * @param listener the TailerListener to use.
   * @param delayMillis the delay between checks of the file for new content in milliseconds.
   * @param end Set to true to tail from the end of the file, false to tail from the beginning of
   *     the file.
   */
  public Tailer(
  ...
  /**
   * Creates and starts a Tailer for the given file, starting at the beginning of the file with the

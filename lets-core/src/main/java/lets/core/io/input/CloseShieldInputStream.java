...
public class CloseShieldInputStream extends ProxyInputStream {
  ...
  /**
   * Replaces the underlying input stream with a {@link ClosedInputStream} sentinel. The original
   * input stream will remain open, but this proxy will appear closed.
   */
  @Override
  public void close() {

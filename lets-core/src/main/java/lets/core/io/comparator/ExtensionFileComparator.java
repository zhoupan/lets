...
/**
 * Compare the file name <b>extensions</b> for order (see {@link
 * FilenameUtils#getExtension(String)}).
 *
 * <p>This comparator can be used to sort lists or arrays of files by their file extension either in
 * a case-sensitive, case-insensitive or system dependent case sensitive way. A number of singleton
 * instances are provided for the various case sensitivity options (using {@link IOCase}) and the
 * reverse of those options.
 *
 * <p>Example of a <i>case-sensitive</i> file extension sort using the {@link #EXTENSION_COMPARATOR}
 * singleton instance:
 *
 * <pre>
 *       List&lt;File&gt; list = ...
 ...
 * </pre>
 *
 * <p>Example of a <i>reverse case-insensitive</i> file extension sort using the {@link
...
public class ExtensionFileComparator extends AbstractFileComparator implements Serializable {
  ...
  public static final Comparator<File> EXTENSION_REVERSE =
      new ReverseComparator(EXTENSION_COMPARATOR);
  ...
  public static final Comparator<File> EXTENSION_SYSTEM_REVERSE =
      new ReverseComparator(EXTENSION_SYSTEM_COMPARATOR);
   ...
   * @return a negative value if the first file's extension is less than the second, zero if the
   *     extensions are the same and a positive value if the first files extension is greater than
   *     the second file.
   */
  @Override

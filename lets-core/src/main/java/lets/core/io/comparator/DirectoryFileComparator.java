 ...
 *
 * <p>This comparator can be used to sort lists or arrays by directories and files.
 *
 * <p>Example of sorting a list of files/directories using the {@link #DIRECTORY_COMPARATOR}
 * singleton instance:
 *
 * <pre>
 *       List&lt;File&gt; list = ...
 ...
 * </pre>
 *
 * <p>Example of doing a <i>reverse</i> sort of an array of files/directories using the {@link
...
public class DirectoryFileComparator extends AbstractFileComparator implements Serializable {
  ...
  public static final Comparator<File> DIRECTORY_REVERSE =
      new ReverseComparator(DIRECTORY_COMPARATOR);

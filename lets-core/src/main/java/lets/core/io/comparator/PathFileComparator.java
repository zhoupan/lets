 ...
 *
 * <p>This comparator can be used to sort lists or arrays of files by their path either in a
 ...
 *
 * <p>Example of a <i>case-sensitive</i> file path sort using the {@link #PATH_COMPARATOR} singleton
 * instance:
 *
 * <pre>
 *       List&lt;File&gt; list = ...
 ...
 * </pre>
 *
 * <p>Example of a <i>reverse case-insensitive</i> file path sort using the {@link
...
public class PathFileComparator extends AbstractFileComparator implements Serializable {
  ...
  public static final Comparator<File> PATH_INSENSITIVE_COMPARATOR =
      new PathFileComparator(IOCase.INSENSITIVE);
  ...
  public static final Comparator<File> PATH_SYSTEM_COMPARATOR =
      new PathFileComparator(IOCase.SYSTEM);
  ...
  public static final Comparator<File> PATH_SYSTEM_REVERSE =
      new ReverseComparator(PATH_SYSTEM_COMPARATOR);
   ...
   * @return a negative value if the first file's path is less than the second, zero if the paths
   *     are the same and a positive value if the first files path is greater than the second file.
   */
  @Override

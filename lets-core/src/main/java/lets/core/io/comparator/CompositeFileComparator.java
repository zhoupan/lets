 ...
 *
 * <p>This comparator can be used to sort lists or arrays of files by combining a number other
 * comparators.
 *
 * <p>Example of sorting a list of files by type (i.e. directory or file) and then by name:
 *
 * <pre>

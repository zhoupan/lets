 ...
 *
 * <p>This comparator can be used to sort lists or arrays of files by using the default file
 * comparison.
 *
 * <p>Example of sorting a list of files using the {@link #DEFAULT_COMPARATOR} singleton instance:
 *
 * <pre>
 *       List&lt;File&gt; list = ...
 ...
 * </pre>
 *
 * <p>Example of doing a <i>reverse</i> sort of an array of files using the {@link #DEFAULT_REVERSE}
 * singleton instance:
 *
 * <pre>
 *       File[] array = ...

 ...
 *
 * <p>This comparator can be used to sort lists or arrays of files by their name either in a
 ...
 *
 * <p>Example of a <i>case-sensitive</i> file name sort using the {@link #NAME_COMPARATOR} singleton
 * instance:
 *
 * <pre>
 *       List&lt;File&gt; list = ...
 ...
 * </pre>
 *
 * <p>Example of a <i>reverse case-insensitive</i> file name sort using the {@link
...
public class NameFileComparator extends AbstractFileComparator implements Serializable {
  ...
  public static final Comparator<File> NAME_INSENSITIVE_REVERSE =
      new ReverseComparator(NAME_INSENSITIVE_COMPARATOR);
  ...
  public static final Comparator<File> NAME_SYSTEM_COMPARATOR =
      new NameFileComparator(IOCase.SYSTEM);
  ...
  public static final Comparator<File> NAME_SYSTEM_REVERSE =
      new ReverseComparator(NAME_SYSTEM_COMPARATOR);
   ...
   * @return a negative value if the first file's name is less than the second, zero if the names
   *     are the same and a positive value if the first files name is greater than the second file.
   */
  @Override

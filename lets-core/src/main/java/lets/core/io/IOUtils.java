...
import lets.core.data.ProgressSupport;
import lets.core.event.OnChangedListener;
import lets.core.io.output.ByteArrayOutputStream;
import lets.core.io.output.StringBuilderWriter;
 ...
 *   <li>{@link #copyLarge(InputStream, OutputStream, long, long, byte[])}
 *   <li>{@link #copyLarge(Reader, Writer, char[])}
 *   <li>{@link #copyLarge(Reader, Writer, long, long, char[])}
 * </ul>
 *
...
public class IOUtils {
   ...
   * @deprecated As of 2.6 removed without replacement. Please use the try-with-resources statement
   *     or handle suppressed exceptions manually.
   */
  @Deprecated
   ...
   * Closes a <code>Closeable</code> unconditionally.
   *
   * <p>Equivalent to {@link Closeable#close()}, except any exceptions will be ignored.
   *
   * <p>This is typically used in finally blocks to ensure that the closeable is closed even if an
   * Exception was thrown before the normal close statement was reached. <br>
   * <b>It should not be used to replace the close statement(s) which should be present for the
   * non-exceptional case.</b> <br>
   * It is only intended to simplify tidying up where normal processing has already failed and
   * reporting close failure as well is not necessary or useful.
   *
   * <p>Example code:
   *
   * <pre>
   ...
   *
   * <p>Equivalent to {@link Socket#close()}, except any exceptions will be ignored. This is
   * typically used in finally blocks.
   *
   * <p>Example code:
   *
   ...
   *
   * <p>Equivalent to {@link Selector#close()}, except any exceptions will be ignored. This is
   * typically used in finally blocks.
   *
   * <p>Example code:
   *
   ...
   *
   * <p>Equivalent to {@link ServerSocket#close()}, except any exceptions will be ignored. This is
   * typically used in finally blocks.
   *
   * <p>Example code:
   *
  ...
  /**
   * Returns the given InputStream if it is already a {@link BufferedInputStream}, otherwise creates
   * a BufferedInputStream from the given InputStream.
   *
  ...
  /**
   * Gets contents of an <code>InputStream</code> as a <code>byte[]</code>. Use this method instead
  ...
  /**
   * Gets the contents of an <code>InputStream</code> as a <code>byte[]</code>. Use this method
  ...
  /**
   * Gets the contents of a <code>Reader</code> as a <code>byte[]</code> using the default character
  ...
  /**
   * Gets the contents of a <code>String</code> as a <code>byte[]</code> using the default character
   * encoding of the platform.
   *
   * <p>This is the same as {@link String#getBytes()}.
   *
  ...
  /**
   * Gets the contents of an <code>InputStream</code> as a character array using the default
  ...
  /**
   * Gets the contents of an <code>InputStream</code> as a character array using the specified
   * character encoding.
   *
   * <p>This method buffers the input internally, so there is no need to use a <code>
   * BufferedInputStream</code>.
  ...
  /**
   * Gets the contents of a <code>byte[]</code> as a String using the default character encoding of
   * the platform.
   *
  ...
  /**
   * Gets the contents of a <code>byte[]</code> as a String using the specified character encoding.
   *
   * <p>Character encoding names can be found at <a
   * href="http://www.iana.org/assignments/character-sets">IANA</a>.
   *
   ...
   *
   * <p>It is expected the given <code>name</code> to be absolute. The behavior is not well-defined
   * otherwise.
   *
  ...
  public static String resourceToString(
      final String name, final Charset encoding, final ClassLoader classLoader) throws IOException {
  ...
  public static URL resourceToURL(final String name, final ClassLoader classLoader)
    ...
    final URL resource =
        classLoader == null ? IOUtils.class.getResource(name) : classLoader.getResource(name);
  ...
  /**
   * Gets the contents of an <code>InputStream</code> as a list of Strings, one entry per line,
  ...
  /**
   * Gets the contents of a <code>Reader</code> as a list of Strings, one entry per line.
   *
   * <p>This method buffers the input internally, so there is no need to use a <code>BufferedReader
   * </code>.
   *
   ...
   *
   * <p><code>LineIterator</code> holds a reference to the open <code>Reader</code> specified here.
   * When you have finished with the iterator you should close the reader to free internal
   * resources. This can be done by closing the reader directly, or by calling {@link
   * LineIterator#close()} or {@link LineIterator#closeQuietly(LineIterator)}.
   *
  ...
  /**
   * Returns an Iterator for the lines in an <code>InputStream</code>, using the character encoding
   * specified (or default encoding if null).
   *
   * <p><code>LineIterator</code> holds a reference to the open <code>InputStream</code> specified
   * here. When you have finished with the iterator you should close the stream to free internal
   * resources. This can be done by closing the stream directly, or by calling {@link
   * LineIterator#close()} or {@link LineIterator#closeQuietly(LineIterator)}.
   *
   * <p>The recommended usage pattern is:
   *
   ...
   * character encoding of the platform.
   *
   * <p>This method uses {@link String#String(byte[])}.
   *
   * @param data the byte array to write, do not modify during output, null ignored
  ...
  /**
   * Writes chars from a <code>char[]</code> to a <code>Writer</code> using chunked writes. This is
   * intended for writing very large byte arrays which might otherwise cause excessive memory usage
   * if the native code has to allocate a copy.
   *
   * @param data the char array to write, do not modify during output, null ignored
   * @param output the <code>Writer</code> to write to
   * @throws IOException if an I/O error occurs
   ...
   *
   * <p>This method uses {@link String#String(char[])} and {@link String#getBytes()}.
   *
   * @param data the char array to write, do not modify during output, null ignored
   * @param output the <code>OutputStream</code> to write to
   * @throws IOException if an I/O error occurs
   ...
   *
   * <p>This method uses {@link String#getBytes()}.
   *
   * @param data the <code>CharSequence</code> to write, null ignored
   * @param output the <code>OutputStream</code> to write to
   * @throws IOException if an I/O error occurs
   ...
   */
  public static void write(
      final CharSequence data, final OutputStream output, final String encoding)
      throws IOException {
    write(data, output, Charsets.toCharset(encoding));
  }
  ...
  @Deprecated
  public static void write(
      final StringBuffer data, final OutputStream output, final String encoding)
      throws IOException {
    if (data != null) {
   ...
   * </code> line by line, using the default character encoding of the platform and the specified
   * line ending.
   *
  ...
  public static void writeLines(
      final Collection<?> lines, final String lineEnding, final OutputStream output)
      throws IOException {
   ...
   * @param max the max
   * @param onChangedListener the on changed listener
   * @return the long
  ...
  public static long copyLarge(
      ...
      final byte[] buffer,
      long max,
      OnChangedListener<ProgressSupport> onChangedListener)
      throws IOException {
    long count = 0;
    int n;
    ProgressSupport progress = new ProgressSupport();
    progress.setMax(max);
    while (EOF != (n = input.read(buffer))) {
      output.write(buffer, 0, n);
      count += n;
  ...
  public static long copyLarge(
      ...
      OnChangedListener<ProgressSupport> onChangedListener)
      throws IOException {
    return copyLarge(input, output, new byte[DEFAULT_BUFFER_SIZE], max, onChangedListener);
  }

  /**
   * Copies some or all bytes from a large (over 2GB) <code>InputStream</code> to an <code>
   * OutputStream</code>, optionally skipping input bytes.
   *
   * <p>This method buffers the input internally, so there is no need to use a <code>
   * BufferedInputStream</code>.
   *
   * <p>Note that the implementation uses {@link #skip(InputStream, long)}. This means that the
   * method may be considerably less efficient than using the actual skip implementation, this is
   * done to guarantee that the correct number of characters are skipped. The buffer size is given
   * by {@link #DEFAULT_BUFFER_SIZE}.
   *
   * @param input the <code>InputStream</code> to read from
   * @param output the <code>OutputStream</code> to write to
   ...
   */
  public static long copyLarge(
      final InputStream input, final OutputStream output, final long inputOffset, final long length)
      throws IOException {
  ...
  /**
   * Copies some or all chars from a large (over 2GB) <code>InputStream</code> to an <code>
   * OutputStream</code>, optionally skipping input chars.
   *
   * <p>This method buffers the input internally, so there is no need to use a <code>BufferedReader
   * </code>.
   *
   ...
   */
  public static long copyLarge(
      final Reader input, final Writer output, final long inputOffset, final long length)
      throws IOException {
  ...
  public static void copy(
      final Reader input, final OutputStream output, final Charset outputEncoding)
      throws IOException {
    final OutputStreamWriter out =
        new OutputStreamWriter(output, Charsets.toCharset(outputEncoding));
    copy(input, out);
   ...
   */
  public static void copy(
      final Reader input, final OutputStream output, final String outputEncoding)
      throws IOException {
   ...
   *
   * <p>This method buffers the input internally using <code>BufferedInputStream</code> if they are
   ...
   *
   * <p>This method buffers the input internally using <code>BufferedReader</code> if they are not
   * already buffered.
   *
  ...
  /**
   * Skips bytes from an input byte stream. This implementation guarantees that it will read as many
   * bytes as possible before giving up; this may not always be the case for skip() implementations
   * in subclasses of {@link InputStream}.
   *
   * <p>Note that the implementation uses {@link InputStream#read(byte[], int, int)} rather than
   * delegating to {@link InputStream#skip(long)}. This means that the method may be considerably
   * less efficient than using the actual skip implementation, this is done to guarantee that the
   * correct number of bytes are skipped.
   *
   ...
   *
   * <p>Note that the implementation uses {@link Reader#read(char[], int, int)} rather than
   * delegating to {@link Reader#skip(long)}. This means that the method may be considerably less
   * efficient than using the actual skip implementation, this is done to guarantee that the correct
   ...
   *
   * <p>This allows for the possibility that {@link Reader#skip(long)} may not skip as many
   * characters as requested (most likely because of reaching EOF).
   *
   * <p>Note that the implementation uses {@link #skip(Reader, long)}. This means that the method
   * may be considerably less efficient than using the actual skip implementation, this is done to
   ...
   *
   * <p>This implementation guarantees that it will read as many bytes as possible before giving up;
   ...
   *
   * <p>This allows for the possibility that {@link Reader#read(char[], int, int)} may not read as
   ...
   *
   * <p>This allows for the possibility that {@link InputStream#read(byte[], int, int)} may not read
   ...
   * Reads the requested number of bytes or fail if there are not enough left.
   *
   * <p>This allows for the possibility that {@link ReadableByteChannel#read(ByteBuffer)} may not

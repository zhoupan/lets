 ...
 *
 * <p>This works by sleeping until the specified timeout amount and then interrupting the thread
 * being monitored. If the thread being monitored completes its work before being interrupted, it
 * should <code>interrupt()</code> the <i>monitor</i> thread.
 *
 * <pre>
...
class ThreadMonitor implements Runnable {
   ...
   *
   * <p>This method exists because Thread.sleep(100) can sleep for 0, 70, 100 or 200ms or anything
   * else it deems appropriate. Read the docs on Thread.sleep for further interesting details.
   *

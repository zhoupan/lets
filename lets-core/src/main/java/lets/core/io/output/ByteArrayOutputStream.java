...
import lets.core.io.input.ClosedInputStream;
 ...
 *
 * <p>The data can be retrieved using <code>toByteArray()</code> and <code>toString()</code>.
 *
 ...
 *
 * <p>This is an alternative implementation of the {@link java.io.ByteArrayOutputStream} class. The
...
public class ByteArrayOutputStream extends OutputStream {
  ...
  /**
   * Creates a new byte array output stream. The buffer capacity is initially 1024 bytes, though its
   ...
   * after the stream has been closed without generating an {@code IOException}.
   *
   * @throws IOException never (this method should not declare this exception but it has to now due
   ...
   * by buffers of <code>this</code> stream, avoiding memory allocation and copy, thus saving space
   * and time.<br>
   *

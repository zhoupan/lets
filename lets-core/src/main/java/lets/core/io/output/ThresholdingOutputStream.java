 ...
 *
 * <p>This class overrides all <code>OutputStream</code> methods. However, these overrides
 * ultimately call the corresponding methods in the underlying output stream implementation.
 *
 * <p>NOTE: This implementation may trigger the event <em>before</em> the threshold is actually

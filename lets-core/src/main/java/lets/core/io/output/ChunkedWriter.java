...
/**
 * Writer which breaks larger output blocks into chunks. Native code may need to copy the input
 * array; if the write buffer is very large this can cause OOME.
 *
 * @since 2.5
 */

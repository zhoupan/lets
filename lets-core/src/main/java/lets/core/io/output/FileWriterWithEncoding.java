 ...
 *
 * <p>This class provides a simple alternative to <code>FileWriter</code> that allows an encoding to
 * be set. Unfortunately, it cannot subclass <code>FileWriter</code>.
 *
 * <p>By default, the file will be overwritten, but this may be changed to append.
 *
 * <p>The encoding must be specified using either the name of the {@link Charset}, the {@link
 * Charset}, or a {@link CharsetEncoder}. If the default encoding is required then use the {@link
 * java.io.FileWriter} directly, rather than this implementation.
 *
 * <p>
 *
 * @since 1.4
...
public class FileWriterWithEncoding extends Writer {
   ...
   * @throws IOException in case of an I/O error
   */
  public FileWriterWithEncoding(final String filename, final CharsetEncoder encoding)
      throws IOException {
    this(new File(filename), encoding, false);
  }
   ...
   * @throws IOException in case of an I/O error
   */
  public FileWriterWithEncoding(final File file, final String encoding, final boolean append)
      throws IOException {
    super();
   ...
   * @throws IOException in case of an I/O error
   */
  public FileWriterWithEncoding(final File file, final Charset encoding, final boolean append)
      throws IOException {
    super();
    this.out = initWriter(file, encoding, append);
  }
   ...
   */
  public FileWriterWithEncoding(
      final File file, final CharsetEncoder encoding, final boolean append) throws IOException {
    super();
    this.out = initWriter(file, encoding, append);
  }
   ...
   */
  private static Writer initWriter(final File file, final Object encoding, final boolean append)
      throws IOException {
    if (file == null) {

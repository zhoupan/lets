...
public class StringEscapeUtils {
   ...
   *
   * @see <a href="https://pubs.opengroup.org/onlinepubs/7908799/xcu/chap2.html">Shell Command
   *     Language</a>
   */
   ...
   * href="https://en.wikipedia.org/wiki/Comma-separated_values">Wikipedia</a> and <a
   ...
   * @param input the {@code String} to escape, may be null
   * @return a new escaped {@code String}, {@code null} if null string input
   * @see <a href="https://hotwired.lycos.com/webmonkey/reference/special_characters/">ISO
   *     Entities</a>
   ...
   * Unicode surrogate code points, even after escaping. {@code escapeXml10} will remove characters
   ...
   * unpaired Unicode surrogate code points, even after escaping. {@code escapeXml11} will remove
   ...
   * methods provided by {@link ProcessBuilder} or {@link Runtime#exec(String[])} instead.
   *
   * <p>Example:
   *
   * <pre>

...
public class CharSequenceUtils {
   ...
   * </blockquote>
   *
   * is true. In either case, if no such character occurs inm {@code cs} at or after position {@code
   * start}, then {@code -1} is returned.
   *
  ...
  /**
   * Returns the index within {@code cs} of the last occurrence of the specified character,
   ...
   * </blockquote>
   *
   * is true. In either case, if no such character occurs in {@code cs} at or before position {@code
   * start}, then {@code -1} is returned.
   *
   * <p>All indices are specified in {@code char} values (Unicode code units).
   *

...
/**
 * The Builder interface is designed to designate a class as a <em>builder</em> object in the
 * Builder design pattern. Builders are capable of creating and configuring objects or results that
 * normally take multiple steps to construct or are very complex to derive.
 *
 ...
 * built return a reference to {@code this} so that method calls can be chained together.
 *
 * <p>Example Builder:
 *
 * <pre>

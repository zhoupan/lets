...
public final class Resolver {
  ...
  /**
   * Resolves the value of the current Promise with the given value. Allowed Object types of the
   ...
   *
   * @param value value of the current Promise
   */
  public final void resolve(Object value) {
    Promise.toCompletableFuture(value)
        .handle(
            (data, error) -> {
              if (error == null) {
  ...
  /**
   * Resolves the value of the current Promise with the given boolean value.
   *
   * @param value the value of the Promise
   */

  ...
  public void accept(Kryo mapper) {
    ...
    mapper.register(
        ...
        new Serializer<BsonBoolean>() {
          ...
          @Override
          public final BsonBoolean read(
              final Kryo kryo, final Input input, final Class<? extends BsonBoolean> clazz) {
    ...
    mapper.register(
        ...
        new Serializer<BsonDateTime>() {
          ...
          @Override
          public final BsonDateTime read(
              final Kryo kryo, final Input input, final Class<? extends BsonDateTime> clazz) {
    ...
    mapper.register(
        ...
        new Serializer<BsonDouble>() {
          ...
          @Override
          public final BsonDouble read(
              final Kryo kryo, final Input input, final Class<? extends BsonDouble> clazz) {
    ...
    mapper.register(
        ...
        new Serializer<BsonInt32>() {
          ...
          @Override
          public final BsonInt32 read(
              final Kryo kryo, final Input input, final Class<? extends BsonInt32> clazz) {
    ...
    mapper.register(
        ...
        new Serializer<BsonInt64>() {
          ...
          @Override
          public final BsonInt64 read(
              final Kryo kryo, final Input input, final Class<? extends BsonInt64> clazz) {
    ...
    mapper.register(
        ...
        new Serializer<BsonNull>() {
          ...
          @Override
          public final BsonNull read(
              final Kryo kryo, final Input input, final Class<? extends BsonNull> clazz) {
            return new BsonNull();
          }
        });
    ...
    mapper.register(
        ...
        new Serializer<BsonRegularExpression>() {

          @Override
          public final void write(
              final Kryo kryo, final Output output, final BsonRegularExpression obj) {
            output.writeString(obj.getPattern());
          }

          @Override
          public final BsonRegularExpression read(
              final Kryo kryo,
              final Input input,
              final Class<? extends BsonRegularExpression> clazz) {
    ...
    mapper.register(
        ...
        new Serializer<BsonString>() {
          ...
          @Override
          public final BsonString read(
              final Kryo kryo, final Input input, final Class<? extends BsonString> clazz) {
    ...
    mapper.register(
        ...
        new Serializer<BsonTimestamp>() {
          ...
          @Override
          public final BsonTimestamp read(
              final Kryo kryo, final Input input, final Class<? extends BsonTimestamp> clazz) {
    ...
    mapper.register(
        ...
        new Serializer<BsonUndefined>() {
          ...
          @Override
          public final BsonUndefined read(
              final Kryo kryo, final Input input, final Class<? extends BsonUndefined> clazz) {
    ...
    mapper.register(
        ...
        new Serializer<Binary>() {
          ...
          @Override
          public final Binary read(
              final Kryo kryo, final Input input, final Class<? extends Binary> clazz) {
    ...
    mapper.register(
        ...
        new Serializer<Code>() {
          ...
          @Override
          public final Code read(
              final Kryo kryo, final Input input, final Class<? extends Code> clazz) {
    ...
    mapper.register(
        ...
        new Serializer<Decimal128>() {
          ...
          @Override
          public final Decimal128 read(
              final Kryo kryo, final Input input, final Class<? extends Decimal128> clazz) {
    ...
    mapper.register(
        ...
        new Serializer<ObjectId>() {
          ...
          @Override
          public final ObjectId read(
              final Kryo kryo, final Input input, final Class<? extends ObjectId> clazz) {
    ...
    mapper.register(
        ...
        new Serializer<Symbol>() {
          ...
          @Override
          public final Symbol read(
              final Kryo kryo, final Input input, final Class<? extends Symbol> clazz) {

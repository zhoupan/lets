 ...
 * <br>
 * Description: JsonIO - Convert Java to JSON. Convert JSON to Java. PrettyFormatter print JSON.
 * Java JSON serializer.<br>
 * <br>
 * <b>Dependency:</b><br>
 * <br>
 ...
 * (eg. only the "json-io") implementation on the classpath, this step is NOT necessary, the

 ...
 * format offering interchangeable binary and text representations. The binary representation is
 * efficient to store, transmit, and skip-scan parse. The rich type system provides unambiguous
 * semantics for long-term preservation of business data which can survive multiple generations of
 * software evolution. Ion was built to solve the rapid development, decoupling, and efficiency
 * challenges faced every day while engineering large-scale, service-oriented architectures.<br>
 * <br>
 * <b>Dependency:</b><br>
 * <br>
 ...
 * <br>
 * If there is more than one ION implementation on classpath, the preferred implementation is
 * adjustable with the following System Properties. If there is only one (eg. only the "ion-java")

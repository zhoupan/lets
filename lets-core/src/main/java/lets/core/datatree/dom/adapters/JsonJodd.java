 ...
 * <br>
 * Description: Jodd Json is lightweight library for (de)serializing Java objects into and from
 * JSON.<br>
 * <br>
 * <b>Dependency:</b><br>
 * <br>
 * https://mvnrepository.com/artifact/org.jodd/jodd-json<br>
 * compile group: 'org.jodd', name: 'jodd-json', version: '6.0.1'<br>
 * <br>
 ...
 * (eg. only the "jodd-json") implementation on the classpath, this step is NOT necessary, the
...
public class JsonJodd extends AbstractTextAdapter {
  ...
  public static final <T> void addSerializer(
      JsonSerializer mapper, Class<T> type, BiConsumer<T, JsonContext> consumer) {
    mapper.withSerializer(
        type,
        new TypeJsonSerializer<T>() {

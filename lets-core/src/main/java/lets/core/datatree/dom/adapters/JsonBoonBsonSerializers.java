...
import static lets.core.datatree.dom.adapters.JsonBoon.addSerializer;
  ...
  public void accept(JsonSerializerFactory factory) {
        ...
        (instance, builder) -> {
          if (Config.USE_TIMESTAMPS) {
            builder.addJsonEscapedString(
                DataConverterRegistry.convert(String.class, new Date(instance.getValue()))
                    .toCharArray());
          } else {
    ...
    addSerializer(
        ...
        (instance, builder) -> {
          if (Config.USE_TIMESTAMPS) {
            builder.addJsonEscapedString(
                DataConverterRegistry.convert(String.class, new Date(instance.getTime() * 1000L))
                    .toCharArray());
          } else {
    ...
    factory.addTypeSerializer(
        Binary.class,
        new CustomObjectSerializer<Binary>() {
          ...
          public void serializeObject(
              JsonSerializerInternal serializer, Binary instance, CharBuf builder) {

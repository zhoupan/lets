...
import lets.core.jtoml.impl.SimpleTomlParser;

/**
 * <b>JTOML TOML ADAPTER</b><br>
 * <br>
 * Description: This is a parser for Tom Preson-Werner's (@mojombo) TOML markup language, using
 * Java.<br>
 * <br>
 * <b>Dependency:</b><br>
 * <br>
 ...
 * <br>
 * The "io.ous.jtoml" is better TOML reader than "me.grison.jtoml", but has no writer functionality.
 * To combine the two APIs, use this settings:<br>
 * <br>

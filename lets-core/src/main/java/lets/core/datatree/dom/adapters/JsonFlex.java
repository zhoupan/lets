 ...
 * <br>
 * Description: Flexjson is a lightweight library for serializing and deserializing Java objects
 * into and from JSON.<br>
 * <br>
 * <b>Dependency:</b><br>
 * <br>
 ...
 * (eg. only the "flexjson") implementation on the classpath, this step is NOT necessary, the
...
public class JsonFlex extends AbstractTextAdapter {
  ...
  public static final <T> void addSerializer(
      TypeTransformerMap map, Class<T> type, CheckedBiConsumer<T, JSONContext> consumer) {
    map.put(
        type,

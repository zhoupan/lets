 ...
 * <b>Dependency:</b><br>
 * <br>
 * https://mvnrepository.com/artifact/com.fasterxml.jackson.dataformat/ jackson-dataformat-yaml<br>
 * compile group: 'com.fasterxml.jackson.dataformat', name: 'jackson-dataformat-yaml', version:
 * '2.11.3'<br>
 * <br>
 * <b>Set as default (using Java System Properties):</b><br>
 * <br>
 * If there is more than one YAML implementation on classpath, the preferred implementation is
 * adjustable with the following System Properties. If there is only one (eg. only the
 * "jackson-dataformat-yaml") implementation on the classpath, this step is NOT necessary, the

 ...
 * <br>
 * Description: Kryo is a fast and efficient object graph serialization framework for Java. The
 * goals of the project are speed, efficiency, and an easy to use API. The project is useful any
 * time objects need to be persisted, whether to a file, database, or over the network.<br>
 * <br>
 * <b>Dependency:</b><br>
 * <br>
 * https://mvnrepository.com/artifact/com.esotericsoftware/kryo<br>
 * compile group: 'com.esotericsoftware', name: 'kryo', version: '5.0.0-RC9'<br>
 * <br>
  ...
  public void addDefaultSerializers() {
    ...
    mapper.register(
        ...
        new Serializer<UUID>() {
          ...
          public final UUID read(
              final Kryo kryo, final Input input, final Class<? extends UUID> type) {
            return new UUID(input.readLong(), input.readLong());
          }
        });
    mapper.register(
        Inet4Address.class,
        new Serializer<Inet4Address>() {
          ...
          @Override
          public final Inet4Address read(
              final Kryo kryo, final Input input, final Class<? extends Inet4Address> type) {
            try {
    ...
    mapper.register(
        ...
        new Serializer<Inet6Address>() {
          ...
          @Override
          public final Inet6Address read(
              final Kryo kryo, final Input input, final Class<? extends Inet6Address> type) {
            try {

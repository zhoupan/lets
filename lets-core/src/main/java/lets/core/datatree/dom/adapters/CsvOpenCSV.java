 ...
 * <br>
 * If there is more than one CSV implementation on classpath, the preferred implementation is
 * adjustable with the following System Properties. If there is only one (eg. only the "opencsv")
...
public class CsvOpenCSV extends AbstractTextAdapter {
  ...
  public String toString(Object value, Object meta, boolean pretty, boolean insertMeta) {
    ...
    CSVWriter mapper =
        new CSVWriter(
            writer, defaultSeparatorChar, defaultQuoteChar, defaultEscapeChar, defaultLineEnd);

 ...
 * <br>
 * Description: Genson API is designed to be easy to use, it handles for you all the databinding,
 * streaming and much more.<br>
 * <br>
 * <b>Dependency:</b><br>
 * <br>
 ...
 * (eg. only the "genson") implementation on the classpath, this step is NOT necessary, the DataTree
...
public class JsonGenson extends AbstractTextAdapter {
  ...
  public static final <T> void addSerializer(
      GensonBuilder builder, Class<T> type, OneWayConverter<T> converter) {

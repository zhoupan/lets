 ...
 * <br>
 * Description: DSL Platform compatible JSON library (https://dsl-platform.com). <br>
 * <br>
 * <b>Dependency:</b><br>
 * <br>
 ...
 * (eg. only the "dsl-json") implementation on the classpath, this step is NOT necessary, the
...
public class JsonDSL extends AbstractTextAdapter {
  ...
  public static final DslJson<Object> create() {
    ...
    mapper.registerWriter(
        BigInteger.class,
        (writer, value) -> {
          StringConverter.serializeNullable(
              DataConverterRegistry.convert(String.class, value), writer);
        });

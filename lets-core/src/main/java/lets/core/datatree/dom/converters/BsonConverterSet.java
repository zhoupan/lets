...
import static lets.core.datatree.dom.converters.DataConverterRegistry.register;
...
import lets.core.datatree.dom.DeepCloner;
...
final class BsonConverterSet extends AbstractConverterSet {
  ...
  static {
    ...
    DataConverterRegistry.addUnquotedClass(
        BsonBoolean.class, BsonDouble.class, BsonInt32.class, BsonInt64.class, Decimal128.class);

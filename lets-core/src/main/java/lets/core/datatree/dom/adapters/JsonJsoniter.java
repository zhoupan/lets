/*
 * Copyright (c) 2020 zhoupan (https://github.com/zhoupan).
 *
 ...
 * <br>
 * Description: jsoniter (json-iterator) is fast and flexible JSON parser available in Java and Go.
 * <br>
 * <br>
 * <b>Dependencies:</b><br>
 * <br>
 ...
 * (eg. only the "Jsoniter") implementation on the classpath, this step is NOT necessary, the
...
public class JsonJsoniter extends AbstractTextAdapter {
  ...
  public static final <T> void addSerializer(
      Class<T> type, CheckedBiConsumer<T, JsonStream> consumer) {

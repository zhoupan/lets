 ...
 * <br>
 * Description: MessagePack is an efficient binary serialization format. It lets you exchange data
 * among multiple languages like JSON. But it's faster and smaller. Small integers are encoded into
 * a single byte, and typical short strings require only one extra byte in addition to the strings
 * themselves. <br>
 * <br>
 * <b>Dependency:</b><br>
 * <br>
 * https://mvnrepository.com/artifact/org.msgpack/jackson-dataformat-msgpack<br>
 * compile group: 'org.msgpack', name: 'jackson-dataformat-msgpack', version: '0.8.21'<br>
 * <br>
 * <b>Set as default (using Java System Properties):</b><br>
 * <br>
 * If there is more than one MessagePack implementation on classpath, the preferred implementation
 * is adjustable with the following System Properties. If there is only one (eg. only the
 * "jackson-dataformat-msgpack") implementation on the classpath, this step is NOT necessary, the

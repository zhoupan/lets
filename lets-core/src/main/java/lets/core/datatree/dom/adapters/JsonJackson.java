 ...
 * <br>
 * Description: Standard JSON library for Java (or JVM platform in general), or, as the "best JSON
 * parser for Java".<br>
 * <br>
 * <b>Dependency:</b><br>
 * <br>
 * https://mvnrepository.com/artifact/com.fasterxml.jackson.core/jackson- databind<br>
 * compile group: 'com.fasterxml.jackson.core', name: 'jackson-databind', version: '2.11.3'<br>
 * <br>
 * <b>Set as default (using Java System Properties):</b><br>
 * <br>
 * If there is more than one JSON implementation (Boon, Bson, Gson, etc.) on classpath, the
 * preferred implementation is adjustable with the following System Properties. If there is only one
 * (eg. only the "jackson-databind") implementation on the classpath, this step is NOT necessary,
 * the DataTree API will use this JSON API automatically.<br>
 * <br>
...
public class JsonJackson extends AbstractJacksonTextAdapter {
  ...
  public JsonJackson() {
    ...
    tryToAddSerializers(
        "io.datatree.dom.adapters.JsonJacksonBsonSerializers", mapper, prettyMapper);
  }
  ...
  public static final <T> void addSerializer(
      SimpleModule module, Class<T> type, CheckedBiConsumer<T, JsonGenerator> consumer) {

 ...
 * <br>
 * Description: Apache Johnzon is a project providing an implementation of JsonProcessing (aka
 * jsr-353) and a set of useful extension for this specification like an Object mapper, some JAX-RS
 * providers and a WebSocket module provides a basic integration with Java WebSocket API.<br>
 * <br>
 * <b>Dependencies:</b><br>
 * <br>
 * https://mvnrepository.com/artifact/org.apache.johnzon/johnzon-mapper <br>
 * compile group: 'org.apache.johnzon', name: 'johnzon-mapper', version: '1.2.8'<br>
 * <br>
 ...
 * (eg. only the "johnzon-mapper") implementation on the classpath, this step is NOT necessary, the
...
public class JsonJohnzon extends AbstractTextAdapter {
  ...
  public Object parse(String source) throws Exception {
    ...
    if (c == '[') {
      Map<String, Object> map =
          mapper.readObject(new StringReader("{\"a\":" + source + "}"), Map.class);
      return map.get("a");
    }
  ...
  public static final Mapper create(boolean pretty) {
    ...
    builder.setReaderFactory(
        new JsonReaderFactory() {
  ...
  public static final <FROM, TO> void addSerializer(
      MapperBuilder builder, Class<FROM> from, Class<TO> to, Function<FROM, TO> function) {
    builder.addAdapter(
        from,
        String.class,
        new Adapter<FROM, TO>() {

 ...
 * <br>
 * Description: Simple opinionated Java for the novice to expert level Java Programmer. Low
 * Ceremony. High Productivity. A real boon to Java to developers!<br>
 * <br>
 * <b>Dependency:</b><br>
 * <br>
 ...
 * (eg. only the "boon") implementation on the classpath, this step is NOT necessary, the DataTree
 * API will use this JSON API automatically.<br>
 * <br>
 ...
 * <br>
 * Tree node = new Tree(inputString, "JsonBoon");<br>
 * String outputString = node.toString("JsonBoon");
 *
...
public class JsonBoon extends AbstractTextAdapter {
  ...
  public static final <T> void addSerializer(
      JsonSerializerFactory factory, Class<T> type, CheckedBiConsumer<T, CharBuf> consumer) {
    factory.addTypeSerializer(
        type,
        new CustomObjectSerializer<T>() {
          ...
          public void serializeObject(
              JsonSerializerInternal serializer, T instance, CharBuf builder) {
            try {

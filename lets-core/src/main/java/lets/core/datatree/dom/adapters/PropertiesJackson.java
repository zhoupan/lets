 ...
 * compile group: 'com.fasterxml.jackson.dataformat', name: 'jackson-dataformat-properties',
 * version: '2.11.3'<br>
 * <br>
 * <b>Set as default (using Java System Properties):</b><br>
 * <br>
 * If there is more than one "properties" implementation on classpath, the preferred implementation
 * is adjustable with the following System Properties. <br>
 * <br>

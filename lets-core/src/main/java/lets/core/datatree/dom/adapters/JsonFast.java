 ...
 * compile group: 'com.alibaba', name: 'fastjson', version: '1.2.73'<br>
 * <br>
 ...
 * (eg. only the "fastjson") implementation on the classpath, this step is NOT necessary, the
...
public class JsonFast extends AbstractTextAdapter {
  ...
  static {
    ...
    tryToAddSerializers(
        "io.datatree.dom.adapters.JsonFastBsonSerializers", SerializeConfig.getGlobalInstance());
  }
  ...
  public static final <T> void addSerializer(
      SerializeConfig config, Class<T> type, CheckedBiConsumer<T, JSONSerializer> consumer) {
    config.put(
        type,

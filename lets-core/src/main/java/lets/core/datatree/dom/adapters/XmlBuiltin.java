...
public class XmlBuiltin extends AbstractTextAdapter {
  ...
  protected static final char[] XML_HEADER =
  ...
  protected static final void addChildren(
      StringBuilder out, int indent, Tree node, boolean skipPrimitive) {
  ...
  protected static final Object copyChildren(
      String parentName, Node source, LinkedHashMap<String, Object> map) {
  ...
  protected static final void putWithType(
      LinkedHashMap<String, Object> map, LinkedList<Object> list, String name, String value) {
  ...
  protected static final void putOrAdd(

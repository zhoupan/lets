 ...
 * compile group: 'org.mongodb', name: 'bson', version: '3.12.1'<br>
 * <br>
 ...
 * (eg. only the "bson") implementation on the classpath, this step is NOT necessary, the DataTree
...
public class JsonBson extends AbstractTextAdapter {
  ...
  public EncoderContext encoderContext =
  ...
  public JsonWriterSettings normalJsonWriterSettings =
      JsonWriterSettings.builder().indent(false).build();
  public JsonWriterSettings prettyJsonWriterSettings =
  ...
  public String toString(Object value, Object meta, boolean pretty, boolean insertMeta) {
    return toString(
        ...
        (input) -> {
          ...
          CustomStateWriter writer =
              new CustomStateWriter(
                  buffer, pretty ? prettyJsonWriterSettings : normalJsonWriterSettings);
  ...
  protected class InetAddressCodec implements Codec<InetAddress> {
    ...
    public final void encode(
        final org.bson.BsonWriter writer,
  ...
  protected class ArrayCodec implements Codec<Object[]> {
    ...
    @Override
    public final void encode(
        org.bson.BsonWriter writer, Object[] array, EncoderContext encoderContext) {
      if (codec == null) {

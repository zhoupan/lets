 ...
 * format offering interchangeable binary and text representations. The text format (a superset of
 * JSON) is easy to read and author, supporting rapid prototyping. The rich type system provides
 * unambiguous semantics for long-term preservation of business data which can survive multiple
 * generations of software evolution. Ion was built to solve the rapid development, decoupling, and
 * efficiency challenges faced every day while engineering large-scale, service-oriented
 * architectures.<br>
 * <br>
 * <b>Dependency:</b><br>
 * <br>
 ...
 * <br>
 * If there is more than one JSON implementation (Jackson, Bson, Gson, etc.) on classpath, the
 * preferred implementation is adjustable with the following System Properties. If there is only one
 * (eg. only the "ion-java") implementation on the classpath, this step is NOT necessary, the
 * DataTree API will use this JSON API automatically.<br>
 * <br>
...
public class JsonIon extends AbstractTextAdapter {
  ...
  public Object parse(LinkedHashMap<String, Object> map, LinkedList<Object> list, IonReader reader)
      throws Exception {
    IonType type;
    String name;
  ...
  public void add(
      LinkedHashMap<String, Object> map, LinkedList<Object> list, String name, Object value) {
    if (name == null) {
      if (list != null) {
        list.add(value);
      }
  ...
  @SuppressWarnings("unchecked")
  public static final <T> void addSerializer(
      HashMap<Class<?>, Function<Object, Object>> converters,
      Class<T> type,

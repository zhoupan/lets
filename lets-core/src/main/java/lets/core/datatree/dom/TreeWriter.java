...
/**
 * TreeWriter provides functionality for converting structured data to String or byte array format.
 *
...
public interface TreeWriter {
   ...
   *
   * @param value content (Maps, Lists and other Java types)
   * @param meta optional meta structure (Map or null)
   * @param insertMeta insert meta into the byte array
   ...
   * @param value content (Maps, Lists and other Java types)
   * @param meta optional meta structure (Map or null)
   * @param pretty try to generate formatted output
   * @param insertMeta insert meta structure into the String
   ...
   *
   * @return name of the format (eg. "json", "xml", "yaml", "toml", "bson", etc.)
   */

 ...
 * <br>
 * Description: SOJO stands for Simplify your Old Java Objects or, in noun form, Simplified Old Java
 * Objects.<br>
 * <br>
 * <b>Dependency:</b><br>
 * <br>
 ...
 * (eg. only the "sojo") implementation on the classpath, this step is NOT necessary, the DataTree
...
public class JsonSojo extends AbstractTextAdapter {
  ...
  public static final JsonSerializer create() {
    ...
    boolean allInstalled =
        tryToAddSerializers("io.datatree.dom.adapters.JsonSojoBsonSerializers", converter);

 ...
 * <br>
 * Description: Gson is a Java library that can be used to convert Java Objects into their JSON
 * representation. It can also be used to convert a JSON string to an equivalent Java object. Gson
 * can work with arbitrary Java objects including pre-existing objects that you do not have
 * source-code of.<br>
 * <br>
 * <b>Dependency:</b><br>
 * <br>
 ...
 * (eg. only the "gson") implementation on the classpath, this step is NOT necessary, the DataTree
...
public class JsonGson extends AbstractTextAdapter {
  ...
  public static final <T> void addSerializer(
      GsonBuilder builder, Class<T> type, Function<T, JsonElement> function) {

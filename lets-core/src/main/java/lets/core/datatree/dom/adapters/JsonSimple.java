 ...
 * <br>
 * Description: JSON.simple is a simple Java toolkit for JSON. You can use JSON.simple to encode or
 * decode JSON text.<br>
 * <br>
 * <b>Dependency:</b><br>
 * <br>
 * https://mvnrepository.com/artifact/com.googlecode.json-simple/json-simple <br>
 * compile group: 'com.googlecode.json-simple', name: 'json-simple', version: '1.1.1'<br>
 * <br>
 ...
 * (eg. only the "json-simple") implementation on the classpath, this step is NOT necessary, the

...
public class LocaleUtils {
  ...
  /**
   * {@code LocaleUtils} instances should NOT be constructed in standard programming. Instead, the
   * class should be used as {@code LocaleUtils.toLocale("en_GB");}.
   *
   ...
   * </pre>
   *
   * <p>The result list begins with the most specific locale, then the next more general and so on,
   ...
   *
   * <p>This method is a wrapper around {@link Locale#getAvailableLocales()}. It is more efficient,
   ...
   *
   * <p>This method takes a country code and searches to find the languages available for that
   ...
   *
   * <p>This method takes a language code and searches to find the countries available for that
  ...
  static class SyncAvoid {
    ...
    static {
      final List<Locale> list =
          new ArrayList<>(Arrays.asList(Locale.getAvailableLocales())); // extra safe

 ...
 * stored. If mutable objects are stored in the triple, then the triple itself effectively becomes
 * mutable. The class is also {@code final}, so a subclass can not add undesirable behavior.
 *
 * <p>#ThreadSafe# if all three objects are thread-safe
 *

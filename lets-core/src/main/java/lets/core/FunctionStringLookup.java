...
/**
 * A function-based lookup where the request for a lookup is answered by applying that function with
 * a key.
 *
...
final class FunctionStringLookup<V> extends AbstractStringLookup {
   ...
   *
   * <p>If the function is null, then null is returned. The function result object is converted to a

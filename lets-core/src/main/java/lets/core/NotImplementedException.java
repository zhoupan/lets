 ...
 * {@code UnsupportedOperationException} by providing a more semantically rich description of the
 * problem.
 *
 * <p>{@code NotImplementedException} represents the case where the author has yet to implement the
 * logic at this point in the program. This can act as an exception based TODO tag.
 *
 * <pre>
 * public void foo() {
 *   try {
...
public class NotImplementedException extends UnsupportedOperationException {
   ...
   *
   * @param message description of the exception
   * @param code code indicating a resource for more information regarding the lack of
   *     implementation
   * @since 3.2
   */

...
/**
 * A representation of a region, using a {@link Position} object and a {@link Dimension} object.
 *
 * @author coobird
 * @since 0.3.4
 */
public final class Region {
  ...
  /**
   * Instantiates a representation of a region from a {@link Position} and {@link Size}.
   *
   * @param position Position of the region.
   * @param size Size of the region.
   * @throws NullPointerException When the position and/or the size is {@code null}.
   */
   ...
   *
   * <p>The portions of the enclosed region which lies outside of the enclosing region are ignored.
   * Effectively, the {@link Rectangle} returned by this method is a intersection of the enclosing
   * and enclose regions.
   *

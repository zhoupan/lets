...
public class RelativeSize implements Size {
   ...
   *
   * @param scalingFactor The scaling factor to use to determine the size of the enclosing object.
   * @throws IllegalArgumentException When the scaling factor is not within the range of {@code
   *     0.0d} and {@code 1.0d}, inclusive.
   */

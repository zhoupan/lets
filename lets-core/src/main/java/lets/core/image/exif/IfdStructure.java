...
public class IfdStructure {
   ...
   *
   * @return An integer representation of the tag element. Should be a value between 0x00 to 0xFF.
   */
  public int getTag() {
    return tag;
  }
  ...
  /**
   * Returns the count element in the IFD structure, indicating the number of values the value
   * field..
   *
   ...
   *
   * @return Either the offset or value. The type of the returned value can be determined by the
   *     return of the {@link #isOffset()} or {@link #isValue()} method.
   */
  ...
  /**
   * Returns whether the value returned by the {@link #getOffsetValue()} method is an actual value.
   *
   * @return {@code true} if the value returned by the {@link #getOffsetValue()} method is a value,
   *     {@code false} otherwise.
   */
  public boolean isValue() {
    /*
     * The offsetValue field contains a value if the size of the value is less than or equal to 4 bytes see "Value Offset" in Section 4.6.3 of
     * the Exif version 2.3 specification.
     */
    return type.size() * count <= 4;
  }

  /**
   * Returns whether the value returned by the {@link #getOffsetValue()} method is an offset value.
   *
   * @return {@code true} if the value returned by the {@link #getOffsetValue()} method is a offset
   ...
   *
   * @return {@code true} if the given object and this object is equivalent, {@code false}
   *     otherwise.
   */
  @Override

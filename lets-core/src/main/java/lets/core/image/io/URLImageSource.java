...
public class URLImageSource extends AbstractImageSource<URL> {
   ...
   *
   * <p>If a proxy is not required, then this field will be {@code null}.
   */
  private final Proxy proxy;

  /**
   * Instantiates an {@link URLImageSource} with the URL from which the source image should be
   * retrieved from.
   *
  ...
  /**
   * Instantiates an {@link URLImageSource} with the URL from which the source image should be
   * retrieved from, along with the proxy to use to connect to the aforementioned URL.
   *
   * @param url URL to the source image.

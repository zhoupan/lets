...
public class FileImageSource extends AbstractImageSource<File> {
  ...
  /**
   * Instantiates a {@link FileImageSource} with the specified file as the source image.
   *
  ...
  public BufferedImage read() throws IOException {
    if (!sourceFile.exists()) {
      throw new FileNotFoundException("Could not find file: " + sourceFile.getAbsolutePath());
    }

    /*
     * TODO refactor. The following code has been adapted from the StreamImageTask.read method.
     */
    ImageInputStream iis = ImageIO.createImageInputStream(sourceFile);

    if (iis == null) {
      throw new IOException("Could not open file: " + sourceFile.getAbsolutePath());
    }

...
public class Caption implements ImageFilter {
   ...
   *
   * <p>The value should be between {@code 0.0f} to {@code 1.0f}, where {@code 0.0f} is completely
   ...
   * Instantiates a filter which adds a text caption to an image.
   *
   * <p>The opacity of the caption will be 100% opaque.
   *
   * @param caption The text of the caption.
   * @param font The font of the caption.
   * @param c The color of the caption.
  ...
  public BufferedImage apply(BufferedImage img) {
    ...
    Point p =
        position.calculate(
            imageWidth, imageHeight, captionWidth, 0, insets, insets, insets, insets);

 ...
 *
 * <p>Aside from the three {@link Rotator}s provided as class constants, a {@link Rotator} which
 * performs a rotation by an arbituary angle can be obtained through the {@link
...
public class Rotation {
   ...
   *
   * <p>An instance of a {@link Rotator} can be obtained through the {@link
   * Rotation#newRotator(double)} method.
   *
   * @author coobird
   */
  ...
  /**
   * Creates a new instance of {@code Rotator} which rotates an image at the specified angle.
   *
   * <p>When the {@link Rotator} returned by this method is applied, the image will be rotated
   * clockwise by the specified angle.
   *
   * @param angle The angle at which the instance of {@code Rotator} is to rotate a image it acts
   *     upon.
   * @return An instance of {@code Rotator} which will rotate a given image.
   */
    ...
    Rotator r =
        new Rotator() {
          ...
          public BufferedImage apply(BufferedImage img) {
            ...
            /*
             * TODO consider RenderingHints to use. The following are hints which have been chosen to give decent image quality. In the future,
             * there may be a need to have a way to change these settings.
             */
            g.setRenderingHint(
  ...
  /** A {@code Rotator} which will rotate a specified image to the left 90 degrees. */
  public static final Rotator LEFT_90_DEGREES = newRotator(-90);

  /** A {@code Rotator} which will rotate a specified image to the right 90 degrees. */

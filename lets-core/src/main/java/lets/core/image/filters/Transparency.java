 ...
 *
 * <p>The resulting image will always have an image type of {@link BufferedImage#TYPE_INT_ARGB}.
 *
 * @author coobird
 */
public class Transparency implements ImageFilter {
   ...
   *
   * @param alpha The opacity of the resulting image. The value should be between {@code 0.0f}
   *     (transparent) to {@code 1.0f} (opaque), inclusive.
   * @throws IllegalArgumentException If the specified opacity is outside of the range specified
   *     above.
   */
   ...
   * Instantiates a {@link Transparency} filter with the specified opacity.
   *
   * <p>This is a convenience constructor for the {@link Transparency#Transparency(float)}
   * constructor.
   *
   * @param alpha The opacity of the resulting image. The value should be between {@code 0.0f}
   *     (transparent) to {@code 1.0f} (opaque), inclusive.
   ...
   *
   * @return The opacity in the range of {@code 0.0f} (transparent) to {@code 1.0f} (opaque).
   */

 ...
 * (version 2.3.7). See <a href="http://iharder.net/base64">http://iharder.net/base64</a> for more
 * information.
 *
...
public final class Base64 {
   ...
   * RFC3548: <a href="http://www.faqs.org/rfcs/rfc3548.html">http://www.faqs
   * .org/rfcs/rfc3548.html</a>. It is important to note that data encoded this way is <em>not</em>
   * officially valid Base64, or at the very least should not be called Base64 without also
  ...
  /**
   * Used in the URL- and Filename-safe dialect described in Section 4 of RFC3548: <a href
   * ="http://www.faqs.org/rfcs/rfc3548.html">http://www.faqs.org/rfcs/rfc3548.html</a>. Notice that
   * the last two bytes become "hyphen" and "underscore" instead of "plus" and "slash."
   */
   ...
   * encoding.
   *
   * <p>This is the lowest level of the decoding methods with all possible parameters.
   *
   * @param source the array to convert
   * @param srcOffset the index where conversion begins
   * @param destination the array to hold the conversion
  ...
  private static byte[] decode(
      final byte[] source, final int off, final int len, final int options) {

...
/**
 * A skeletal implementation of the {@link Bag} interface to minimize the effort required for target
 * implementations. Subclasses need only to call <code>setMap(Map)</code> in their constructor (or
 * invoke the Map constructor) specifying a map instance that will be used to store the contents of
 * the bag.
 *
 * <p>The map will be used to map bag elements to a number; the number represents the number of
 * occurrences of that element in the bag.
 *
...
public abstract class DefaultMapBag implements Bag {
  ...
  /**
   * No-argument constructor. Subclasses should invoke <code>setMap(Map)</code> in their
   * constructors.
   */
  ...
  /**
   * Returns true if the given object is not null, has the precise type of this bag, and contains
   * the same number of occurrences of all the same elements.
   *
  ...
  /**
   * Utility method for implementations to set the map that backs this bag. Not intended for

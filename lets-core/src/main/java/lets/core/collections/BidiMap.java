...
public interface BidiMap extends IterableMap {
   ...
   *
   * <p>A map iterator is an efficient way of iterating over maps. It does not require that the map
   * is stored using Map Entry objects which can increase performance.
   *
   * <pre>

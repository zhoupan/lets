...
public class IfClosure implements Closure, Serializable {
   ...
   *
   * <p>This factory creates a closure that performs no action when the predicate is false.
   *
  ...
  public static Closure getInstance(
      Predicate predicate, Closure trueClosure, Closure falseClosure) {
    if (predicate == null) {
   ...
   *
   * <p>This constructor creates a closure that performs no action when the predicate is false.
   *

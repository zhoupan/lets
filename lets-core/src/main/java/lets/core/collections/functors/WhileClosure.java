...
/**
 * Closure implementation that executes a closure repeatedly until a condition is met, like a
 ...
 *
 * <p>In order to re-enable serialization support for {@code WhileClosure} the following system

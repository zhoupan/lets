 ...
 *
 * <p>No check is made that the object is immutable. In general, only immutable objects should use
 * the constant factory. Mutable objects should use the prototype factory.
 *

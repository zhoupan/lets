...
public class PrototypeFactory {
   ...
   *
   * <p>Creates a Factory that will return a clone of the same prototype object each time the
   * factory is used. The prototype will be cloned using one of these techniques (in order):
   *
   * <ul>
   ...
   *       <ul>
   *         <p><b>WARNING:</b> from v3.2.2 onwards this method will return a {@code Factory} that
   *         will throw an {@link UnsupportedOperationException} when trying to serialize or
   *         de-serialize it to prevent potential remote code execution exploits.
   *         <p>In order to re-enable serialization support the following system property can be
   *         used (via -Dproperty=true):
   *         <pre>
    ...
    try {
      ...
      try {
        ...
        return new InstantiateFactory(
            prototype.getClass(), new Class[] {prototype.getClass()}, new Object[] {prototype});
    ...
    private void findCloneMethod() {
      try {
        ...
        throw new IllegalArgumentException(
            "PrototypeCloneFactory: The clone method must exist and be public ");
      }
    }

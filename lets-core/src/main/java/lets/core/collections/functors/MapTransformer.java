...
/**
 * Transformer implementation that returns the value held in a specified map using the input
 * parameter as a key.
 *
...
public final class MapTransformer implements Transformer, Serializable {
   ...
   *
   * <p>If the map is null, a transformer that always returns null is returned.
   *

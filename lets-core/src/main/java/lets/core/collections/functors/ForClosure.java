 ...
 *
 * <p>In order to re-enable serialization support for {@code ForClosure} the following system
...
public class ForClosure implements Closure, Serializable {
   ...
   *
   * <p>A null closure or zero count returns the <code>NOPClosure</code>. A count of one returns the
   * specified closure.
   *

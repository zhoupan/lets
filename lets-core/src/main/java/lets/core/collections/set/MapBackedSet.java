 ...
 *
 * <p>This class is used to create a <code>Set</code> with the same properties as the key set of any
 * map. Thus, a ReferenceSet can be created by wrapping a <code>ReferenceMap</code> in an instance
 * of this class.
 *
 * <p>Most map implementation can be used to create a set by passing in dummy values. Exceptions
 * include <code>BidiMap</code> implementations, as they require unique values.
 *

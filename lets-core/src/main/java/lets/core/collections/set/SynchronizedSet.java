...
/**
 * Decorates another <code>Set</code> to synchronize its behaviour for a multi-threaded environment.
 *
 * <p>Methods are synchronized, then forwarded to the decorated set.
 *

...
/**
 * A customized implementation of <code>java.util.TreeMap</code> designed to operate in a
 ...
 *
 * <p><strong>NOTE</strong>: If you are creating and accessing a <code>TreeMap</code> only within a
 * single thread, you should use <code>java.util.TreeMap</code> directly (with no synchronization),
...
public class FastTreeMap extends TreeMap {
  ...
  /**
   * Construct a new map with the same mappings as the specified map, sorted according to the keys's
   * natural order
   *
  ...
  /**
   * Construct a new map with the same mappings as the specified map, sorted according to the same
   * ordering
   *
   * @param map the map whose mappings are to be copied
   */
  ...
  /**
   * Return the comparator used to order this map, or <code>null</code> if this map uses its keys'
   * natural order.
   *
  ...
  /**
   * Copy all of the mappings from the specified map to this one, replacing any mappings with the
   * same keys.
   *
  ...
  /**
   * Return a shallow copy of this <code>FastTreeMap</code> instance. The keys and values themselves
   * are not copied.
   *
  ...
  /**
   * Return a view of the portion of this map whose keys are in the range fromKey (inclusive) to
   * toKey (exclusive).
   *
  ...
  /**
   * Return a view of the portion of this map whose keys are greater than or equal to the specified
   * key.
   *

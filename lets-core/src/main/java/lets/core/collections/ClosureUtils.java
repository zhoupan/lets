...
import lets.core.collections.functors.ChainedClosure;
import lets.core.collections.functors.EqualPredicate;
import lets.core.collections.functors.ExceptionClosure;
import lets.core.collections.functors.ForClosure;
import lets.core.collections.functors.IfClosure;
import lets.core.collections.functors.InvokerTransformer;
import lets.core.collections.functors.NOPClosure;
import lets.core.collections.functors.SwitchClosure;
import lets.core.collections.functors.TransformerClosure;
import lets.core.collections.functors.WhileClosure;

/**
 * <code>ClosureUtils</code> provides reference implementations and utilities for the Closure
 * functor interface. The supplied closures are:
 *
 * <ul>
...
public class ClosureUtils {
  ...
  /**
   * Gets a Closure that always throws an exception. This could be useful during testing as a
   * placeholder.
   *
   * @see lets.core.collections.functors.ExceptionClosure
   * @return the closure
   */
   ...
   *
   * @see lets.core.collections.functors.NOPClosure
   * @return the closure
   */
  ...
  /**
   * Creates a Closure that calls a Transformer each time it is called. The transformer will be
   * called using the closure's input object. The transformer's result will be ignored.
   *
   * @see lets.core.collections.functors.TransformerClosure
   ...
   *
   * <p>A null closure or zero count returns the <code>NOPClosure</code>.
   *
   * @see lets.core.collections.functors.ForClosure
   ...
   *
   * @see lets.core.collections.functors.WhileClosure
  ...
  /**
   * Creates a Closure that will call the closure once and then repeatedly until the predicate
   * returns false.
   *
   * @see lets.core.collections.functors.WhileClosure
   * @param closure the closure to call repeatedly, not null
   ...
   *
   * @see lets.core.collections.functors.ChainedClosure
   ...
   *
   * @see lets.core.collections.functors.IfClosure
   ...
   *
   * <p>The closure at array location 0 is called if the predicate at array location 0 returned
   * true. Each predicate is evaluated until one returns true.
   *
   * @see lets.core.collections.functors.SwitchClosure
   ...
   *
   * <p>The closure at array location 0 is called if the predicate at array location 0 returned
   * true. Each predicate is evaluated until one returns true. If no predicates evaluate to true,
   * the default closure is called.
   *
   * @see lets.core.collections.functors.SwitchClosure
   * @param predicates an array of predicates to check, not null
   * @param closures an array of closures to call, not null
  ...
  public static Closure switchClosure(
      Predicate[] predicates, Closure[] closures, Closure defaultClosure) {
   ...
   * Create a new Closure that calls one of the closures depending on the predicates.
   *
   * <p>The Map consists of Predicate keys and Closure values. A closure is called if its matching
   * predicate returns true. Each predicate is evaluated until one returns true. If no predicates
   * evaluate to true, the default closure is called. The default closure is set in the map with a
   * null key. The ordering is that of the iterator() method on the entryset collection of the map.
   *
   * @see lets.core.collections.functors.SwitchClosure
   ...
   *
   * <p>The Map consists of object keys and Closure values. A closure is called if the input object
   * equals the key. If there is no match, the default closure is called. The default closure is set
   * in the map using a null key.
   *
   * @see lets.core.collections.functors.SwitchClosure

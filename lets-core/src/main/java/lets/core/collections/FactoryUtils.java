...
import lets.core.collections.functors.ConstantFactory;
import lets.core.collections.functors.ExceptionFactory;
import lets.core.collections.functors.InstantiateFactory;
import lets.core.collections.functors.PrototypeFactory;
...
public class FactoryUtils {
  ...
  /**
   * Gets a Factory that always throws an exception. This could be useful during testing as a
   * placeholder.
   *
   * @see lets.core.collections.functors.ExceptionFactory
   * @return the factory
   */
  ...
  /**
   * Gets a Factory that will return null each time the factory is used. This could be useful during
   * testing as a placeholder.
   *
   * @see lets.core.collections.functors.ConstantFactory
   * @return the factory
   */
  ...
  /**
   * Creates a Factory that will return the same object each time the factory is used. No check is
   * made that the object is immutable. In general, only immutable objects should use the constant
   * factory. Mutable objects should use the prototype factory.
   *
   * @see lets.core.collections.functors.ConstantFactory
   ...
   *       <ul>
   *
   * @see lets.core.collections.functors.PrototypeFactory
   ...
   *
   * @see lets.core.collections.functors.InstantiateFactory
  ...
  /**
   * Creates a Factory that can create objects of a specific type using the arguments specified to
   * this method.
   *
   * @see lets.core.collections.functors.InstantiateFactory
   * @param classToInstantiate the Class to instantiate each time in the factory
   ...
   */
  public static Factory instantiateFactory(

 ...
 *
 * <p>The add methods are affected by this class. Thus objects must be removed or searched for using
 * their transformed form. For example, if the transformation converts Strings to Integers, you must
...
public class TransformedBag extends TransformedCollection implements Bag {
   ...
   *
   * <p>If there are any elements already in the bag being decorated, they are NOT transformed.
   *

 ...
 *
 * <p>The add and set methods are affected by this class. Thus objects must be removed or searched
 * for using their transformed form. For example, if the transformation converts Strings to
 * Integers, you must use the Integer form to remove objects.
 *
...
public class TransformedList extends TransformedCollection implements List {
   ...
   *
   * <p>If there are any elements already in the list being decorated, they are NOT transformed.
   *

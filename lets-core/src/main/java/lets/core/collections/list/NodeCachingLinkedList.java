 ...
 *
 * <p>A linked list creates one Node for each item of data added. This can result in a lot of object
 * creation and garbage collection. This implementation seeks to avoid that by maintaining a store
 * of cached nodes.
 *
 * <p>This implementation is suitable for long-lived lists where both add and remove are used.

...
/**
 * A mutable <code>KeyValue</code> pair that does not implement {@link java.util.Map.Entry
 * Map.Entry}.
 *
 * <p>Note that a <code>DefaultKeyValue</code> instance may not contain itself as a key or value.
 *
...
public class DefaultKeyValue extends AbstractKeyValue {
   ...
   *
   * <p>Returns true if the compared object is also a <code>DefaultKeyValue</code>, and its key and
   * value are equal to this object's key and value.
   *
   ...
   *
   * <p>Implemented per API documentation of {@link java.util.Map.Entry#hashCode()}, however

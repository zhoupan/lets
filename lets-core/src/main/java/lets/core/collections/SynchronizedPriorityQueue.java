...
/**
 * A thread safe version of the PriorityQueue. Provides synchronized wrapper methods for all the
 * methods defined in the PriorityQueue interface.
 *
 * @deprecated PriorityQueue is replaced by the Buffer interface, see buffer subpackage. Due to be
 *     removed in v4.0.

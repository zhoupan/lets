 ...
 * lets.core.collections.MapIterator MapIterator} functionality, additional convenience methods and
 * allowing bidirectional iteration. It also implements <code>OrderedMap
 * </code>. In addition, non-interface methods are provided to access the map by index.
 *

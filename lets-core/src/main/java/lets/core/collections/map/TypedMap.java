...
/**
 * Decorates another <code>Map</code> to validate that elements added are of a specific type.
 *
 ...
 * thrown.
 *
 * <p><strong>Note that TypedMap is not synchronized and is not thread-safe.</strong> If you wish to

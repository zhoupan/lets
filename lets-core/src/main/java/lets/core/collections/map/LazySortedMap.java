 ...
 * Furthermore, that <code>Date</code> instance is mapped to the "NOW" key in the map.
 *
 * <p><strong>Note that LazySortedMap is not synchronized and is not thread-safe.</strong> If you

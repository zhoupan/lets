...
/**
 * A <code>Map</code> implementation that matches keys and values based on <code>==</code> not
 * <code>equals()</code>.
 *
 ...
 *
 * <p><strong>Note that IdentityMap is not synchronized and is not thread-safe.</strong> If you wish

...
/**
 * Decorates another <code>Map</code> to validate that additions match a specified predicate.
 *
 ...
 *
 * <p><strong>Note that PredicatedMap is not synchronized and is not thread-safe.</strong> If you

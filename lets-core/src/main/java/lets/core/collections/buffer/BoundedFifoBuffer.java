...
/**
 * The BoundedFifoBuffer is a very efficient implementation of <code>Buffer</code> that is of a
 * fixed size.
 *
...
public class BoundedFifoBuffer extends AbstractCollection
  ...
  /**
   * Index mod maxElements of the array position following the last buffer element. Buffer elements
  ...
  /**
   * Constructs a new <code>BoundedFifoBuffer</code> big enough to hold all of the elements in the
   * specified collection. That collection's elements will also be added to the buffer.
   *
  ...
  public boolean add(Object element) {
    ...
    if (full) {
      throw new BufferOverflowException(
          "The buffer cannot hold more than " + maxElements + " objects.");
    }

...
/**
 * <code>SingletonIterator</code> is an {@link ListIterator} over a single object instance.
 *
...
public class SingletonListIterator implements ListIterator, ResettableListIterator {
   ...
   *
   * <p>This returns true if the single object hasn't been returned yet.
   *
   ...
   *
   * <p>This returns true if the single object has been returned.
   *
  ...
  /**
   * Returns the index of the element that would be returned by a subsequent call to <tt>next</tt>.
   *
   ...
   * <tt>previous</tt>. A return value of -1 indicates that the iterator is currently at the start.
   *
   * @return 0 or -1 depending on current state.
   */
   ...
   *
   * <p>This returns the single object if it hasn't been returned yet.
   *
   ...
   *
   * <p>This returns the single object if it has been returned.
   *
   * @return the single object
   ...
   *
   * @throws IllegalStateException if the <tt>next</tt> or <tt>previous</tt> method has not yet been
   *     called, or the <tt>remove</tt> method has already been called after the last call to
   ...
   * @throws IllegalStateException if <tt>next</tt> has not been called or the object has been
   *     removed
   */

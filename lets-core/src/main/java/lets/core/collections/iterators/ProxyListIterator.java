...
public class ProxyListIterator implements ListIterator {
  ...
  /**
   * Constructs a new <code>ProxyListIterator</code> that will not function until {@link
  ...
  /**
   * Constructs a new <code>ProxyListIterator</code> that will use the given list iterator.
   *

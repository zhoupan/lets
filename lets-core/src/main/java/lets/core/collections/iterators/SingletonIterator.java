...
/**
 * <code>SingletonIterator</code> is an {@link Iterator} over a single object instance.
 *
...
public class SingletonIterator implements Iterator, ResettableIterator {
  ...
  /**
   * Constructs a new <code>SingletonIterator</code> where <code>remove</code> is a permitted
   * operation.
   *
  ...
  /**
   * Constructs a new <code>SingletonIterator</code> optionally choosing if <code>remove</code> is a
   * permitted operation.
   *
   * @param object the single object to return from the iterator

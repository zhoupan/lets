...
public class ProxyIterator implements Iterator {
  ...
  /**
   * Constructs a new <code>ProxyIterator</code> that will not function until {@link
   * #setIterator(Iterator)} is called.
   */
  ...
  /**
   * Constructs a new <code>ProxyIterator</code> that will use the given iterator.
   *
   ...
   * @throws java.util.NoSuchElementException if the underlying iterator raises it because it has no
   *     more elements
   */
  public Object next() {

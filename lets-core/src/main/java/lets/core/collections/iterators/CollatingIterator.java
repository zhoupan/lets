 ...
 *
 * <p>Given two ordered {@link Iterator} instances <code>A</code> and <code>B</code>, the {@link
 * #next} method on this iterator will return the lesser of <code>A.next()</code> and <code>B.next()
 * </code>.
 *
...
public class CollatingIterator implements Iterator {
  ...
  // ----------------------------------------------------------------------
  /**
   * Constructs a new <code>CollatingIterator</code>. Natural sort order will be used, and child
   * iterators will have to be manually added using the {@link #addIterator(Iterator)} method.
   */
  ...
  /**
   * Constructs a new <code>CollatingIterator</code> that will used the specified comparator for
   * ordering. Child iterators will have to be manually added using the {@link
  ...
  /**
   * Constructs a new <code>CollatingIterator</code> that will used the specified comparator for
   * ordering and have the specified initial capacity. Child iterators will have to be manually
   * added using the {@link #addIterator(Iterator)} method.
   *
   * @param comp the comparator to use to sort, or null to use natural sort order
   * @param initIterCapacity the initial capacity for the internal list of child iterators
   */
  ...
  /**
   * Constructs a new <code>CollatingIterator</code> that will use the specified comparator to
   * provide ordered iteration over the two given iterators.
   *
   * @param comp the comparator to use to sort, or null to use natural sort order
  ...
  /**
   * Constructs a new <code>CollatingIterator</code> that will use the specified comparator to
   * provide ordered iteration over the array of iterators.
   *
   * @param comp the comparator to use to sort, or null to use natural sort order
  ...
  /**
   * Constructs a new <code>CollatingIterator</code> that will use the specified comparator to
   * provide ordered iteration over the collection of iterators.
   *
   * @param comp the comparator to use to sort, or null to use natural sort order
   * @param iterators the collection of iterators
   * @throws NullPointerException if the iterators collection is or contains null
   * @throws ClassCastException if the iterators collection contains an element that's not an {@link
   *     Iterator}
   */
   ...
   *
   * @throws IllegalStateException if there is no last returned element, or if the last returned
  ...
  /**
   * Sets the {@link #values} and {@link #valueSet} attributes at position <i>i</i> to the next
   * value of the {@link #iterators iterator} at position <i>i</i>, or clear them if the
   * <i>i</i><sup>th</sup> iterator has no next value.
   *
  ...
  /**
   * Returns the index of the least element in {@link #values}, {@link #set(int) setting} any

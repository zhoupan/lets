...
/**
 * UnboundedFifoBuffer is a very efficient buffer implementation. According to performance testing,
 * it exhibits a constant access time, but it also outperforms ArrayList when used for the same
 * purpose.
 *

...
/**
 * A {@link Bag} that is backed by a {@link TreeMap}. Order will be maintained among the unique
...
public class TreeBag extends DefaultMapBag implements SortedBag {
  ...
  /**
   * Constructs an empty {@link Bag} that maintains order on its unique representative members

...
public class DefaultMapEntry implements Map.Entry, KeyValue {
   ...
   *
   * <p>This Map Entry is not connected to a Map, so only the local data is changed.
   *
  ...
  /**
   * Written to match the output of the Map.Entry's used in a {@link java.util.HashMap}.
   *
   * @since 3.0
   */

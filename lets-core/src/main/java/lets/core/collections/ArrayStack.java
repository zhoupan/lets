 ...
 *
 * <p>The removal order of an <code>ArrayStack</code> is based on insertion order: The most recently
...
public class ArrayStack extends ArrayList implements Buffer {
  ...
  /**
   * Constructs a new empty <code>ArrayStack</code>. The initial size is controlled by <code>
   * ArrayList</code> and is currently 10.
   */
  public ArrayStack() {
    super();
  }
   ...
   *
   * <p>This method exists for compatibility with <code>java.util.Stack</code>. New users of this
  ...
  /**
   * Returns the one-based position of the distance from the top that the specified object exists on
   * this stack, where the top-most element is considered to be at distance <code>1</code>. If the
   * object is not present on the stack, return <code>-1</code> instead. The <code>equals()</code>

...
import lets.core.collections.collection.AbstractCollectionDecorator;
 ...
 *
 * <p>An implementation can be written simply by implementing the <code>createMap</code> method.
 *
 * @see DualHashBidiMap
 * @see DualTreeBidiMap
...
public abstract class AbstractDualBidiMap implements BidiMap {
   ...
   *
   * <p>This design is deeply flawed and has been deprecated. It relied on subclass data being used
   * during a superclass constructor.
   *
   * @return the map to be used for internal storage
   * @deprecated For constructors, use the new two map constructor. For deserialization, populate
   *     the maps array directly in readObject.
   */

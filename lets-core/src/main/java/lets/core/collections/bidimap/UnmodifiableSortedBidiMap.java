...
import lets.core.collections.SortedBidiMap;
import lets.core.collections.Unmodifiable;
import lets.core.collections.collection.UnmodifiableCollection;
import lets.core.collections.iterators.UnmodifiableOrderedMapIterator;
import lets.core.collections.map.UnmodifiableEntrySet;
...
public final class UnmodifiableSortedBidiMap extends AbstractSortedBidiMapDecorator
   ...
   *
   * <p>If the map passed in is already unmodifiable, it is returned.
   *

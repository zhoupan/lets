 ...
 *
 * <p>Two <code>HashMap</code> instances are used in this class. This provides fast lookups at the
 * expense of storing two sets of map entries. Commons Collections would welcome the addition of a
 * direct hash-based implementation of the <code>BidiMap</code> interface.
 *
 * <p>NOTE: From Commons Collections 3.1, all subclasses will use <code>HashMap</code> and the
 * flawed <code>createMap</code> method is ignored.
 *
...
public class DualHashBidiMap extends AbstractDualBidiMap implements Serializable {
  ...
  /**
   * Constructs a <code>HashBidiMap</code> and copies the mappings from specified <code>Map</code>.
   *

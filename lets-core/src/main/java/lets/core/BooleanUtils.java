 ...
 * a {@code null} input. Each method documents its behavior in more detail.
 *
 * <p>#ThreadSafe#
 *
 * @since 2.0
...
public class BooleanUtils {
  ...
  /**
   * {@code BooleanUtils} instances should NOT be constructed in standard programming. Instead, the
   * class should be used as {@code BooleanUtils.negate(true);}.
   *
   ...
   *
   * <p>NOTE: This returns {@code null} and will throw a {@code NullPointerException} if unboxed to
   * a boolean.
   *
   * <pre>
  ...
  // -----------------------------------------------------------------------
  /**
   * Checks if a {@code Boolean} value is {@code true}, handling {@code null} by returning {@code
   * false}.
   *
   * <pre>
  ...
  /**
   * Checks if a {@code Boolean} value is <i>not</i> {@code true}, handling {@code null} by
   * returning {@code true}.
   *
   * <pre>
  ...
  /**
   * Checks if a {@code Boolean} value is {@code false}, handling {@code null} by returning {@code
   * false}.
   *
   * <pre>
  ...
  /**
   * Checks if a {@code Boolean} value is <i>not</i> {@code false}, handling {@code null} by
   * returning {@code true}.
   *
   * <pre>
  ...
  /**
   * Converts an Integer to a Boolean using the convention that {@code zero} is {@code false}, every
   * other numeric value is {@code true}.
   *
   * <p>{@code null} will be converted to {@code null}.
   *
   * <p>NOTE: This method may return {@code null} and may throw a {@code NullPointerException} if
   * unboxed to a {@code boolean}.
   *
   * <pre>
   ...
   *
   * <p>If the {@code trueValue} and {@code falseValue} are the same number then the return value
   * will be {@code true} in case {@code value} matches it.
   *
   * <pre>
   ...
   * @return {@code true} or {@code false}
   * @throws IllegalArgumentException if {@code value} does not match neither {@code trueValue} no
   *     {@code falseValue}
   */
  ...
  public static Boolean toBooleanObject(
      final int value, final int trueValue, final int falseValue, final int nullValue) {
    if (value == trueValue) {
      return Boolean.TRUE;
    }
    if (value == falseValue) {
  ...
  // -----------------------------------------------------------------------
  /**
   * Converts a boolean to an int using the convention that {@code true} is {@code 1} and {@code
   * false} is {@code 0}.
   *
   * <pre>
  ...
  /**
   * Converts a boolean to an Integer using the convention that {@code true} is {@code 1} and {@code
   * false} is {@code 0}.
   *
   * <pre>
  ...
  public static int toInteger(
      final Boolean bool, final int trueValue, final int falseValue, final int nullValue) {
    if (bool == null) {
      return nullValue;
    }
  ...
  public static Integer toIntegerObject(
      final boolean bool, final Integer trueValue, final Integer falseValue) {
    return bool ? trueValue : falseValue;
  }
   ...
   *
   * <p>{@code 'true'}, {@code 'on'}, {@code 'y'}, {@code 't'}, {@code 'yes'} or {@code '1'} (case
   * insensitive) will return {@code true}. {@code 'false'}, {@code 'off'}, {@code 'n'}, {@code
   * 'f'}, {@code 'no'} or {@code '0'} (case insensitive) will return {@code false}. Otherwise,
   ...
   * @return the Boolean value of the string, {@code null} if either the String matches {@code
   *     nullString} or if {@code null} input and {@code nullString} is {@code null}
   ...
   *
   * <p>This method performs 4 times faster (JDK1.4) than {@code Boolean.valueOf(String)}. However,
   * this method accepts 'on' and 'yes', 't', 'y' as true values.
   *
   * <pre>
   *   BooleanUtils.toBoolean(null)    = false
   ...
   */
  public static boolean toBoolean(
      final String str, final String trueString, final String falseString) {
    if (str == trueString) {
      return true;
   ...
   */
  public static String toString(
      final boolean bool, final String trueString, final String falseString) {
   ...
   * @return the result of the logical 'and' operation. That is {@code false} if any of the
   *     parameters is {@code false} and {@code true} otherwise.
   ...
   *
   * @param array an array of {@code boolean}s
   * @return {@code true} if any of the arguments is {@code true}, and it returns {@code false}
   *     otherwise.
   * @throws IllegalArgumentException if {@code array} is {@code null}
   * @throws IllegalArgumentException if {@code array} is empty.
   * @since 3.0.1

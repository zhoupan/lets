 ...
 *
 * <p>Note that as MutableBoolean does not extend Boolean, it is not treated by String.format as a
 * Boolean parameter.
 *
 * @see Boolean
 * @since 2.2
...
public class MutableBoolean implements Mutable<Boolean>, Serializable, Comparable<MutableBoolean> {
  ...
  public String getDisplayString(String trueString, String falseString) {

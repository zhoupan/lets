...
/**
 * Allows the storage and retrieval of contextual information based on label-value pairs for
 * exceptions.
 *
 * <p>Implementations are expected to manage the pairs in a list-style collection that keeps the
 * pairs in the sequence of their addition.
 *
...
public interface ExceptionContext {
   ...
   *
   * <p>The pair will be added to the context, independently of an already existing pair with the
   * same label.
   *
   ...
   *
   * <p>The pair will be added normally, but any existing label-value pair with the same label is
  ...
  /**
   * Gets the contextualized error message based on a base message. This will add the context
   * label-value pairs to the message.
   *

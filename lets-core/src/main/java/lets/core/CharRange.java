...
final class CharRange implements Iterable<Character>, Serializable {
   ...
   *
   * <p>If start and end are in the wrong order, they are reversed. Thus {@code a-e} is the same as
   * {@code e-a}.
   *
   ...
   *
   * <p>A negated range includes everything except that defined by the single character.
   *
   * @param ch only character in this range
   * @return the new CharRange object
   * @since 2.5
   ...
   *
   * <p>A negated range includes everything except that defined by the start and end characters.
   *
   * <p>If start and end are in the wrong order, they are reversed. Thus {@code a-e} is the same as
   * {@code e-a}.
   *
  ...
  // Basics
  /**
   * Compares two CharRange objects, returning true if they represent exactly the same range of
   ...
   *
   * <p>#NotThreadSafe# the iterator is not thread-safe
   *

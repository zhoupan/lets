...
/**
 * An enumeration defining {@link StringLookup} objects available through {@link
 * StringLookupFactory}.
 *
 * <p>This enum was adapted and expanded from Apache Commons Configuration 2.4.
 *
 * <p><strong>NOTE:</strong> Starting in version 1.10.0, not all lookups defined in this class are
 * included by default in the {@link StringLookupFactory#addDefaultStringLookups(java.util.Map)
 * StringLookupFactory.addDefaultStringLookups} method. See the {@link StringLookupFactory} class
...
public enum DefaultStringLookup {
   ...
   */
  LOCAL_HOST(
      StringLookupFactory.KEY_LOCALHOST, StringLookupFactory.INSTANCE.localHostStringLookup()),
   ...
   */
  PROPERTIES(
      StringLookupFactory.KEY_PROPERTIES, StringLookupFactory.INSTANCE.propertiesStringLookup()),
   ...
   */
  URL_ENCODER(
      StringLookupFactory.KEY_URL_ENCODER, StringLookupFactory.INSTANCE.urlEncoderStringLookup()),
   ...
   */
  XML_DECODER(
      StringLookupFactory.KEY_XML_DECODER, StringLookupFactory.INSTANCE.xmlDecoderStringLookup()),
   ...
   */
  XML_ENCODER(
      StringLookupFactory.KEY_XML_ENCODER, StringLookupFactory.INSTANCE.xmlEncoderStringLookup());
  ...
  /**
   * Constructs a new instance of {@link DefaultStringLookup} and sets the key and the associated
   * lookup instance.
   *

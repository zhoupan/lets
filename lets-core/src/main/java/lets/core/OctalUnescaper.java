...
public class OctalUnescaper extends CharSequenceTranslator {
  ...
  /**
   * Tests if the given char is an octal digit. Octal digits are the character representations of
   * the digits 0 to 7.
   *
  ...
  public int translate(final CharSequence input, final int index, final Writer writer)
      throws IOException {
    final int remaining =
        input.length() - index - 1; // how many characters left, ignoring the first \

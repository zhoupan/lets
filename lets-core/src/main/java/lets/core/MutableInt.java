 ...
 *
 * <p>Note that as MutableInt does not extend Integer, it is not treated by String.format as an
 * Integer parameter.
 *
 * @see Integer
 * @since 2.1
...
public class MutableInt extends Number implements Comparable<MutableInt>, Mutable<Number> {
   ...
   * argument is not {@code null} and is a {@code MutableInt} object that contains the same {@code

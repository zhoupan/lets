...
public class Detector {
  ...
  /**
   * Returns the normalized OS name of the platform that is currently running based on os.name
   * property.
   *
  ...
  /**
   * Returns the normalized architecture name of the platform that is currently running based on
   * os.arch property.
   *
   ...
   *
   * @param value architecture name to normalize. Typically, System.getProperty("os.archive") should
   *     be passed.

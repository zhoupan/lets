...
public enum Distro {
  ...
  CENTOS(
      "CentOS",
      new FileExistsType("/etc/centos-release"),
      new FileContainsType("/etc/redhat-release", "CentOS")),
  CRUNCHBANG(
      "Crunchbang",
      new FileExistsType("/etc/crunchbang-lsb-release"),
      new FileExistsType("/etc/lsb-release-crunchbang")),
  DEBIAN("Debian"),
  ...
  FUNTOO(
      "Funtoo",
      new FileContainsType("/etc/gentoo-release", "funtoo"),
      new CommandContainsType(new String[] {"lsb_release", "-sd"}, "funtoo")),
  ...
  PARABOLA(
      ...
      new FileContainsType("/etc/issue", "Parabola GNU/Linux-libre")),
  PEPPERMINT("Peppermint"),
  REDHAT_ENTERPRISE(
      "Redhat Enterprise",
      "RedHatEnterprise",
      new FileContainsType("/etc/redhat-release", "Red Hat")),
  SABAYON("Sabayon", new FileExistsType("/etc/sabayon-edition")),
  SCIENTIFICLINUX(
      "Scientific Linux", new FileContainsType("/etc/system-release", "Scientific Linux")),
  ...
  ORACLE_LINUX(
      ...
      "ol",
      "Ol",
      new FileExistsType("/etc/oracle-release"),
      new FileContainsType("/etc/system-release", "Oracle Linux")),

...
public enum JavaVersion {
  ...
  /**
   * The most recent java version. Mainly introduced to avoid to break when a new version of Java is
   * used.
   */
  ...
  /**
   * Gets the Java Version from the system or 99.0 if the {@code java.specification.version} system
   * property is not set.
   *

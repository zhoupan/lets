 ...
 *
 * <p>Note that as MutableFloat does not extend Float, it is not treated by String.format as a Float
 * parameter.
 *
 * @see Float
 * @since 2.1
...
public class MutableFloat extends Number implements Comparable<MutableFloat>, Mutable<Number> {
  ...
  // -----------------------------------------------------------------------
  /**
   * Compares this object against some other object. The result is {@code true} if and only if the
   ...
   *
   * <p>Note that in most cases, for two instances of class {@code Float},{@code f1} and {@code f2},
   * the value of {@code f1.equals(f2)} is {@code true} if and only if
   *
   * <blockquote>
   *
   * <pre>

...
public class StandardToStringStyle extends ToStringStyle {
  ...
  public void setUseShortClassName(
      final boolean useShortClassName) { // NOPMD as this is implementing the abstract
    // class
  ...
  public void setUseIdentityHashCode(
      final boolean useIdentityHashCode) { // NOPMD as this is implementing the abstract
    // class
  ...
  public void setDefaultFullDetail(
      final boolean defaultFullDetail) { // NOPMD as this is implementing the abstract
    // class
  ...
  public void setArrayContentDetail(
      final boolean arrayContentDetail) { // NOPMD as this is implementing the abstract
    // class
  ...
  public void setFieldNameValueSeparator(
      final String fieldNameValueSeparator) { // NOPMD as this is implementing the
    // abstract class
  ...
  public void setFieldSeparatorAtStart(
      final boolean fieldSeparatorAtStart) { // NOPMD as this is implementing the
    // abstract class
  ...
  public void setFieldSeparatorAtEnd(
      final boolean fieldSeparatorAtEnd) { // NOPMD as this is implementing the abstract
    // class
  ...
  /**
   * Sets the start text to output when a {@code Collection}, {@code Map} or {@code Array} size is
   * output.
   *
   * <p>This is output before the size value.
   *
  ...
  /**
   * Gets the end text to output when a {@code Collection}, {@code Map} or {@code Array} size is
   * output.
   *
  ...
  /**
   * Sets the end text to output when a {@code Collection}, {@code Map} or {@code Array} size is
   * output.
   *
   * <p>This is output after the size value.
   *
  ...
  public void setSummaryObjectStartText(
      final String summaryObjectStartText) { // NOPMD as this is implementing the
    // abstract class
  ...
  public void setSummaryObjectEndText(
      final String summaryObjectEndText) { // NOPMD as this is implementing the abstract
    // class

...
/**
 * This class assists in validating arguments. The validation methods are based along the following
 * principles:
 *
 * <ul>
 *   <li>An invalid {@code null} argument causes a {@link NullPointerException}.
 *   <li>A non-{@code null} argument causes an {@link IllegalArgumentException}.
 *   <li>An invalid index into an array/collection/map/string causes an {@link
 *       IndexOutOfBoundsException}.
 * </ul>
 *
 * <p>All exceptions messages are <a
 * href="http://docs.oracle.com/javase/1.5.0/docs/api/java/util/Formatter.html#syntax">format
...
public class Validate {
   ...
   * </pre>
   *
   * <p>For performance reasons, the double value is passed as a separate parameter and appended to
   * the exception message only in the case of an error.
   *
   * @param expression the boolean expression to check
   * @param message the {@link String#format(String, Object...)} exception message if invalid, not
   ...
   * </pre>
   *
   * <p>The message of the exception is &quot;The validated expression is false&quot;.
   *
   * @param expression the boolean expression to check
   * @throws IllegalArgumentException if expression is {@code false}
   * @see #isTrue(boolean, String, long)
  ...
  public static <T> T[] notEmpty(final T[] array, final String message, final Object... values) {
    requireNonNull(array, () -> String.format(message, values));
    if (array.length == 0) {
      throw new IllegalArgumentException(String.format(message, values));
    }
    return array;
  ...
  /**
   * Validate that the specified argument collection is neither {@code null} nor a size of zero (no
   * elements); otherwise throwing an exception with the specified message.
   *
   * <pre>
  ...
  public static <T extends Collection<?>> T notEmpty(
      final T collection, final String message, final Object... values) {
    requireNonNull(collection, () -> String.format(message, values));
  ...
  public static <T extends Map<?, ?>> T notEmpty(
      final T map, final String message, final Object... values) {
    requireNonNull(map, () -> String.format(message, values));
    if (map.isEmpty()) {
      throw new IllegalArgumentException(String.format(message, values));
    }
    return map;
  ...
  public static <T extends CharSequence> T notEmpty(
      final T chars, final String message, final Object... values) {
    requireNonNull(chars, () -> String.format(message, values));
    if (chars.length() == 0) {
      throw new IllegalArgumentException(String.format(message, values));
    }
    return chars;
   ...
   * </pre>
   *
   * <p>The message in the exception is &quot;The validated character sequence is empty&quot;.
   *
   * @param <T> the character sequence type
   * @param chars the character sequence to check, validated not null by this method
   * @return the validated character sequence (never {@code null} method for chaining)
   ...
   * zero (no characters), empty nor whitespace; otherwise throwing an exception with the specified
   * message.
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>The message in the exception is &quot;The validated character sequence is blank&quot;.
   *
   * @param <T> the character sequence type
   * @param chars the character sequence to check, validated not null by this method
   * @return the validated character sequence (never {@code null} method for chaining)
   ...
   * </pre>
   *
   * <p>If the array is {@code null}, then the message in the exception is &quot;The validated
   * object is null&quot;.
   *
   * <p>If the array has a {@code null} element, then the iteration index of the invalid element is
  ...
  public static <T> T[] noNullElements(
      final T[] array, final String message, final Object... values) {
    notNull(array);
   ...
   * object is null&quot;.
   *
   * <p>If the array has a {@code null} element, then the message in the exception is &quot;The
   * validated array contains null element at index: &quot; followed by the index.
   *
   * @param <T> the array type
   * @param array the array to check, validated not null by this method
   * @return the validated array (never {@code null} method for chaining)
   ...
   * </pre>
   *
   * <p>If the iterable is {@code null}, then the message in the exception is &quot;The validated
   * object is null&quot;.
   *
   * <p>If the iterable has a {@code null} element, then the iteration index of the invalid element
  ...
  public static <T extends Iterable<?>> T noNullElements(
      final T iterable, final String message, final Object... values) {
    notNull(iterable);
    int i = 0;
   ...
   *
   * <p>If the array has a {@code null} element, then the message in the exception is &quot;The
   * validated iterable contains null element at index: &quot; followed by the index.
   *
   * @param <T> the iterable type
   * @param iterable the iterable to check, validated not null by this method
   * @return the validated iterable (never {@code null} method for chaining)
   ...
   * </pre>
   *
   * <p>If the array is {@code null}, then the message of the exception is &quot;The validated
   * object is null&quot;.
   *
   * @param <T> the array type
   * @param array the array to check, validated not null by this method
   ...
   * object is null&quot;.
   *
   * <p>If the index is invalid, then the message of the exception is &quot;The validated array
  ...
  /**
   * Validates that the index is within the bounds of the argument collection; otherwise throwing an
   * exception with the specified message.
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>If the collection is {@code null}, then the message of the exception is &quot;The validated
   * object is null&quot;.
   *
   * @param <T> the collection type
   * @param collection the collection to check, validated not null by this method
   ...
   * @since 3.0
   */
  public static <T extends Collection<?>> T validIndex(
      final T collection, final int index, final String message, final Object... values) {
    notNull(collection);
   ...
   * </pre>
   *
   * <p>If the index is invalid, then the message of the exception is &quot;The validated collection
   * index is invalid: &quot; followed by the index.
   *
   * @param <T> the collection type
   * @param collection the collection to check, validated not null by this method
   ...
   * </pre>
   *
   * <p>If the character sequence is {@code null}, then the message of the exception is &quot;The
   ...
   * @since 3.0
   */
  public static <T extends CharSequence> T validIndex(
      final T chars, final int index, final String message, final Object... values) {
    notNull(chars);
   ...
   * validated object is null&quot;.
   *
   * <p>If the index is invalid, then the message of the exception is &quot;The validated character
   ...
   * </pre>
   *
   * <p>The message of the exception is &quot;The validated state is false&quot;.
   *
   * @param expression the boolean expression to check
  ...
  /**
   * Validate that the stateful condition is {@code true}; otherwise throwing an exception with the
   * specified message. This method is useful when validating according to an arbitrary boolean
   * expression, such as validating a primitive number or using your own custom validation
   * expression.
   *
   ...
   * </pre>
   *
   * <p>The syntax of the pattern is the one used in the {@link Pattern} class.
   *
   ...
   * </pre>
   *
   * <p>The message of the exception is &quot;The validated value is not a number&quot;.
   *
  ...
  /**
   * Validates that the specified argument is not {@code NaN}; otherwise throwing an exception with
   * the specified message.
   *
   * <pre>
  ...
  /**
   * Validates that the specified argument is not infinite or {@code NaN}; otherwise throwing an
   * exception.
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>The message of the exception is &quot;The value is invalid: %f&quot;.
   *
   * @param value the value to validate
   ...
   * @since 3.0
   */
  public static <T> void inclusiveBetween(
      final T start,
      final T end,
   ...
   * @since 3.3
   */
  public static void inclusiveBetween(
      final long start, final long end, final long value, final String message) {
    // TODO when breaking BC, consider returning value
    if (value < start || value > end) {
   ...
   */
  public static void inclusiveBetween(
      final double start, final double end, final double value, final String message) {
    // TODO when breaking BC, consider returning value
    if (value < start || value > end) {
      throw new IllegalArgumentException(message);
    }
   ...
   * @since 3.0
   */
  public static <T> void exclusiveBetween(
      final T start,
      final T end,
      final Comparable<T> value,
      final String message,
   ...
   * @since 3.3
   */
  public static void exclusiveBetween(
      final long start, final long end, final long value, final String message) {
    // TODO when breaking BC, consider returning value
    if (value <= start || value >= end) {
      throw new IllegalArgumentException(message);
   ...
   *
   * <p>This method is useful when validating according to an arbitrary class
   *
   * <pre>
  ...
  public static void isInstanceOf(
      final Class<?> type, final Object obj, final String message, final Object... values) {
    // TODO when breaking BC, consider returning obj
    if (!type.isInstance(obj)) {
      throw new IllegalArgumentException(String.format(message, values));
    }
   ...
   * exception.
   *
   * <p>This method is useful when validating that there will be no casting errors.
   *
   * <pre>
   * Validate.isAssignableFrom(SuperClass.class, object.getClass());
   * </pre>
   *
   * <p>The message format of the exception is &quot;Cannot assign {type} to {superType}&quot;
   *
   ...
   * exception.
   *
   * <p>This method is useful when validating if there will be no casting errors.
   *
   * <pre>
   * Validate.isAssignableFrom(SuperClass.class, object.getClass());
   * </pre>
  ...
  public static void isAssignableFrom(
      final Class<?> superType, final Class<?> type, final String message, final Object... values) {
    // TODO when breaking BC, consider returning type
    if (!superType.isAssignableFrom(type)) {
      throw new IllegalArgumentException(String.format(message, values));
    }

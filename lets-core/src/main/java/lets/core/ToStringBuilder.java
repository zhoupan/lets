 ...
 *
 * <p>This class enables a good and consistent {@code toString()} to be built for any class or
 ...
 *
 * <p>To add the superclass {@code toString}, use {@link #appendSuper}. To append the {@code
 * toString} from an object that is delegated to (or any other object), use {@link #appendToString}.
 *
 * <p>Alternatively, there is a method that uses reflection to determine the fields to test. Because
 * these fields are usually private, the method, {@code reflectionToString}, uses {@code
...
public class ToStringBuilder implements Builder<String> {
   ...
   * {@code ToStringStyle} to the constructor instead of using this global default.
   *
   * <p>This method can be used from multiple threads. Internally, a {@code volatile} variable is
   * used to provide the guarantee that the latest value set using {@link #setDefaultStyle} is the
   * value returned. It is strongly recommended that the default style is only changed during
   * application startup.
   *
   ...
   * default should generally only be done during application startup. It is recommended to pass a
   * {@code ToStringStyle} to the constructor instead of changing this global default.
   *
   * <p>This method is not intended for use from multiple threads. Internally, a {@code volatile}
   * variable is used to provide the guarantee that the latest value set is the value returned from
   * {@link #getDefaultStyle}.
   *
   ...
   * Append to the {@code toString} a {@code boolean} array.
   *
   * <p>A boolean parameter controls the level of detail to show. Setting {@code true} will output
   * the array in full. Setting {@code false} will output a summary, typically the size of the
   * array.
   *
   * @param fieldName the field name
   * @param array the array to add to the {@code toString}
  ...
  public ToStringBuilder append(
      final String fieldName, final boolean[] array, final boolean fullDetail) {
   ...
   */
  public ToStringBuilder append(
      final String fieldName, final byte[] array, final boolean fullDetail) {
    style.append(buffer, fieldName, array, Boolean.valueOf(fullDetail));
    return this;
  }
   ...
   */
  public ToStringBuilder append(
      final String fieldName, final char[] array, final boolean fullDetail) {
    style.append(buffer, fieldName, array, Boolean.valueOf(fullDetail));
    return this;
  }
   ...
   */
  public ToStringBuilder append(
      final String fieldName, final double[] array, final boolean fullDetail) {
    style.append(buffer, fieldName, array, Boolean.valueOf(fullDetail));
    return this;
  }
   ...
   */
  public ToStringBuilder append(
      final String fieldName, final float[] array, final boolean fullDetail) {
    style.append(buffer, fieldName, array, Boolean.valueOf(fullDetail));
    return this;
  }
   ...
   */
  public ToStringBuilder append(
      final String fieldName, final int[] array, final boolean fullDetail) {
    style.append(buffer, fieldName, array, Boolean.valueOf(fullDetail));
    return this;
  }
   ...
   */
  public ToStringBuilder append(
      final String fieldName, final long[] array, final boolean fullDetail) {
    style.append(buffer, fieldName, array, Boolean.valueOf(fullDetail));
    return this;
  }
   ...
   */
  public ToStringBuilder append(
      final String fieldName, final short[] array, final boolean fullDetail) {
    style.append(buffer, fieldName, array, Boolean.valueOf(fullDetail));
    return this;
  }
   ...
   *
   * <p>This method assumes that the superclass uses the same {@code ToStringStyle} as this one.
   *
   * <p>If {@code superToString} is {@code null}, no change is made.
   *
   ...
   * to another class. You can then call {@code toString()} on the other class and pass the result
   * into this method.
   *
   * <pre>
   ...
   * </pre>
   *
   * <p>This method assumes that the other object uses the same {@code ToStringStyle} as this one.
   *
   * <p>If the {@code toString} is {@code null}, no change is made.
   *
   ...
   *
   * <p>If the object is {@code null}, return the style's {@code nullText}
   *

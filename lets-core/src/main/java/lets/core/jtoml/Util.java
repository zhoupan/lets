...
public class Util {
   ...
   *
   * <p>"2008-03-01T13:00:00+01:00". It also supports parsing the "Z" timezone.
   *
   * <p>Author: <a href="http://stackoverflow.com/users/1010931/wrygiel">wrigiel</a>
   *
   * <p>Taken from:
   ...
   *
   * <p>Note: This is to avoid dependency on Apache commons for such limited features.
   */
  public static class TomlString {
    private static final Map<Character, Character> ESCAPE = new HashMap<>();
    private static final Map<Character, Character> UNESCAPE =
    ...
    /**
     * Unescape a list of literals found in the given String. It will replace characters (<code>
     * '\' + 't'</code>, <code>'\' + 'n'</code>, ...) to there equivalent (<code>'\t'</code>, <code>
     * '\n'</code>).
     *
     * <ul>
     *   <li><code>'\'</code> + <code>'0'</code> → <code>'\0'</code> null character (0x00)
     *   <li><code>'\'</code> + <code>'t'</code> → <code>'\t'</code> tab character (0x09)
     *   <li><code>'\'</code> + <code>'n'</code> → <code>'\n'</code> newline character (0x0a)
     *   <li><code>'\'</code> + <code>'r'</code> → <code>'\r'</code> carriage return character
     *       (0x0d)
     *   <li><code>'\'</code> + <code>'"'</code> → <code>'"'</code> quote character (0x22)
     *   <li><code>'\'</code> + <code>'\'</code> → <code>'\'</code> backslash character (0x5c)
     * </ul>
     *
     * i
     *
    ...
    /**
     * Escapes a list of literals found in the given String. It will replace characters (<code>'\t'
     * </code>, <code>'\n'</code>, ...) to there equivalent (<code>'\' + 't'</code>, <code>'\' + 'n'
     * </code>).
     *
     * <ul>
     *   <li><code>'\0'</code> null character (0x00) → <code>'\'</code> + <code>'0'</code>
     *   <li><code>'\t'</code> tab character (0x09) → <code>'\'</code> + <code>'t'</code>
     *   <li><code>'\n'</code> newline character (0x0a) → <code>'\'</code> + <code>'n'</code>
     *   <li><code>'\r'</code> carriage return character (0x0d) → <code>'\'</code> + <code>'r'
     *       </code>
     *   <li><code>'\"'</code> quote character (0x22) → <code>'\'</code> + <code>'"'</code>
     *   <li><code>'\\'</code> backslash character (0x5c) → <code>'\'</code> + <code>'\'</code>
     * </ul>
     *
     ...
     *
     * <p><code>createWhitespaceString(3) → "&nbsp;&nbsp;&nbsp;" // 3 spaces</code>
     *
  ...
  public static class Reflection {
    ...
    static final Set<Class<?>> TOML_SUPPORTED =
        new HashSet<>(
            Arrays.asList(
                int.class,
                Integer.class, //
     ...
     * @throws IllegalAccessException if the field cannot be retrieved
     */
   ...
   *
   * <ul>
   *   <li>Keeps ordering of the original list of declared fields
   *   <li>Primitive types comes before complex types ({@link Map} and Custom types).
   * </ul>
   */

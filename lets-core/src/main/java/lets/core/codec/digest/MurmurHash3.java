...
import lets.core.codec.binary.StringUtils;
...
public final class MurmurHash3 {
  ...
  /**
   * Generates 32-bit hash from the byte array with a default seed. This is a helper method that
   * will produce the same result as:
   *
   * <pre>
   * int offset = 0;
   ...
   * </pre>
   *
   * <p>This implementation contains a sign-extension bug in the finalization step of any bytes left
   * over from dividing the length by 4. This manifests if any of these bytes are negative.
   *
   * <p>
   *
   ...
   * @deprecated Use {@link #hash32x86(byte[], int, int, int)}. This corrects the processing of
   *     trailing bytes.
   */
  @Deprecated
   ...
   * @return The 32-bit hash
   * @see #hash32(byte[], int, int, int)
   * @deprecated Use {@link #hash32x86(byte[], int, int, int)} with the bytes returned from {@link
  ...
  /**
   * Generates 32-bit hash from the byte array with the given length and a default seed. This is a
  ...
  /**
   * Generates 32-bit hash from the byte array with the given length and seed. This is a helper
   * method that will produce the same result as:
   *
   * <pre>
   * int offset = 0;
   * int hash = MurmurHash3.hash32(data, offset, length, seed);
   ...
   *
   * <p><strong>This is not part of the original MurmurHash3 {@code c++} implementation.</strong>
   *
   * <p>This is a Murmur3-like 64-bit variant. The method does not produce the same result as either
   * half of the hash bytes from {@linkplain #hash128x64(byte[])} with the same byte data from the
   * {@code long}. This method will be removed in a future release.
   *
   * <p>Note: The sign extension bug in {@link #hash64(byte[], int, int, int)} does not effect this
   * result as the default seed is positive.
   *
   * <p>This is a helper method that will produce the same result as:
   *
   * <pre>
   * int offset = 0;
   * int seed = 104729;
   ...
   * @deprecated Not part of the MurmurHash3 implementation. Use half of the hash bytes from {@link
   *     #hash128x64(byte[])} with the bytes from the {@code long}.
   */
  @Deprecated
   ...
   * <p>This is a Murmur3-like 64-bit variant. The method does not produce the same result as either
   * half of the hash bytes from {@linkplain #hash128x64(byte[])} with the same byte data from the
   * {@code int}. This method will be removed in a future release.
   *
   * <p>Note: The sign extension bug in {@link #hash64(byte[], int, int, int)} does not effect this
   * result as the default seed is positive.
   *
   ...
   * @see #hash64(byte[], int, int, int)
   * @deprecated Not part of the MurmurHash3 implementation. Use half of the hash bytes from {@link
   *     #hash128x64(byte[])} with the bytes from the {@code int}.
   */
  @Deprecated
   ...
   * <p>This is a Murmur3-like 64-bit variant. The method does not produce the same result as either
   * half of the hash bytes from {@linkplain #hash128x64(byte[])} with the same byte data from the
   * {@code short}. This method will be removed in a future release.
   *
   * <p>Note: The sign extension bug in {@link #hash64(byte[], int, int, int)} does not effect this
   * result as the default seed is positive.
   *
   ...
   * @see #hash64(byte[], int, int, int)
   * @deprecated Not part of the MurmurHash3 implementation. Use half of the hash bytes from {@link
   *     #hash128x64(byte[])} with the bytes from the {@code short}.
   */
  @Deprecated
   ...
   *
   * <p>This is a Murmur3-like 64-bit variant. The method does not produce the same result as either
   * half of the hash bytes from {@linkplain #hash128x64(byte[])} with the same byte data. This
   ...
   * <p><strong>This is not part of the original MurmurHash3 {@code c++} implementation.</strong>
   *
   * <p>This is a Murmur3-like 64-bit variant. This method will be removed in a future release.
   *
   * <p>This implementation contains a sign-extension bug in the seed initialization. This manifests
   * if the seed is negative.
   *
   * <p>This algorithm processes 8 bytes chunks of data in a manner similar to the 16 byte chunks of
   * data processed in the MurmurHash3 {@code MurmurHash3_x64_128} method. However the hash is not
   * mixed with a hash chunk from the next 8 bytes of data. The method will not return the same
   * value as the first or second 64-bits of the function {@link #hash128(byte[], int, int, int)}.
   *
   * <p>Use of this method is not advised. Use the first long returned from {@link
   * #hash128x64(byte[], int, int, int)}.
   *
   * <p>
   *
  ...
  /**
   * Generates 128-bit hash from the byte array with a default seed. This is a helper method that
   * will produce the same result as:
   *
   * <pre>
   * int offset = 0;
   ...
   * </pre>
   *
   * <p>Note: The sign extension bug in {@link #hash128(byte[], int, int, int)} does not effect this
   * result as the default seed is positive.
   *
   * @param data The input byte array
   ...
   * @return The 128-bit hash (2 longs)
   * @see #hash128(byte[], int, int, int)
   * @deprecated Use {@link #hash128x64(byte[])} using the bytes returned from {@link
   ...
   * @param seed The initial seed value
   * @return The 128-bit hash (2 longs)
   * @deprecated Use {@link #hash128x64(byte[], int, int, int)}. This corrects the seed
   *     initialization.
   */
  @Deprecated
  ...
  /**
   * Generates 32-bit hash from input bytes. Bytes can be added incrementally and the new hash
   * computed.
   *
   * <p>This is an implementation of the 32-bit hash function {@code MurmurHash3_x86_32} from from
   * Austin Applyby's original MurmurHash3 {@code c++} code in SMHasher.
  ...
  public static class IncrementalHash32x86 {
    ...
    /**
     * Generate the 32-bit hash value. Repeat calls to this method with no additional data will
    ...
    /**
     * Finalize the running hash to the output 32-bit hash by processing remaining bytes and
     * performing final mixing.
     *
    ...
    /**
     * Combines the bytes using an Or operation ({@code | } in a little-endian representation of a
     * 32-bit integer; byte 1 will be the least significant byte, byte 4 the most significant.
     *
  ...
  public static class IncrementalHash32 extends IncrementalHash32x86 {
     ...
     * {@inheritDoc}
     *
     * <p>This implementation contains a sign-extension bug in the finalization step of any bytes
     * left over from dividing the length by 4. This manifests if any of these bytes are negative.
     *
     * <p>
     *
     * @deprecated Use IncrementalHash32x86. This corrects the processing of trailing bytes.

...
/**
 * Standard {@link HmacUtils} algorithm names from the <cite>Java Cryptography Architecture Standard
 * Algorithm Name Documentation</cite>.
 *
 * <p><strong>Note: Not all JCE implementations support all the algorithms in this enum.</strong>
 *
 * @see <a
 *     href="http://docs.oracle.com/javase/6/docs/technotes/guides/security/SunProviders.html#SunJCEProvider">
 *     Java 6 Cryptography Architecture Sun Providers Documentation</a>
 * @see <a
 *     href="http://docs.oracle.com/javase/7/docs/technotes/guides/security/SunProviders.html#SunJCEProvider">
 *     Java 7 Cryptography Architecture Sun Providers Documentation</a>
 * @see <a
 *     href="http://docs.oracle.com/javase/8/docs/technotes/guides/security/SunProviders.html#SunJCEProvider">
...
public enum HmacAlgorithms {
   ...
   * 180-2.
   *
   * <p>Every implementation of the Java 8+ platform is required to support this standard MAC
   * algorithm.
   *
   * @since 1.11
   */
   ...
   * 180-2.
   *
   * <p>This MAC algorithm is <em>optional</em>; not all implementations support it.
   */

...
public final class MurmurHash2 {
  ...
  /**
   * Generates a 32-bit hash from byte array with the given length and a default seed value. This is
   * a helper method that will produce the same result as:
   *
   * <pre>
   * int seed = 0x9747b28c;
  ...
  /**
   * Generates a 32-bit hash from a substring with a default seed value. The string is converted to

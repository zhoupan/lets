 ...
 *
 * <p>This codec is meant to be a replacement for standard Java classes {@link java.net.URLEncoder}
 * and {@link java.net.URLDecoder} on older Java platforms, as these classes in Java versions below
 * 1.4 rely on the platform's default charset encoding.
 *
 * <p>This class is thread-safe as of 1.11
 *
 * @see <a href="http://www.w3.org/TR/html4/interact/forms.html#h-17.13.4.1">Chapter 17.13.4 Form
 *     content types</a> of the <a href="http://www.w3.org/TR/html4/">HTML 4.01 Specification</a>
 * @since 1.2
 */
public class URLCodec implements BinaryEncoder, BinaryDecoder, StringEncoder, StringDecoder {
   ...
   */
  @Deprecated protected volatile String charset; // added volatile: see CODEC-232

  /** Release 1.5 made this field final. */
  protected static final byte ESCAPE_CHAR = '%';

  /**
   * BitSet of www-form-url safe characters. This is a copy of the internal BitSet which is now used
   * for the conversion. Changes to this field are ignored.
   *
   ...
   * @param charsetName the charset for str
  ...
  /**
   * Encodes a string into its URL safe form using the default string charset. Unsafe characters are
   * escaped.
   *
   * @param str string to convert to a URL safe form
   * @return URL safe string
   ...
   * @param charsetName the original string charset
   ...
   * @throws EncoderException Thrown if URL encoding is not applicable to objects of this type or if
  ...
  public Object encode(final Object obj) throws EncoderException {
    if (obj == null) {
      ...
      throw new EncoderException(
          "Objects of type " + obj.getClass().getName() + " cannot be URL encoded");
    }
  }
  ...
  public Object decode(final Object obj) throws DecoderException {
    if (obj == null) {
      ...
      throw new DecoderException(
          "Objects of type " + obj.getClass().getName() + " cannot be URL decoded");
    }
  }

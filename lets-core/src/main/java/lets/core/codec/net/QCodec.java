 ...
 *
 * <p>This class is conditionally thread-safe. The instance field for encoding blanks is mutable
...
public class QCodec extends RFC1522Codec implements StringEncoder, StringDecoder {
  ...
  /**
   * Decodes a quoted-printable string into its original form. Escaped characters are converted back
   ...
   *
   * @param b {@code true} if SPACE characters are to be transformed, {@code false} otherwise
   */

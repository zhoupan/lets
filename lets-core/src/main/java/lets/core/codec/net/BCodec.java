...
import lets.core.codec.binary.Base64;
import lets.core.codec.binary.BaseNCodec;
 ...
 *
 * <p><a href="http://www.ietf.org/rfc/rfc1522.txt">RFC 1522</a> describes techniques to allow the
...
public class BCodec extends RFC1522Codec implements StringEncoder, StringDecoder {
  ...
  /**
   * If true then decoding should throw an exception for impossible combinations of bits at the end
   * of the byte input. The default is to decode as much of them as possible.
   */
  ...
  /**
   * Returns true if decoding behavior is strict. Decoding will raise a {@link DecoderException} if
   * trailing bits are not part of a valid Base64 encoding.
   *
   ...
   * escaped.
   *
   * @param strSource string to convert to Base64 form
  ...
  /**
   * Decodes a Base64 object into its original form. Escaped characters are converted back to their
   * original representation.
   *
   * @param value Base64 object to convert into its original form
   * @return original object
   * @throws DecoderException Thrown if the argument is not a {@code String}. Thrown if a failure

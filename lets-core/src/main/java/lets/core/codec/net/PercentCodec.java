...
/**
 * Implements the Percent-Encoding scheme, as described in HTTP 1.1 specification. For
 * extensibility, an array of special US-ASCII characters can be specified in order to perform
 * proper URI encoding for the different parts of the URI.
 *
 * <p>This class is immutable. It is also thread-safe besides using BitSet which is not thread-safe,
 * but its public interface only call the access
 *
...
public class PercentCodec implements BinaryEncoder, BinaryDecoder {
  ...
  /**
   * Constructs a Percent coded that will encode all the non US-ASCII characters using the
   * Percent-Encoding while it will not encode all the US-ASCII characters, except for character '%'
   * that is used as escape character for Percent-Encoding.
   */
  public PercentCodec() {
  ...
  /**
   * Decode bytes encoded with Percent-Encoding based on RFC 3986. The reverse process is performed
   * in order to decode the encoded characters to Unicode.
   */
  @Override
  ...
  public Object encode(final Object obj) throws EncoderException {
    if (obj == null) {
      ...
      throw new EncoderException(
          "Objects of type " + obj.getClass().getName() + " cannot be Percent encoded");
    }
  }
  ...
  public Object decode(final Object obj) throws DecoderException {
    if (obj == null) {
      ...
      throw new DecoderException(
          "Objects of type " + obj.getClass().getName() + " cannot be Percent decoded");
    }
  }
}

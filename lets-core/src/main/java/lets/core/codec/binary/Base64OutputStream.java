 ...
 *
 * <p>The default behavior of the Base64OutputStream is to ENCODE, whereas the default behavior of
 * the Base64InputStream is to DECODE. But this behavior can be overridden by using a different
 * constructor.
 *
...
public class Base64OutputStream extends BaseNCodecOutputStream {
  ...
  /**
   * Creates a Base64OutputStream such that all data written is Base64-encoded to the original
  ...
  /**
   * Creates a Base64OutputStream such that all data written is either Base64-encoded or
   * Base64-decoded to the original provided OutputStream.
   *
   * @param out OutputStream to wrap.
   ...
   *     characters (rounded down to nearest multiple of 4). If lineLength &lt;= 0, the encoded data
   *     is not divided into lines. If doEncode is false, lineLength is ignored.

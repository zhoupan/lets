 ...
 *
 * <p>The default behavior of the Base32InputStream is to DECODE, whereas the default behavior of
 * the Base32OutputStream is to ENCODE, but this behavior can be overridden by using a different
 * constructor.
 *
...
public class Base32InputStream extends BaseNCodecInputStream {
  ...
  /**
   * Creates a Base32InputStream such that all data read is Base32-decoded from the original
  ...
  /**
   * Creates a Base32InputStream such that all data read is either Base32-encoded or Base32-decoded

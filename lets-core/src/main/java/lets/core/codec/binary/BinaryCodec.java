 ...
 *
 * <p>This class is immutable and thread-safe. TODO: may want to add more bit vector functions like
 * and/or/xor/nand TODO: also might be good to generate boolean[] from byte[] et cetera.
 *
 * @since 1.3
 */
public class BinaryCodec implements BinaryDecoder, BinaryEncoder {
  ...
  /**
   * Converts an array of raw binary data into an array of ASCII 0 and 1 character bytes - each byte
   * is a truncated char.
   *
   * @param raw the raw binary data to convert
   * @return an array of 0 and 1 character bytes for each bit of the argument
   * @see lets.core.codec.BinaryEncoder#encode(byte[])
   */
   ...
   * @param ascii each byte represents an ASCII '0' or '1'
   * @return the raw encoded binary where each bit corresponds to a byte in the byte array argument
   * @see lets.core.codec.Decoder#decode(Object)
   */
  @Override
   ...
   * @see lets.core.codec.Encoder#encode(Object)
   */
  @Override

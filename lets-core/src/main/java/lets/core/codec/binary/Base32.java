...
public class Base32 extends BaseNCodec {
  ...
  /**
   * Convenience variable to help us determine when our buffer is going to run out of room and needs
   * resizing. {@code encodeSize = {@link #BYTES_PER_ENCODED_BLOCK} + lineSeparator.length;}
   */
   ...
   * validity.
   *
   * <p>Output is written to {@link lets.core.codec.binary.BaseNCodec.Context#buffer Context#buffer}
   * as 8-bit octets, using {@link lets.core.codec.binary.BaseNCodec.Context#pos Context#pos} as the
   * buffer position
   *
   ...
   * test the final trailing base-32 digit is zero in the bits that will be discarded.
   *

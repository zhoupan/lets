...
public class Hex implements BinaryEncoder, BinaryDecoder {
  ...
  /**
   * Converts a byte buffer into an array of characters representing the hexadecimal values of each
   ...
   * The returned String will be double the length of the passed array, as it takes two characters
  ...
  /**
   * Convert the byte buffer to a byte array. All bytes identified by {@link ByteBuffer#remaining()}
   * will be used.
   *
  ...
  /**
   * Converts a buffer of character bytes representing hexadecimal values into an array of bytes of
   * those same values. The returned array will be half the length of the passed array, as it takes
   * two characters to represent any given byte. An exception is thrown if the passed char array has
   * an odd number of elements.
   *
  ...
  /**
   * Converts a String or an array of character bytes representing hexadecimal values into an array
   * of bytes of those same values. The returned array will be half the length of the passed String
   * or array, as it takes two characters to represent any given byte. An exception is thrown if the
   ...
   * @return A byte array containing binary data decoded from the supplied byte array (representing
   *     characters).
   * @throws DecoderException Thrown if an odd number of characters is supplied to this function or
   *     the object is not a String or char[]
   * @see #decodeHex(char[])
   */
  @Override
   ...
   * values of each byte in order. The returned array will be double the length of the passed array,
  ...
  /**
   * Converts a String or an array of bytes into an array of characters representing the hexadecimal
   * values of each byte in order. The returned array will be double the length of the passed String

...
public class DoubleMetaphone implements StringEncoder {
  ...
  public boolean isDoubleMetaphoneEqual(
    ...
    return StringUtils.equals(
        doubleMetaphone(value1, alternate), doubleMetaphone(value2, alternate));
  }
  ...
  /**
   * Determines whether or not the value starts with a silent letter. It will return {@code true} if
   * the value starts with any of 'GN', 'KN', 'PN', 'WR' or 'PS'.
   */

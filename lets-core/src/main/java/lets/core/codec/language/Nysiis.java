...
/**
 * Encodes a string into a NYSIIS value. NYSIIS is an encoding used to relate similar names, but can
 * also be used as a general purpose scheme to find word with similar phonemes.
 *
 * <p>NYSIIS features an accuracy increase of 2.7% over the traditional Soundex algorithm.
 *
...
public class Nysiis implements StringEncoder {
  ...
  /**
   * Transcodes the remaining parts of the String. The method operates on a sliding window, looking
   * at 4 characters at a time: [i-1, i, i+1, i+2].
   *
  ...
  /**
   * Creates an instance of the {@link Nysiis} encoder with strict mode (original form), i.e.
   ...
   *
   * <ul>
   *   <li>{@code true}: encoded strings have a maximum length of 6
   *   <li>{@code false}: encoded strings may have arbitrary length
   * </ul>
   *
  ...
  /**
   * Encodes an Object using the NYSIIS algorithm. This method is provided in order to satisfy the
   * requirements of the Encoder interface, and will throw an {@link EncoderException} if the
   * supplied object is not of type {@link String}.
   *
   * @param obj Object to encode
   * @return An object (or a {@link String}) containing the NYSIIS code which corresponds to the
   *     given String.

 ...
 *
 * @see <a href="http://en.wikipedia.org/wiki/Match_rating_approach">Wikipedia - Match Rating
 *     Approach</a>
 * @since 1.8
 */
public class MatchRatingApproachEncoder implements StringEncoder {
  ...
  /**
   * Unicode characters corresponding to various accented letters. For example: \u00DA is U acute
   * etc...
   */
  ...
  /**
   * Cleans up a name: 1. Upper-cases everything 2. Removes some common punctuation 3. Removes
   * accents 4. Removes any spaces.
   *
   * <h2>API Usage</h2>
   *
   * <p>Consider this method private, it is package protected for unit testing only.
   *
  ...
  /**
   * Encodes an Object using the Match Rating Approach algorithm. Method is here to satisfy the
   * requirements of the Encoder interface Throws an EncoderException if input object is not of type
   * java.lang.String.
   *
   * @param pObject Object to encode
   * @return An object (or type java.lang.String) containing the Match Rating Approach code which
  ...
  /**
   * Obtains the min rating of the length sum of the 2 names. In essence the larger the sum length
   * the smaller the min rating. Values strictly from documentation.
   *
   * <h2>API Usage</h2>
   *
   * <p>Consider this method private, it is package protected for unit testing only.
  ...
  /**
   * Determines if two names are homophonous via Match Rating Approach (MRA) algorithm. It should be
   * noted that the strings are cleaned in the same way as {@link #encode(String)}.
   *
  ...
  /**
   * Processes the names from left to right (first) then right to left removing identical letters in
   * same positions. Then subtracts the longer string that remains from 6 and returns this.
   *
   * <h2>API Usage</h2>
   *
   * <p>Consider this method private, it is package protected for unit testing only.

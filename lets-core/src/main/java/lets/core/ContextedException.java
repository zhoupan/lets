 ...
 *
 * <p>An exception trace itself is often insufficient to provide rapid diagnosis of the issue.
 * Frequently what is needed is a select few pieces of local contextual data. Providing this data is
 * tricky however, due to concerns over formatting and nulls.
 *
 * <p>The contexted exception approach allows the exception to be created together with a list of
 * context label-value pairs. This additional information is automatically included in the message
 * and printed stack trace.
 *
 * <p>An unchecked version of this exception is provided by ContextedRuntimeException.
 *
 ...
 * </pre>
 *
 * <p>or improve diagnose data at a higher level:
 *
 * <pre>
 *   try {
 *     ...
 ...
 * </pre>
 *
 * <p>The output in a printStacktrace() (which often is written to a log) would look something like
 * the following:
 *
 * <pre>
...
public class ContextedException extends Exception implements ExceptionContext {
   ...
   *
   * <p>The context information is stored using a default implementation.
   */
   ...
   * @param message the exception message, may be null
   * @param cause the underlying cause of the exception, may be null
   * @param context the context used to store the additional information, null uses default
   *     implementation
   */

...
import lets.ai.whispercpp.callbacks.WhisperEncoderBeginCallback;
import lets.ai.whispercpp.callbacks.WhisperLogitsFilterCallback;
import lets.ai.whispercpp.callbacks.WhisperNewSegmentCallback;
import lets.ai.whispercpp.callbacks.WhisperProgressCallback;

/**
 * Parameters for the whisper_full() function. If you change the order or add new parameters, make
 * sure to update the default values in whisper.cpp: whisper_full_default_params()
 */
public class WhisperFullParams extends Structure {
  ...
  public lets.ai.whispercpp.params.CBool translate;

  /** The compliment of translateMode() */
  public void transcribeMode() {
    translate = lets.ai.whispercpp.params.CBool.FALSE;
  }

  /** The compliment of transcribeMode() */
  public void translateMode() {
    translate = lets.ai.whispercpp.params.CBool.TRUE;
  }

  /**
   * Flag to indicate whether to use past transcription (if any) as an initial prompt for the
   * decoder. (default = true)
   */
  public lets.ai.whispercpp.params.CBool no_context;
  ...
  public void enableContext(boolean enable) {
    no_context =
        enable ? lets.ai.whispercpp.params.CBool.FALSE : lets.ai.whispercpp.params.CBool.TRUE;
  }

  /** Generate timestamps or not? */
  public lets.ai.whispercpp.params.CBool no_timestamps;

  /** Flag to force single segment output (useful for streaming). (default = false) */
  public lets.ai.whispercpp.params.CBool single_segment;

  /** Flag to force single segment output (useful for streaming). (default = false) */
  public void singleSegment(boolean single) {
    single_segment =
        single ? lets.ai.whispercpp.params.CBool.TRUE : lets.ai.whispercpp.params.CBool.FALSE;
  }

  /** Flag to print special tokens (e.g., &lt;SOT>, &lt;EOT>, &lt;BEG>, etc.). (default = false) */
  public lets.ai.whispercpp.params.CBool print_special;

  /** Flag to print special tokens (e.g., &lt;SOT>, &lt;EOT>, &lt;BEG>, etc.). (default = false) */
  public void printSpecial(boolean enable) {
    print_special =
        enable ? lets.ai.whispercpp.params.CBool.TRUE : lets.ai.whispercpp.params.CBool.FALSE;
  }

  /** Flag to print progress information. (default = true) */
  public lets.ai.whispercpp.params.CBool print_progress;
  ...
  /**
   * Flag to print results from within whisper.cpp (avoid it, use callback instead). (default =
   * true)
   */
  public lets.ai.whispercpp.params.CBool print_realtime;
  ...
  public lets.ai.whispercpp.params.CBool print_timestamps;
  ...
  public lets.ai.whispercpp.params.CBool token_timestamps;
  ...
  public lets.ai.whispercpp.params.CBool split_on_word;
  ...
  public lets.ai.whispercpp.params.CBool tdrz_enable;
  ...
  /**
   * Tokens to provide to the whisper decoder as an initial prompt. These are prepended to any
   * existing text context from a previous call.
   */
  ...
  public lets.ai.whispercpp.params.CBool detect_language;
  ...
  public lets.ai.whispercpp.params.CBool suppress_blank;
  ...
  public lets.ai.whispercpp.params.CBool suppress_non_speech_tokens;

  /** Flag to suppress non-speech tokens. */
  public void suppressNonSpeechTokens(boolean enable) {
    suppress_non_speech_tokens = enable ? lets.ai.whispercpp.params.CBool.TRUE : CBool.FALSE;
  }
  ...
  public lets.ai.whispercpp.params.GreedyParams greedy;

  /** Beam search decoding parameters. */
  public lets.ai.whispercpp.params.BeamSearchParams beam_search;
  ...
  public void setBeamSize(int beamSize) {
    if (beam_search == null) {
      beam_search = new lets.ai.whispercpp.params.BeamSearchParams();
    }
